...
import takizawaVacancy from "./takizawa.json";
...
import amiVacancy from "./ami.json";
import akitakataVacancy from "./akitakata.json";
import kamisatoVacancy from "./kamisato.json";
import takahamaVacancy from "./takahama.json";
import chinoVacancy from "./chino.json";
import annakaVacancy from "./annaka.json";
import hannanVacancy from "./hannan.json";
import shinshiroVacancy from "./shinshiro.json";
import bandoVacancy from "./bando.json";
...
import tendoVacancy from "./tendo.json";
import higashineVacancy from "./higashine.json";
import himejiVacancy from "./himeji.json";
import inoVacancy from "./ino.json";
import mineVacancy from "./mine.json";
import iwanumaVacancy from "./iwanuma.json";
import uwajimaVacancy from "./uwajima.json";
import saitamaInaVacancy from "./saitama-ina.json";
import shimotsumaVacancy from "./shimotsuma.json";
import kochiKonanVacancy from "./kochi-konan.json";
import tochigiSakuraVacancy from "./tochigi-sakura.json";
import takaishiVacancy from "./takaishi.json";
...
import wakoVacancy from "./wako.json";
...
import kumejimaVacancy from "./kumejima.json";
...
import toyotaVacancy from "./toyota.json";
...
import kudamatsuVacancy from "./kudamatsu.json";
...
import sazaVacancy from "./saza.json";
...
import matsusakaVacancy from "./matsusaka.json";
import matsumotoVacancy from "./matsumoto.json";
import arakawaVacancy from "./arakawa.json";
import mibuVacancy from "./mibu.json";
import hamadaVacancy from "./hamada.json";
import kanzakiVacancy from "./kanzaki.json";
import gamagoriVacancy from "./gamagori.json";
import katoVacancy from "./kato.json";
import yokoteVacancy from "./yokote.json";
import satoshoVacancy from "./satosho.json";
import kaminokawaVacancy from "./kaminokawa.json";
import tokonameVacancy from "./tokoname.json";
import tamamuraVacancy from "./tamamura.json";
import unnanVacancy from "./unnan.json";
import sandaVacancy from "./sanda.json";
import otaGunmaVacancy from "./ota-gunma.json";
import tomigusukuVacancy from "./tomigusuku.json";
import sodegauraVacancy from "./sodegaura.json";
import izumiKagoshimaVacancy from "./izumi-kagoshima.json";
import izumiotsuVacancy from "./izumiotsu.json";
import kashibaVacancy from "./kashiba.json";
import ashikagaVacancy from "./ashikaga.json";
import zushiVacancy from "./zushi.json";
...
import yuzawaVacancy from "./yuzawa.json";
...
import ishikariVacancy from "./ishikari.json";
import shikokuchuoVacancy from "./shikokuchuo.json";
...
// 曽於市も空き状況を1枚の画像で公開している（「－」は施設に問い合わせ、斜線がクラスなし）
...
const registry: Record<string, VacancyDataset> = {
  ...
  takizawa: takizawaVacancy as unknown as VacancyDataset,
  ...
  ami: amiVacancy as unknown as VacancyDataset,
  akitakata: akitakataVacancy as unknown as VacancyDataset,
  kamisato: kamisatoVacancy as unknown as VacancyDataset,
  takahama: takahamaVacancy as unknown as VacancyDataset,
  chino: chinoVacancy as unknown as VacancyDataset,
  annaka: annakaVacancy as unknown as VacancyDataset,
  hannan: hannanVacancy as unknown as VacancyDataset,
  shinshiro: shinshiroVacancy as unknown as VacancyDataset,
  bando: bandoVacancy as unknown as VacancyDataset,
  ...
  tendo: tendoVacancy as unknown as VacancyDataset,
  higashine: higashineVacancy as unknown as VacancyDataset,
  himeji: himejiVacancy as unknown as VacancyDataset,
  ino: inoVacancy as unknown as VacancyDataset,
  mine: mineVacancy as unknown as VacancyDataset,
  iwanuma: iwanumaVacancy as unknown as VacancyDataset,
  uwajima: uwajimaVacancy as unknown as VacancyDataset,
  "saitama-ina": saitamaInaVacancy as unknown as VacancyDataset,
  shimotsuma: shimotsumaVacancy as unknown as VacancyDataset,
  "kochi-konan": kochiKonanVacancy as unknown as VacancyDataset,
  "tochigi-sakura": tochigiSakuraVacancy as unknown as VacancyDataset,
  takaishi: takaishiVacancy as unknown as VacancyDataset,
  ...
  wako: wakoVacancy as unknown as VacancyDataset,
  ...
  kumejima: kumejimaVacancy as unknown as VacancyDataset,
  ...
  toyota: toyotaVacancy as unknown as VacancyDataset,
  ...
  kudamatsu: kudamatsuVacancy as unknown as VacancyDataset,
  ...
  saza: sazaVacancy as unknown as VacancyDataset,
  ...
  matsusaka: matsusakaVacancy as unknown as VacancyDataset,
  matsumoto: matsumotoVacancy as unknown as VacancyDataset,
  arakawa: arakawaVacancy as unknown as VacancyDataset,
  mibu: mibuVacancy as unknown as VacancyDataset,
  hamada: hamadaVacancy as unknown as VacancyDataset,
  kanzaki: kanzakiVacancy as unknown as VacancyDataset,
  gamagori: gamagoriVacancy as unknown as VacancyDataset,
  kato: katoVacancy as unknown as VacancyDataset,
  yokote: yokoteVacancy as unknown as VacancyDataset,
  satosho: satoshoVacancy as unknown as VacancyDataset,
  kaminokawa: kaminokawaVacancy as unknown as VacancyDataset,
  tokoname: tokonameVacancy as unknown as VacancyDataset,
  tamamura: tamamuraVacancy as unknown as VacancyDataset,
  unnan: unnanVacancy as unknown as VacancyDataset,
  sanda: sandaVacancy as unknown as VacancyDataset,
  "ota-gunma": otaGunmaVacancy as unknown as VacancyDataset,
  tomigusuku: tomigusukuVacancy as unknown as VacancyDataset,
  sodegaura: sodegauraVacancy as unknown as VacancyDataset,
  "izumi-kagoshima": izumiKagoshimaVacancy as unknown as VacancyDataset,
  izumiotsu: izumiotsuVacancy as unknown as VacancyDataset,
  kashiba: kashibaVacancy as unknown as VacancyDataset,
  ashikaga: ashikagaVacancy as unknown as VacancyDataset,
  zushi: zushiVacancy as unknown as VacancyDataset,
  ...
  yuzawa: yuzawaVacancy as unknown as VacancyDataset,
  ...
  ishikari: ishikariVacancy as unknown as VacancyDataset,
  shikokuchuo: shikokuchuoVacancy as unknown as VacancyDataset,
