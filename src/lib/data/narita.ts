...
// ---------------------------------------------------------------------------
// 成田市 保育園入園 基本指数・調整指数データ
// 出典: 成田市「令和8年度保育所等利用のしおり」
// 参考: 成田市保育の実施及び保育所等の利用調整等に関する規則
// https://www.city.narita.chiba.jp/kosodate/page140300.html
// https://www1.g-reiki.net/narita/reiki_honbun/z700RG00001045.html
// ---------------------------------------------------------------------------
// 成田市は基本指数（父母それぞれ）+ 調整指数の加算方式
// 千葉県内の標準基準に基づき、父母それぞれ最大20点の制度を採用
// 就労は月の就労時間で判定：月160時間以上で満点の20点
// 同点の場合：基準点数の高い者＞所得の低い者で判定
// ---------------------------------------------------------------------------
