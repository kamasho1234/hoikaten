...
// ---------------------------------------------------------------------------
// 東村山市 保育園入園 基本指数・調整指数データ
// 出典: 東村山市「令和8年度 保育施設利用のご案内」
// ---------------------------------------------------------------------------
// 東村山市は「基本指数（父母それぞれ）＋ 調整指数」の加算方式。
// 就労は月あたりの就労日数・1日あたりの就労時間で判定。
...
function buildParentQuestions(parentNum: 1 | 2): Question[] {
  ...
  const detailQuestions: Question[] = [
    ...
    },
    {
      ...
      helpText: '月あたりの通学日数と1日あたりの時間を選んでください',
      inputType: 'radio',
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    helpText: '認証保育所・認可外保育施設に月ぎめ契約で預けている場合',
    inputType: 'radio',
    options: [
  ...
  {
    id: 'adj_higashimurayama_resident',
    category: 'adjustment',
    label: '東村山市に住んでいますか？',
    helpText: '東村山市外からの申込みは減点になります',
    inputType: 'radio',
    options: [
      { label: 'はい（東村山市在住）', value: 'adj_higashimurayama_resident_yes', points: 0 },
      { label: 'いいえ（市外在住）', value: 'adj_higashimurayama_resident_no', points: -10 },
    ],
  },
  {
    id: 'adj_grandparent_cohabit',
    category: 'adjustment',
    label: '同居親族に子どもの面倒を見られる方がいますか？',
...
export const higashimurayamaData: MunicipalityData = {
  municipality,
  questions: [
