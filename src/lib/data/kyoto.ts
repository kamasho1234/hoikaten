...
// ---------------------------------------------------------------------------
// 京都市 保育園入園 基本指数・調整指数データ
// ---------------------------------------------------------------------------
// 京都市は点数制。父母それぞれに「基本指数＋調整指数」を計算し、
// 低い方が児童の点数になる。父母各最大40点。
...
const employmentOptions = (prefix: string) => [
  ...
  { label: '週40時間以上', value: `${prefix}_employment_40`, points: 40 },
  { label: '週35〜40時間', value: `${prefix}_employment_35`, points: 35 },
  { label: '週30〜35時間', value: `${prefix}_employment_30`, points: 30 },
  { label: '週25〜30時間', value: `${prefix}_employment_25`, points: 25 },
  { label: '週20〜25時間', value: `${prefix}_employment_20`, points: 20 },
  { label: 'その他（月64時間以上）', value: `${prefix}_employment_15`, points: 15 },
];

/** 疾病・障害 */
const illnessOptions = (prefix: string) => [
  { label: 'あてはまらない', value: `${prefix}_illness_none`, points: 0 },
  { label: '入院・重度障害等（入院/常時臥床/身体1-2級/療育A/精神1級等）', value: `${prefix}_illness_40`, points: 40 },
  { label: '中度（身体3級/療育B/精神2級等）', value: `${prefix}_illness_35`, points: 35 },
  { label: 'その他', value: `${prefix}_illness_15`, points: 15 },
];

/** 介護 */
const careOptions = (prefix: string) => [
  { label: 'あてはまらない', value: `${prefix}_care_none`, points: 0 },
  { label: '要介護3以上・重度障害の親族の介護', value: `${prefix}_care_35`, points: 35 },
  { label: '要介護1-2・中度の親族の介護', value: `${prefix}_care_20`, points: 20 },
...
const childbirthOptions = (prefix: string) => [
  ...
  { label: '出産前後', value: `${prefix}_childbirth_15`, points: 15 },
];

/** 就学・技能習得 */
const educationOptions = (prefix: string) => [
  { label: 'あてはまらない', value: `${prefix}_education_none`, points: 0 },
  { label: '週40時間以上の就学', value: `${prefix}_education_40`, points: 40 },
  { label: '週30時間以上の就学', value: `${prefix}_education_30`, points: 30 },
  { label: 'その他の就学', value: `${prefix}_education_15`, points: 15 },
];
...
export const kyotoData: MunicipalityData = {
  municipality,
  questions: [
