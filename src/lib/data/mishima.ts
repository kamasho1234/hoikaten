...
// ---------------------------------------------------------------------------
// 三島市 保育園入園 基本指数・調整指数データ
// 出典: 三島市子ども未来部保育幼稚園課「令和8年度 保育施設等利用案内」
// https://www.city.mishima.shizuoka.jp/
// 参考: 同県内（掛川市・藤枝市）の指数表に準じた静岡県標準方式
// ---------------------------------------------------------------------------
// 三島市は「基本指数（父母それぞれ最大20点）＋ 調整指数」の加算方式。
// 合計基本指数最大40点。
// ---------------------------------------------------------------------------
...
export const mishimaData: MunicipalityData = {
  municipality,
