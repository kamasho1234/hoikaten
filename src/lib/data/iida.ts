...
// ---------------------------------------------------------------------------
// 飯田市 保育園入園 基本指数・調整指数データ
// 出典: 飯田市子育て支援課「飯田市保育所等利用調整基準」参考
// 松本市に準じた長野県南部標準方式
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '飯田市外にお住まいですか？',
    helpText: '市外から飯田市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（飯田市在住）', value: 'adj_outside_city_no', points: 0 },
...
export const iidaData: MunicipalityData = {
  municipality,
  questions: [
