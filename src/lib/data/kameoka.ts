...
// ---------------------------------------------------------------------------
// 亀岡市 保育園入園 基本指数・調整指数データ
// 出典：亀岡市保育課「亀岡市保育施設の利用調整に関する基準（令和7年4月入所～）」参考
// ---------------------------------------------------------------------------
//
// 亀岡市の選考指数は以下のように算出されます。
//   基本指数 ＝ 父の基本指数 ＋ 母の基本指数
//   選考指数 ＝ 基本指数 ± 調整指数
// 父母各最大20点、合計40点満点です。
// ---------------------------------------------------------------------------
...
function buildParentQuestions(parentNum: 1 | 2): Question[] {
  ...
  const reasonQuestion: Question = {
    ...
    helpText: '亀岡市では父母それぞれの基本指数の合計で選考されます。いちばん近いものをひとつ選んでください。',
    inputType: 'select',
    options: [
...
export const kameokaData: MunicipalityData = {
  municipality,
  questions: [
