...
const employmentOptions = (prefix: string) => [
  ...
  { label: '週5日以上かつ1日7時間以上（月20日以上）', value: `${prefix}_employment_20`, points: 20 },
  { label: '週5日以上かつ1日5時間以上7時間未満', value: `${prefix}_employment_18`, points: 18 },
  { label: '週4日以上かつ1日7時間以上', value: `${prefix}_employment_16`, points: 16 },
  { label: '週4日以上かつ1日5時間以上7時間未満', value: `${prefix}_employment_14`, points: 14 },
  { label: '週3日以上かつ1日4時間以上', value: `${prefix}_employment_12`, points: 12 },
  { label: '月48時間以上64時間未満', value: `${prefix}_employment_10`, points: 10 },
];
...
const educationOptions = (prefix: string) => [
  ...
  { label: '月16日以上かつ1日5時間以上', value: `${prefix}_education_16`, points: 16 },
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    helpText: '認証保育所等に就労等のために月48時間以上、有償で預けている場合',
    inputType: 'radio',
    options: [
  ...
  },
  {
    ...
    helpText: '補助的な保育が可能な同居親族がいる場合は減点になります',
    inputType: 'radio',
    options: [
...
export const nakanoData: MunicipalityData = {
  municipality,
  questions: [
