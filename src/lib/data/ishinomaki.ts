...
// ---------------------------------------------------------------------------
// 石巻市 保育園入園 基本指数・調整指数データ
// 出典: 石巻市子育て支援課「令和8年度 保育施設利用のご案内」
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '石巻市外にお住まいですか？',
    helpText: '市外から石巻市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（石巻市在住）', value: 'adj_outside_city_no', points: 0 },
      { label: 'はい（市外在住）', value: 'adj_outside_city_yes', points: -6 },
    ],
  },
  {
    id: 'adj_grandparent',
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'はい', value: 'adj_transfer_yes', points: -4 },
    ],
  },
];

export const ishinomakiData: MunicipalityData = {
  municipality,
  questions: [
