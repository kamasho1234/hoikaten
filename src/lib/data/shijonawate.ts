...
// ---------------------------------------------------------------------------
// 四条畷市 保育園入園 基本指数・調整指数データ
// 出典: 四条畷市子育て支援室「令和8年度 保育施設利用のご案内」
// 大阪府北河内地域の標準方式に準じた推定値
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '四条畷市外にお住まいですか？',
    helpText: '市外から四条畷市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（四条畷市在住）', value: 'adj_outside_city_no', points: 0 },
...
export const shijonawateData: MunicipalityData = {
  municipality,
  questions: [
