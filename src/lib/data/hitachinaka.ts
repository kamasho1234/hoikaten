...
// ---------------------------------------------------------------------------
// ひたちなか市 保育園入園 基本指数・調整指数データ
// 出典: ひたちなか市子ども家庭課「令和8年度 保育施設利用のご案内」
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    id: 'adj_outside_city',
    category: 'adjustment',
    label: 'ひたちなか市外にお住まいですか？',
    helpText: '市外からひたちなか市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（ひたちなか市在住）', value: 'adj_outside_city_no', points: 0 },
