...
// ---------------------------------------------------------------------------
// あきる野市 保育園入園 基本指数・調整指数データ
// 出典: あきる野市子ども家庭部保育課「令和8年度 保育施設利用のご案内」
// / 東京都多摩地区標準方式に準じた推定値
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    id: 'adj_outside_city',
    category: 'adjustment',
    label: 'あきる野市外にお住まいですか？',
    helpText: '市外からあきる野市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（あきる野市在住）', value: 'adj_outside_city_no', points: 0 },
