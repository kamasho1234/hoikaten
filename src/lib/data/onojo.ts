...
// ---------------------------------------------------------------------------
// 大野城市 保育園入園 基準指数・調整指数データ
// ---------------------------------------------------------------------------
// 大野城市は「基準指数（父母それぞれ）＋ 調整指数」の加算方式。
// 公式の詳細基準が確認できなかったため、福岡県内の近隣自治体（春日市）の基準を参考値として使用しています。
// 実際の申込みは必ず大野城市子育て支援課で確認してください。
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    inputType: 'radio',
    options: [
      { label: 'いいえ（大野城市在住）', value: 'adj_outside_city_no', points: 0 },
...
export const onojoData: MunicipalityData = {
  municipality,
  questions: [
