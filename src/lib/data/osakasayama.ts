...
// ---------------------------------------------------------------------------
// 大阪狭山市 保育園入園 基本指数・調整指数データ
// 出典: 大阪狭山市子育て支援課「令和8年度 保育施設利用のご案内」
//      / 大阪府南河内地域の標準方式に準じた推定値
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    id: 'adj_outside_city',
    category: 'adjustment',
    label: '大阪狭山市外にお住まいですか？',
    helpText: '市外から大阪狭山市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（大阪狭山市在住）', value: 'adj_outside_city_no', points: 0 },
...
export const osakasayamaData: MunicipalityData = {
  municipality,
  questions: [
