...
// ---------------------------------------------------------------------------
// 川西市 保育園入園 基準指数・調整指数データ
// ---------------------------------------------------------------------------
// 川西市は「基準指数（父母それぞれ）＋ 調整指数」の加算方式。
// 父母それぞれに基準指数を判定し、合計する。
// 就労は月あたりの就労日数・時間で点数を判定。父母各最大20点。
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    inputType: 'radio',
    options: [
      { label: 'いいえ（川西市在住）', value: 'adj_outside_city_no', points: 0 },
...
export const kawanishiData: MunicipalityData = {
  municipality,
  questions: [
