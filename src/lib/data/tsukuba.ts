...
// ---------------------------------------------------------------------------
// つくば市 保育園入園 利用調整基準データ
// 出典: つくば市「令和8年度 保育所入所のご案内」
// https://www.city.tsukuba.lg.jp/soshikikarasagasu/kodomobuyojihoikuka/gyomuannai/5/2/1015515.html
// ---------------------------------------------------------------------------
// つくば市は「基準指数（父母それぞれ最大10点）＋ 調整点数」の加算方式。
...
const employmentOptions = (prefix: string) => [
  ...
  { label: '月60時間以上64時間未満', value: `${prefix}_employment_5`, points: 5 },
];
...
function buildParentQuestions(parentNum: 1 | 2): Question[] {
  ...
  const reasonQuestion: Question = {
    ...
    helpText: 'つくば市では父母それぞれの基準点数（各最大10点）の合計で選考されます',
    inputType: 'select',
    options: [
