...
// ---------------------------------------------------------------------------
// 秦野市 保育園入園 基礎点数・調整点数データ
// ---------------------------------------------------------------------------
// 秦野市は「基礎点数（父母それぞれ）＋ 調整点数」の加算方式。
// 就労は月あたりの就労時間で点数を判定。
...
const disabilityOptions = (prefix: string) => [
  ...
  { label: '身体1〜2級/精神1〜3級/療育手帳', value: `${prefix}_disability_20`, points: 20 },
  { label: '身体3〜4級', value: `${prefix}_disability_16`, points: 16 },
];

/** 介護・看護 */
const careOptions = (prefix: string) => [
  { label: 'あてはまらない', value: `${prefix}_care_none`, points: 0 },
  { label: '常時介護が必要', value: `${prefix}_care_20`, points: 20 },
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '秦野市外から申し込みますか？',
    helpText: '秦野市に住民登録がない場合は減点になります',
    inputType: 'radio',
    options: [
      { label: 'いいえ（秦野市在住）', value: 'adj_outside_city_no', points: 0 },
  ...
  },
  {
    ...
    helpText: '現在通っている認可保育園から別の認可保育園への転園は減点になります',
    inputType: 'radio',
    options: [
