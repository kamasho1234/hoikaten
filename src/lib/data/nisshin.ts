...
// ---------------------------------------------------------------------------
// 日進市 保育園入園 基本指数・調整指数データ
// 出典: 日進市こども保育課「令和8年度 保育園・認定こども園・小規模保育事業所利用案内」
// https://www.city.nisshin.lg.jp/department/kenko/hoiku/6/2/2/hoiku/17569.html
// 参考: 同県内（春日井市）の基準を参考に構成
// 注: 公式PDFが未確認のため、愛知県標準基準を参考値として設定
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '日進市外にお住まいですか？',
    helpText: '市外から日進市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（日進市在住）', value: 'adj_outside_city_no', points: 0 },
