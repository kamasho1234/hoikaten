...
// ---------------------------------------------------------------------------
// 伊勢市 保育園入園 基本点数・調整指数データ
// 出典: 伊勢市子ども家庭課「令和8年度 保育施設等利用案内」
// https://www.city.ise.mie.jp/
// 参考: 同県内（桑名市・松阪市）の指数表に準じた三重県標準方式
// ---------------------------------------------------------------------------
// 伊勢市は「基本点数（父母それぞれ最大20点）＋ 調整指数」の加算方式。
// 合計基本点数最大40点。
// ---------------------------------------------------------------------------
...
const illnessOptions = (prefix: string) => [
  ...
  { label: '安静を要する（自宅療養）', value: `${prefix}_illness_17`, points: 17 },
  { label: '通院加療中（週2日以上）', value: `${prefix}_illness_13`, points: 13 },
];

const disabilityOptions = (prefix: string) => [
  { label: 'あてはまらない', value: `${prefix}_disability_none`, points: 0 },
  { label: '身体障害手帳1・2級 / 療育手帳A', value: `${prefix}_disability_20`, points: 20 },
  { label: '身体障害手帳3・4級 / 療育手帳B', value: `${prefix}_disability_17`, points: 17 },
  { label: '精神障害者保健福祉手帳1・2級', value: `${prefix}_disability_17b`, points: 17 },
  { label: 'その他の手帳所持', value: `${prefix}_disability_13`, points: 13 },
];
