...
// ---------------------------------------------------------------------------
// 栃木市 保育園入園 基本指数・調整指数データ
// 出典: 各市子育て支援課/保育課の利用調整基準に基づく典型的な指数体系
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '栃木市外にお住まいですか？',
    helpText: '市外から栃木市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（栃木市在住）', value: 'adj_outside_city_no', points: 0 },
      { label: 'はい（市外在住）', value: 'adj_outside_city_yes', points: -5 },
    ],
  },
  {
    id: 'adj_grandparent',
...
export const tochigiCityData: MunicipalityData = {
  municipality,
  questions: [
