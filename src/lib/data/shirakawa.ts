...
// 白河市 保育園入園 利用調整基準データ
// 出典: 白河市「令和8年度 保育のご案内」
// https://www.city.shirakawa.fukushima.jp/page/page010222.html
// ---------------------------------------------------------------------------
// 白河市は「基準点数（父母それぞれ最大10点）＋ 調整点数」の加算方式。
...
function buildParentQuestions(parentNum: 1 | 2): Question[] {
  ...
  const reasonQuestion: Question = {
    ...
    helpText: '白河市では父母それぞれの基準点数（各最大10点）の合計で選考されます',
    inputType: 'select',
    options: [
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'きょうだいが同じ施設に在園（+4）', value: 'adj_sibling_same_yes', points: 4 },
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '申込児童のきょうだいが2人以上（小学校含む）いますか？',
    inputType: 'radio',
    options: [
...
export const shirakwaData: MunicipalityData = {
  municipality,
  questions: [
