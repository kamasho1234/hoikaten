...
// ---------------------------------------------------------------------------
// 大和市 保育園入園 基本指数・調整指数データ
// ---------------------------------------------------------------------------
// 大和市は「基本指数（父母それぞれ）＋ 調整指数」の加算方式。
// 就労は月あたりの日数と1日あたりの時間の組み合わせで判定。
...
const disabilityOptions = (prefix: string) => [
  ...
  { label: '身体3級/精神2級/療育B', value: `${prefix}_disability_16`, points: 16 },
  { label: '身体4級/精神3級', value: `${prefix}_disability_12`, points: 12 },
];

/** 介護・看護 */
const careOptions = (prefix: string) => [
  { label: 'あてはまらない', value: `${prefix}_care_none`, points: 0 },
  { label: '常時介護が必要（月20日以上かつ1日8時間以上）', value: `${prefix}_care_20`, points: 20 },
  { label: '週4日以上の介護（月16日以上かつ1日6時間以上）', value: `${prefix}_care_16`, points: 16 },
  { label: '週3日程度の介護（月12日以上かつ1日4時間以上）', value: `${prefix}_care_12`, points: 12 },
];
...
const educationOptions = (prefix: string) => [
  ...
  { label: '就学・職業訓練（月20日以上かつ1日8時間以上）', value: `${prefix}_education_20`, points: 20 },
  { label: '就学・職業訓練（月16日以上かつ1日6時間以上）', value: `${prefix}_education_16`, points: 16 },
  ...
  const detailQuestions: Question[] = [
    {
      ...
      helpText: '月あたりの日数と1日あたりの時間の組み合わせを選んでください',
      inputType: 'radio',
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '大和市外から申し込みますか？',
    helpText: '市外からの申込は大幅な減点になります',
    inputType: 'radio',
    options: [
      { label: 'いいえ（大和市民）', value: 'adj_outside_city_no', points: 0 },
  ...
  },
  {
    id: 'adj_relative',
    category: 'adjustment',
    label: '65歳未満の同居親族が保育できる状況ですか？',
    helpText: '保育可能な同居親族がいる場合は減点になります',
    inputType: 'radio',
    options: [
      { label: 'いいえ', value: 'adj_relative_no', points: 0 },
      { label: 'はい', value: 'adj_relative_yes', points: -3 },
    ],
  },
  {
    id: 'adj_transfer',
...
export const yamatoData: MunicipalityData = {
  municipality,
  questions: [
