...
// ---------------------------------------------------------------------------
// 津山市 保育園入園 基本指数・調整指数データ
// 出典: 津山市こども保育課「令和8年度 保育施設利用のご案内」/ 岡山県内自治体の標準方式に準じた推定値
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '津山市外にお住まいですか？',
    helpText: '市外から津山市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（津山市在住）', value: 'adj_outside_city_no', points: 0 },
...
export const tsuyamaData: MunicipalityData = {
  municipality,
  questions: [
