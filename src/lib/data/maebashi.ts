...
// ---------------------------------------------------------------------------
// 前橋市 保育園入園 選考基準点数・調整指数データ
// 出典：前橋市 令和8年度入所用 選考基準表
// https://www.city.maebashi.gunma.jp/soshiki/kodomomiraibu/kodomoshisetsu/gyomu/8/2/20836.html
// ---------------------------------------------------------------------------
...
export const maebashiData: MunicipalityData = {
  municipality,
  questions: [
