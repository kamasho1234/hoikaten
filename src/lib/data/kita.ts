...
const employmentOptions = (prefix: string) => [
  ...
  { label: '週4日以上かつ週32時間以上', value: `${prefix}_employment_9`, points: 9 },
  { label: '週3日以上かつ週24時間以上', value: `${prefix}_employment_8`, points: 8 },
  { label: '週3日以上かつ週16時間以上', value: `${prefix}_employment_6`, points: 6 },
...
const careOptions = (prefix: string) => [
  ...
  { label: '週5日以上かつ週40時間以上の介護', value: `${prefix}_care_10`, points: 10 },
  { label: '週4日以上かつ週32時間以上の介護', value: `${prefix}_care_9`, points: 9 },
  { label: '週3日以上かつ週24時間以上の介護', value: `${prefix}_care_8`, points: 8 },
  { label: '月48時間以上の介護', value: `${prefix}_care_5`, points: 5 },
];
...
const educationOptions = (prefix: string) => [
  ...
  { label: '週5日以上かつ週40時間以上', value: `${prefix}_education_10`, points: 10 },
  { label: '週3日以上かつ週24時間以上', value: `${prefix}_education_8`, points: 8 },
  { label: '月48時間以上', value: `${prefix}_education_5`, points: 5 },
];
...
const adjustmentQuestions: Question[] = [
  {
    id: 'adj_sibling',
    category: 'adjustment',
    label: 'きょうだいが在籍している園に申し込む、または同時にきょうだいで申し込みますか？',
    inputType: 'radio',
    options: [
  ...
  },
  {
    id: 'adj_hoikushi',
    category: 'adjustment',
    label: '保護者のどちらかが保育士として勤務していますか？',
    helpText: '区内または近隣の保育施設で保育士として就労中の場合',
    inputType: 'radio',
    options: [
...
export const kitaData: MunicipalityData = {
  municipality,
  questions: [
