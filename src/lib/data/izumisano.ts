...
// ---------------------------------------------------------------------------
// 泉佐野市 保育園入園 基本指数・調整指数データ
// 出典: 泉佐野市子ども育成室保育課「令和8年度 保育施設利用のご案内」/ 大阪府南部自治体の標準方式に準じた推定値
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '泉佐野市外にお住まいですか？',
    helpText: '市外から泉佐野市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（泉佐野市在住）', value: 'adj_outside_city_no', points: 0 },
