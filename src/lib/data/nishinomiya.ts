...
// ---------------------------------------------------------------------------
// 西宮市 保育園入園 基本点数・調整点数データ
// 出典：西宮市 利用調整基準表（令和8年4月1日入園の利用調整から適用）
...
const employmentOfferOptions = (prefix: string) => [
  ...
  { label: 'パートタイム相当の内定', value: `${prefix}_offer_50`, points: 50 },
];
...
const adjustmentQuestions: Question[] = [
  {
    ...
    category: 'adjustment',
    label: 'ひとり親ですか？',
    helpText: 'ひとり親の場合、片方の保護者の基本点数100点と調整加点が加算されます',
    inputType: 'radio',
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'きょうだいが在園中で、同じ園を第一希望にする', value: 'adj_sibling_first', points: 12 },
      { label: 'きょうだいが在園中（上記以外）', value: 'adj_sibling_other', points: 6 },
      { label: 'きょうだいと同時に申し込む（双子など）', value: 'adj_sibling_simultaneous', points: 4 },
    ],
  },
  {
  ...
  },
  {
    ...
    helpText: '保育所を利用していない未就学のきょうだいがいる場合',
    inputType: 'radio',
    options: [
      { label: 'いいえ', value: 'adj_preschool_sibling_no', points: 0 },
      { label: 'はい', value: 'adj_preschool_sibling_yes', points: -3 },
    ],
  },
];
...
export const nishinomiyaData: MunicipalityData = {
  municipality,
  questions: [
