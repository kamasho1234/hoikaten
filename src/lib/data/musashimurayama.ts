...
// ---------------------------------------------------------------------------
// 武蔵村山市 保育園入園 基準指数・調整指数データ
// 出典: 武蔵村山市「令和8年4月 保育所等入所のご案内」
// https://www.city.musashimurayama.lg.jp/kosodate/azukeru/1012423/1013117.html
// 注：公式の基準指数表が未公開のため、東京都（同じ立川市）の基準を参考に作成
// ---------------------------------------------------------------------------
// 武蔵村山市は東京都の基準に従い「基準指数（父母それぞれ）＋ 調整指数」の加算方式。
