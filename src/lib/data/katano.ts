...
// ---------------------------------------------------------------------------
// 交野市 保育園入園 基本指数・調整指数データ
// 出典: 交野市こども園課「令和7年度 利用調整基準表」
// 参考: 大阪府の枚方市の基準を参照（大阪府内で同基準を使用している自治体が多い）
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: '交野市内の施設に勤務（予定含む）', value: 'adj_nursery_worker_city', points: 10 },
...
export const katanoData: MunicipalityData = {
  municipality,
  questions: [
