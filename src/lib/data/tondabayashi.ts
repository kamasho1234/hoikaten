...
// ---------------------------------------------------------------------------
// 富田林市 保育園入園 基本指数・調整指数データ
// 出典: 富田林市こども未来部こども育成課「令和8年度 保育所等利用ガイドブック」
// https://www.city.tondabayashi.lg.jp/soshiki/109/129578.html
// ---------------------------------------------------------------------------
// 富田林市は大阪府の基準に準拠し、父母各最大100点の体系を採用しています。
// 公式ガイドブックの「保育所等利用調整基準」で詳細が確認できます。
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: '富田林市内の施設に勤務（予定含む）', value: 'adj_nursery_worker_city', points: 10 },
...
export const tondabayashiData: MunicipalityData = {
  municipality,
  questions: [
