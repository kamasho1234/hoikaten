...
// ---------------------------------------------------------------------------
// 佐倉市 保育園入園 基準指数・調整指数データ
// 出典: 佐倉市こども保育課「令和8年度保育施設利用のご案内」
// https://www.city.sakura.lg.jp/soshiki/kodomohoikuka/7/15811.html
// 参考: 同県内（我孫子市）の基準を参考に、父母それぞれ最大20点で構成
// 注: 公式PDFが未確認のため、千葉県標準基準を参考値として設定
// ---------------------------------------------------------------------------
// 佐倉市は「基準指数（父母それぞれ）＋ 調整指数」の加算方式。
// 父母それぞれ最大20点（参考値）。
// 就労は月の就労時間で判定。月160時間以上で満点の20点。
// 同点の場合：基準指数の高い方＞所得の低い方で判定
// ---------------------------------------------------------------------------
