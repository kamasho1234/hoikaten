...
// ---------------------------------------------------------------------------
// 綾瀬市 保育園入園 基本指数・調整指数データ
// 参考値（公式PDFが非公開のため近隣自治体基準を参照）
// 参考: 厚木市「令和8年度認可保育園入園申込み」
// https://www.city.atsugi.kanagawa.jp/
// 参考: 綾瀬市保育所条例施行規則
// https://www1.g-reiki.net/ayase/reiki_honbun/k700RG00000276.html
// ---------------------------------------------------------------------------
// 綾瀬市は「基本指数（父母それぞれ）＋ 調整指数」の加算方式。
// 基本指数: 父母それぞれ最大20点（合計40点満点）
// ---------------------------------------------------------------------------
...
const illnessOptions = (prefix: string) => [
  ...
  { label: '安静を要する通院加療', value: `${prefix}_illness_16`, points: 16 },
...
const disabilityOptions = (prefix: string) => [
  ...
  { label: '身体5〜6級/精神3級', value: `${prefix}_disability_12`, points: 12 },
];

/** 介護・看護 */
const careOptions = (prefix: string) => [
  { label: 'あてはまらない', value: `${prefix}_care_none`, points: 0 },
  { label: '常時介護が必要（要介護4〜5等）', value: `${prefix}_care_20`, points: 20 },
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    id: 'adj_outside_city',
    category: 'adjustment',
    label: '綾瀬市外からの申し込みですか？',
    helpText: '市外在住の場合は減点されます',
    inputType: 'radio',
    options: [
      { label: 'いいえ（綾瀬市在住）', value: 'adj_outside_city_no', points: 0 },
  ...
  },
  {
    ...
    helpText: '現在在園中の認可保育園から別の認可保育園への転園希望の場合です',
    inputType: 'radio',
    options: [
