...
// ---------------------------------------------------------------------------
// 深谷市 保育園入園 基本指数・調整指数データ
// 出典: 深谷市子ども未来部保育課「令和8年度保育園・認定こども園・小規模保育室 入園手引き」
// 公式URL: https://www.city.fukaya.saitama.jp/soshiki/kodomomirai/hoiku/tanto/hoikushisetsu/hoikuen/1391407065674.html
// 注: 埼玉県内の標準的な利用調整基準を参考値として採用
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '深谷市外にお住まいですか？',
    helpText: '市外から深谷市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（深谷市在住）', value: 'adj_outside_city_no', points: 0 },
...
export const fukayaData: MunicipalityData = {
  municipality,
  questions: [
