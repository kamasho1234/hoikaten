...
// ---------------------------------------------------------------------------
// 三木市 保育園入園 基本指数・調整指数データ
// 出典: 三木市子育て支援課「令和8年度 保育施設利用のご案内」
//       兵庫県標準方式に準じた推定値
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '三木市外にお住まいですか？',
    helpText: '市外から三木市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（三木市在住）', value: 'adj_outside_city_no', points: 0 },
...
export const mikiData: MunicipalityData = {
  municipality,
  questions: [
