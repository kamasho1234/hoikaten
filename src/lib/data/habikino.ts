...
// ---------------------------------------------------------------------------
// 羽曳野市 保育園入園 基準指数・調整指数データ
// ---------------------------------------------------------------------------
// 羽曳野市は「基準指数（父母それぞれ）＋ 調整指数」の加算方式。
// 大阪府内の標準的な基準を採用。父母各最大100点（合計200点満点）。
// 公式情報が見つからないため、同府の枚方市基準を参考値として使用。
// ---------------------------------------------------------------------------
...
export const habikinoData: MunicipalityData = {
  municipality,
  questions: [
