...
// ---------------------------------------------------------------------------
// 大村市 保育園入園 基本指数・調整指数データ
// 出典: 大村市こども部保育幼稚園課「令和8年度 保育施設利用のご案内」
//       長崎県内自治体の標準方式に準じた推定値
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '大村市外にお住まいですか？',
    helpText: '市外から大村市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（大村市在住）', value: 'adj_outside_city_no', points: 0 },
...
export const omuraData: MunicipalityData = {
  municipality,
  questions: [
