...
// ---------------------------------------------------------------------------
// 木更津市 保育園入園 基準点数・調整点数データ
// 出典: 木更津市「令和8年度木更津市保育施設入園のご案内」
// https://www.city.kisarazu.lg.jp/soshiki/kenkokodomo/kodomohoiku/1/4345.html
// 注: 公式の詳細基準表取得が困難なため、千葉県内の標準的な基準を参考値として実装
// 実運用時には木更津市役所こども保育課（0438-23-7245）に確認を推奨
// ---------------------------------------------------------------------------
// 木更津市は「基準点数（父母それぞれ）＋ 調整点数」の加算方式。
