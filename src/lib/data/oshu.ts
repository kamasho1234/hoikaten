...
// ---------------------------------------------------------------------------
// 奥州市 保育園入園 基本指数・調整指数データ
// 出典: 奥州市子ども未来部保育課「令和8年度 保育施設利用のご案内」/ 岩手県内自治体の標準方式に準じた推定値
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '奥州市外にお住まいですか？',
    helpText: '市外から奥州市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（奥州市在住）', value: 'adj_outside_city_no', points: 0 },
