...
// ---------------------------------------------------------------------------
// 久喜市 保育園入園 基本指数・調整指数データ
// 出典: 久喜市子ども未来部保育課「令和8年度 保育施設利用のご案内」
// 参考値: 埼玉県内自治体の標準基準に準拠
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '久喜市外にお住まいですか？',
    helpText: '市外から久喜市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（久喜市在住）', value: 'adj_outside_city_no', points: 0 },
...
export const kukiData: MunicipalityData = {
  municipality,
  questions: [
