...
// ---------------------------------------------------------------------------
// 姫路市 保育園入園 利用調整基準データ
// 出典: 姫路市「保育施設等利用調整基準表（令和8年4月入所以降適用）」
// ---------------------------------------------------------------------------
...
const disabilityOptions = (prefix: string) => [
  ...
  { label: '重度（身体1・2級等）', value: `${prefix}_disability_10`, points: 10 },
  { label: '中度（身体3級等）', value: `${prefix}_disability_8`, points: 8 },
  { label: '軽度（身体4級以下）', value: `${prefix}_disability_6`, points: 6 },
];
...
const careOptions = (prefix: string) => [
  ...
  { label: '月64時間以上120時間未満の介護', value: `${prefix}_care_6`, points: 6 },
];
...
const educationOptions = (prefix: string) => [
  ...
  { label: '月120時間以上の就学', value: `${prefix}_education_9`, points: 9 },
  { label: '月64時間以上120時間未満', value: `${prefix}_education_7`, points: 7 },
];
...
export const himejiData: MunicipalityData = {
  municipality,
  questions: [
