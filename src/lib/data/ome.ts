...
// ---------------------------------------------------------------------------
// 青梅市 保育園入園 基本指数・調整指数データ
// 出典: 青梅市「令和8年度 保育施設入園案内」
// ---------------------------------------------------------------------------
// 青梅市は「基本指数（父母それぞれ）＋ 調整指数」の加算方式。
// 就労は月あたりの日数と1日あたりの時間で判定。
  ...
  const detailQuestions: Question[] = [
    {
      ...
      helpText: '月あたりの日数と1日あたりの時間で判定されます',
      inputType: 'radio',
    ...
    },
    {
      ...
      helpText: '月あたりの日数と1日あたりの時間を選んでください',
      inputType: 'radio',
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '青梅市に住んでいますか？',
    helpText: '青梅市外からの申込みは減点になります',
    inputType: 'radio',
    options: [
      { label: 'はい（青梅市在住）', value: 'adj_ome_resident_yes', points: 0 },
      { label: 'いいえ（市外在住）', value: 'adj_ome_resident_no', points: -10 },
    ],
  },
  {
...
export const omeData: MunicipalityData = {
  municipality,
  questions: [
