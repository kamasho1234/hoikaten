...
// ---------------------------------------------------------------------------
// 藤岡市 保育園入園 基本指数・調整指数データ
// 出典: 藤岡市健康福祉部子ども課「令和8年度 保育園等入園のご案内」
// https://www.city.fujioka.gunma.jp/soshiki/kenkohukushibu/kodomo/1/9/kyouikuhoikusisetu/8549.html
// ---------------------------------------------------------------------------
// 藤岡市は「基準点数（父母それぞれ最大20点）＋ 調整点数」の加算方式。
...
export const fujiokaData: MunicipalityData = {
  municipality,
  questions: [
