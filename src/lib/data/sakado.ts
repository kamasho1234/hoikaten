...
// ---------------------------------------------------------------------------
// 坂戸市 保育園入園 基本指数・調整指数データ
// 出典: 坂戸市「令和8年度 保育園・こども園等の入園案内」
// https://www.city.sakado.lg.jp/soshiki/32/54391.html
// 注：公式の選考基準表が未公開のため、埼玉県（上尾市）の基準を参考に作成
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '坂戸市外にお住まいですか？',
    helpText: '市外から坂戸市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（坂戸市在住）', value: 'adj_outside_city_no', points: 0 },
