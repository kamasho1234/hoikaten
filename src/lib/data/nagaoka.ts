...
// ---------------------------------------------------------------------------
// 長岡市 保育園入園 基本指数・調整指数データ
// 出典: 長岡市保育課「令和8年度 保育施設利用調整基準」
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '長岡市外にお住まいですか？',
    helpText: '市外から長岡市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（長岡市在住）', value: 'adj_outside_city_no', points: 0 },
...
export const nagaokaData: MunicipalityData = {
  municipality,
  questions: [
