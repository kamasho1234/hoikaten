...
// ---------------------------------------------------------------------------
// 鴻巣市 保育園入園 基本指数・調整指数データ
// 出典: 鴻巣市子ども未来部保育課「令和8年度 保育施設入所案内」
// 参考: 埼玉県標準基準（上尾市、さいたま市に準拠）
// https://www.city.kounosu.saitama.jp/page/35346.html
// ---------------------------------------------------------------------------
// 鴻巣市は埼玉県内の標準基準に基づき、父母それぞれ最大20点の基本指数制を採用
// 基本指数（父・母各最大20点）+ 調整指数の加算方式
// 就労時間により判定：月160時間以上で満点の20点
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '鴻巣市外にお住まいですか？',
    helpText: '市外から鴻巣市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（鴻巣市在住）', value: 'adj_outside_city_no', points: 0 },
