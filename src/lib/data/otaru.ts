...
// ---------------------------------------------------------------------------
// 小樽市 保育所等利用申込み基準データ
// 出典：小樽市子ども未来部保育課「保育所等利用申込みの御案内」参考・利用調整（選考）基準表に基づき保護者の低い方の基本点を採用するmin方式
// ---------------------------------------------------------------------------
...
const employmentOptions = (prefix: string) => [
  ...
  { label: '月140時間以上160時間未満', value: `${prefix}_employment_85`, points: 85 },
  { label: '月120時間以上140時間未満', value: `${prefix}_employment_75`, points: 75 },
  { label: '月100時間以上120時間未満', value: `${prefix}_employment_65`, points: 65 },
  { label: '月80時間以上100時間未満', value: `${prefix}_employment_55`, points: 55 },
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '転園を希望していますか？',
    helpText: '小樽市が継続して保育を実施しており、別の保育所等への入所を希望する場合',
    inputType: 'radio',
    options: [
...
export const otaruData: MunicipalityData = {
  municipality,
  questions: [
