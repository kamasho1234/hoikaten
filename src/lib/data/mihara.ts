...
// ---------------------------------------------------------------------------
// 三原市 保育園入園 基本指数・調整指数データ
// 出典: 三原市こども家庭課「令和8年度 保育施設利用のご案内」
//      / 広島県内自治体の標準方式に準じた推定値
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '三原市外にお住まいですか？',
    helpText: '市外から三原市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（三原市在住）', value: 'adj_outside_city_no', points: 0 },
...
export const miharaData: MunicipalityData = {
  municipality,
  questions: [
