...
const employmentOptions = (prefix: string) => [
  ...
  { label: '月20日以上かつ週30時間以上40時間未満', value: `${prefix}_employment_18`, points: 18 },
  { label: '月20日以上かつ週20時間以上30時間未満', value: `${prefix}_employment_16`, points: 16 },
  { label: '月16日以上かつ週30時間以上', value: `${prefix}_employment_17`, points: 17 },
  { label: '月16日以上かつ週20時間以上30時間未満', value: `${prefix}_employment_14`, points: 14 },
...
const educationOptions = (prefix: string) => [
  ...
  { label: '月16日以上かつ週20時間以上', value: `${prefix}_education_16`, points: 16 },
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    id: 'adj_sibling',
    category: 'adjustment',
    label: 'きょうだいが品川区内の認可保育園に在園していますか？',
    inputType: 'radio',
    options: [
      { label: 'いいえ', value: 'adj_sibling_no', points: 0 },
      { label: 'きょうだいが在園中', value: 'adj_sibling_enrolled', points: 3 },
      { label: 'きょうだいと同時申込', value: 'adj_sibling_simultaneous', points: 1 },
    ],
  },
  {
    ...
    helpText: '月48時間以上、有償で預けている場合（ベビーシッター含む）',
    inputType: 'radio',
    options: [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: 'パパ・ママのどちらかが会社命令で単身赴任中ですか？',
    inputType: 'radio',
    options: [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '申込締切日時点で勤務実績が3ヶ月未満ですか？',
    helpText: '転職して間もない場合など（1ヶ月以内の転職は除く）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（3ヶ月以上の実績あり）', value: 'adj_work_experience_no', points: 0 },
      { label: 'はい（3ヶ月未満）', value: 'adj_work_experience_yes', points: -1 },
    ],
  },
];
...
export const shinagawaData: MunicipalityData = {
  municipality,
  questions: [
