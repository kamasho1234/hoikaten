...
// ---------------------------------------------------------------------------
// 八王子市 保育園入園 基準指数・調整指数データ
// 出典: 八王子市「保育所等利用調整基準指数表（令和8年度版）」
// ---------------------------------------------------------------------------
...
const employmentOptions = (prefix: string) => [
  ...
  { label: '週40時間以上の就労', value: `${prefix}_employment_10`, points: 10 },
  { label: '週35時間以上40時間未満', value: `${prefix}_employment_9`, points: 9 },
  { label: '週30時間以上35時間未満', value: `${prefix}_employment_8`, points: 8 },
  { label: '週25時間以上30時間未満', value: `${prefix}_employment_7`, points: 7 },
  { label: '週16時間以上25時間未満', value: `${prefix}_employment_6`, points: 6 },
];
...
const careOptions = (prefix: string) => [
  ...
  { label: '週40時間以上の介護', value: `${prefix}_care_10`, points: 10 },
  { label: '週30時間以上40時間未満の介護', value: `${prefix}_care_8`, points: 8 },
  { label: '週16時間以上30時間未満の介護', value: `${prefix}_care_6`, points: 6 },
];
...
const educationOptions = (prefix: string) => [
  ...
  { label: '週40時間以上の就学', value: `${prefix}_education_10`, points: 10 },
  { label: '週30時間以上40時間未満', value: `${prefix}_education_8`, points: 8 },
  { label: '週16時間以上30時間未満', value: `${prefix}_education_6`, points: 6 },
];
...
export const hachiojiData: MunicipalityData = {
  municipality,
  questions: [
