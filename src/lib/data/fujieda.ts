...
// ---------------------------------------------------------------------------
// 藤枝市 保育園入園 基本指数・調整指数データ
// 出典: 藤枝市こども未来部保育課「令和8年度 保育施設等利用案内」
// https://www.city.fujieda.shizuoka.jp/kosodate_kyoiku/hoiku/hoiku_nyuujo/1001781.html
// 参考: 同県内（磐田市・富士市）の指数表に準じた静岡県標準方式
// ---------------------------------------------------------------------------
// 藤枝市は「基本指数（父母それぞれ）＋ 調整指数」の加算方式。
// 父母各最大20点（合計40点）。
// ---------------------------------------------------------------------------
