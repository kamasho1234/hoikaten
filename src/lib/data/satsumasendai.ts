...
// ---------------------------------------------------------------------------
// 薩摩川内市 保育園入園 基本指数・調整指数データ
// 出典: 薩摩川内市子育て支援課「令和8年度 保育施設利用のご案内」
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    id: 'adj_outside_city',
    category: 'adjustment',
    label: '薩摩川内市外にお住まいですか？',
    helpText: '市外から薩摩川内市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（薩摩川内市在住）', value: 'adj_outside_city_no', points: 0 },
