...
// ---------------------------------------------------------------------------
// 富士見市 保育園入園 基準指数・調整指数データ
// 出典: 富士見市「令和8年度 保育施設入所案内」
// https://www.city.fujimi.saitama.jp/kosodate_kyoiku/kosodate_oen/yochien_hoikusho/hoikusho/hoikusyonyusyo/r4_4gatsunyuusyo.html
// ---------------------------------------------------------------------------
// 富士見市は「基準指数（父母の低い方を採用）＋ 調整指数」の方式。
// 父母それぞれ最大20点。フルタイム共働きで基本ライン。
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '富士見市外にお住まいですか？',
    helpText: '市外から富士見市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（富士見市在住）', value: 'adj_outside_city_no', points: 0 },
...
export const fujimiData: MunicipalityData = {
  municipality,
  questions: [
