...
// ---------------------------------------------------------------------------
// 安曇野市 保育園入園 利用調整基準データ
// 出典: 安曇野市「令和8年度 安曇野市保育ガイド」
// https://www.city.azumino.nagano.jp/site/hoikuen/
// ---------------------------------------------------------------------------
// 安曇野市は「基準点数（父母それぞれ最大10点）＋ 調整点数」の加算方式。
...
const employmentOptions = (prefix: string) => [
  ...
  { label: '就職決定者 / 派遣開始予定者', value: `${prefix}_employment_3`, points: 3 },
];
...
const disabilityOptions = (prefix: string) => [
  ...
  { label: '身体1・2級 / 精神1級 / 療育手帳A', value: `${prefix}_disability_10`, points: 10 },
  { label: '身体3・4級 / 精神2級 / 療育手帳B1', value: `${prefix}_disability_8`, points: 8 },
  { label: '身体5・6級 / 精神3級 / 療育手帳B2', value: `${prefix}_disability_6`, points: 6 },
];
...
function buildParentQuestions(parentNum: 1 | 2): Question[] {
  ...
  const reasonQuestion: Question = {
    ...
    helpText: '安曇野市では父母それぞれの基準点数（各最大10点）の合計で選考されます',
    inputType: 'select',
    options: [
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    inputType: 'radio',
    options: [
      { label: 'あてはまらない', value: 'adj_siblings_no', points: 0 },
      { label: 'きょうだいが別施設に在園（+4）', value: 'adj_siblings_outside_yes', points: 4 },
      { label: 'きょうだいが同施設に在園（+2）', value: 'adj_siblings_same_yes', points: 2 },
    ],
  },
  {
  ...
  {
    id: 'adj_special_needs_sibling',
    category: 'adjustment',
    label: '障害児や医療的ケアが必要な子どもがいますか？',
    inputType: 'radio',
    options: [
...
export const azuminoData: MunicipalityData = {
  municipality,
  questions: [
