...
// ---------------------------------------------------------------------------
// 熊本市 保育園入園 基準点数・調整点数データ
// 出典: 熊本市「保育所等申込案内（令和8年度版）」
// ---------------------------------------------------------------------------
...
const employmentOfferOptions = (prefix: string) => [
  ...
  { label: '月48時間以上相当の内定', value: `${prefix}_offer_60`, points: 60 },
];
...
const educationOptions = (prefix: string) => [
  ...
  { label: '月48時間以上', value: `${prefix}_education_70`, points: 70 },
];
...
export const kumamotoData: MunicipalityData = {
  municipality,
  questions: [
