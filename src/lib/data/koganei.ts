...
// ---------------------------------------------------------------------------
// 小金井市 保育園入園 基本指数・調整指数データ
// 出典: 小金井市「令和8年度 保育施設入園案内」
// ---------------------------------------------------------------------------
// 小金井市は「基本指数（父母それぞれ）＋ 調整指数」の加算方式。
// 就労は月あたりの就労日数・1日の就労時間で判定。
...
const careOptions = (prefix: string) => [
  ...
  { label: '週24時間以上40時間未満の介護・看護', value: `${prefix}_care_16`, points: 16 },
  { label: '週16時間以上24時間未満の介護・看護', value: `${prefix}_care_12`, points: 12 },
];
  ...
  const detailQuestions: Question[] = [
    {
      ...
      helpText: '月あたりの就労日数と1日の就労時間で判定されます',
      inputType: 'radio',
    ...
    },
    {
      ...
      helpText: '月あたりの通学日数と1日の通学時間を選んでください',
      inputType: 'radio',
...
const adjustmentQuestions: Question[] = [
  ...
  {
    id: 'adj_koganei_resident',
    category: 'adjustment',
    label: '小金井市に住んでいますか？',
    helpText: '小金井市外からの申込みは減点になります',
    inputType: 'radio',
    options: [
      { label: 'はい（小金井市在住）', value: 'adj_koganei_resident_yes', points: 0 },
      { label: 'いいえ（市外在住）', value: 'adj_koganei_resident_no', points: -10 },
    ],
  },
  {
...
export const koganeiData: MunicipalityData = {
  municipality,
  questions: [
