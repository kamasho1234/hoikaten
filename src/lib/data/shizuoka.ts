...
const employmentOptions = (prefix: string) => [
  ...
  { label: '月80時間以上120時間未満', value: `${prefix}_employment_8`, points: 8 },
  { label: '月64時間以上80時間未満', value: `${prefix}_employment_7`, points: 7 },
...
const disabilityOptions = (prefix: string) => [
  ...
  { label: '身体障害者手帳1・2級等', value: `${prefix}_disability_10`, points: 10 },
  { label: '身体障害者手帳3級等', value: `${prefix}_disability_8`, points: 8 },
  { label: '身体障害者手帳4級以下等', value: `${prefix}_disability_6`, points: 6 },
];

/** 介護 */
const careOptions = (prefix: string) => [
  { label: 'あてはまらない', value: `${prefix}_care_none`, points: 0 },
  { label: '月160時間以上の介護', value: `${prefix}_care_10`, points: 10 },
  { label: '月120時間以上160時間未満の介護', value: `${prefix}_care_8`, points: 8 },
  { label: '月48時間以上120時間未満の介護', value: `${prefix}_care_6`, points: 6 },
];
...
const educationOptions = (prefix: string) => [
  ...
  { label: '月120時間以上160時間未満', value: `${prefix}_education_8`, points: 8 },
  { label: '月48時間以上120時間未満', value: `${prefix}_education_6`, points: 6 },
];
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '認可外の保育施設や一時預かりを利用していますか？',
    helpText: '利用頻度で加点が異なります',
    inputType: 'radio',
    options: [
      { label: 'いいえ', value: 'adj_unlicensed_nursery_no', points: 0 },
      { label: 'はい（週3回以上）', value: 'adj_unlicensed_nursery_3', points: 2 },
      { label: 'はい（週1回以上3回未満）', value: 'adj_unlicensed_nursery_1', points: 1 },
    ],
  },
  {
...
export const shizuokaData: MunicipalityData = {
  municipality,
  questions: [
