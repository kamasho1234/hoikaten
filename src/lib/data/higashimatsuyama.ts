...
// ---------------------------------------------------------------------------
// 東松山市 保育園入園 基本指数・調整指数データ
// 出典: 東松山市保育課「保育施設利用調整基準」（参考値）
// 注: 詳細な利用調整基準表PDFは東松山市公式サイトで最新版をご確認ください
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '東松山市外にお住まいですか？',
    helpText: '市外から東松山市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（東松山市在住）', value: 'adj_outside_city_no', points: 0 },
