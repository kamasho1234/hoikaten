...
// ---------------------------------------------------------------------------
// 伊勢崎市 保育園入園 基本指数・調整指数データ
// 出典: 伊勢崎市子育て支援課「令和8年度 保育施設利用のご案内」
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '伊勢崎市外にお住まいですか？',
    helpText: '市外から伊勢崎市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（伊勢崎市在住）', value: 'adj_outside_city_no', points: 0 },
...
export const isesakiData: MunicipalityData = {
  municipality,
  questions: [
