...
// ---------------------------------------------------------------------------
// ふじみ野市 保育園入園 基本指数・調整指数データ
// 出典: ふじみ野市こども・元気健康部保育課「令和8年度ふじみ野市保育所利用のご案内」
// 公式URL: https://www.city.fujimino.saitama.jp/soshikiichiran/hoikuka/hoikugakari/nyusho/1560.html
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    id: 'adj_outside_city',
    category: 'adjustment',
    label: 'ふじみ野市外にお住まいですか？',
    helpText: '市外からふじみ野市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（ふじみ野市在住）', value: 'adj_outside_city_no', points: 0 },
