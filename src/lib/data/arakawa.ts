...
const employmentOptions = (prefix: string) => [
  ...
  { label: '月16日以上かつ1日8時間以上', value: `${prefix}_employment_17`, points: 17 },
  { label: '月16日以上かつ1日6時間以上8時間未満', value: `${prefix}_employment_16`, points: 16 },
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    id: 'adj_sibling',
    category: 'adjustment',
    label: '申込児以外のきょうだいが入園希望園に在園していますか？',
    inputType: 'radio',
    options: [
  ...
  },
  {
    id: 'adj_welfare',
    category: 'adjustment',
    label: '生活保護世帯で就労していますか？',
    helpText: '生活保護を受給中で、収入拡大につながる就労をしている場合',
    inputType: 'radio',
    options: [
...
export const arakawaData: MunicipalityData = {
  municipality,
  questions: [
