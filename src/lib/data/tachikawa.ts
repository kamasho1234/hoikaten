...
// ---------------------------------------------------------------------------
// 立川市 保育園入園 実施基準指数・調整指数データ
// 出典: 立川市「令和8年度 立川市保育施設利用申込みのしおり」実施基準指数表
// https://www.city.tachikawa.lg.jp/kosodate/m-kosodate/1004946/1005097/1025412.html
// ---------------------------------------------------------------------------
// 立川市は「実施基準指数（父母それぞれ）＋ 調整指数」の加算方式。
