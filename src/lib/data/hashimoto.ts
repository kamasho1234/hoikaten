...
// ---------------------------------------------------------------------------
// 橋本市 保育園入園 利用調整基準データ
// 出典: 橋本市「令和7年度 利用調整基準表」
// https://www.city.hashimoto.wakayama.jp/life/kosodate/hoikuen/r7kijun.pdf
// ---------------------------------------------------------------------------
// 橋本市は「基準点数（父母それぞれ最大10点）＋ 調整点数」の加算方式。
...
const employmentOptions = (prefix: string) => [
  ...
  { label: '派遣開始予定', value: `${prefix}_employment_3`, points: 3 },
];
...
const careOptions = (prefix: string) => [
  ...
  { label: '入院付添1月以上または要介護3～5', value: `${prefix}_care_10`, points: 10 },
  { label: '要介護1～2の介護', value: `${prefix}_care_6`, points: 6 },
];

const childbirthOptions = (prefix: string) => [
  { label: 'あてはまらない', value: `${prefix}_childbirth_none`, points: 0 },
  { label: '出産予定日2月前から出産後2月', value: `${prefix}_childbirth_9`, points: 9 },
];

const jobSeekingOptions = (prefix: string) => [
  { label: 'あてはまらない', value: `${prefix}_jobseeking_none`, points: 0 },
  { label: '求職中（開始から1月以内）', value: `${prefix}_jobseeking_3`, points: 3 },
];
...
function buildParentQuestions(parentNum: 1 | 2): Question[] {
  ...
  const reasonQuestion: Question = {
    ...
    helpText: '橋本市では父母それぞれの基準点数（各最大10点）の合計で選考されます',
    inputType: 'select',
    options: [
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'はい（同じ施設希望）（+4）', value: 'adj_sibling_same_yes', points: 4 },
      { label: 'はい（別の施設希望）（+2）', value: 'adj_sibling_different_yes', points: 2 },
    ],
  },
  {
    id: 'adj_siblings_count',
    category: 'adjustment',
    label: '申込児童のきょうだいの人数は？',
    inputType: 'radio',
    options: [
      { label: 'あてはまらない', value: 'adj_siblings_count_none', points: 0 },
      { label: '2人以上（+1）', value: 'adj_siblings_count_yes', points: 1 },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'はい（+2）', value: 'adj_facility_staff_yes', points: 2 },
    ],
  },
  {
    id: 'adj_disable_child',
    category: 'adjustment',
    label: '申込児童が心身に障害がありますか？',
    inputType: 'radio',
    options: [
      { label: 'いいえ', value: 'adj_disable_child_no', points: 0 },
      { label: 'はい（+1）', value: 'adj_disable_child_yes', points: 1 },
    ],
  },
  {
    id: 'adj_emergency_enrollment',
    category: 'adjustment',
    label: '緊急入所の事由がありますか？',
    inputType: 'radio',
    options: [
      { label: 'いいえ', value: 'adj_emergency_enrollment_no', points: 0 },
      { label: 'はい（+3）', value: 'adj_emergency_enrollment_yes', points: 3 },
    ],
  },
];

export const hashimotoData: MunicipalityData = {
  municipality,
  questions: [
