...
// ---------------------------------------------------------------------------
// 栗東市 保育園入園 基本指数・調整指数データ
// 出典：栗東市子育て支援課「栗東市保育所等の利用調整に関する基準（令和7年4月入所～）」参考
// ---------------------------------------------------------------------------
//
// 栗東市の選考指数は以下のように算出されます。
//   基本指数 ＝ 父の基本指数 ＋ 母の基本指数
//   選考指数 ＝ 基本指数 ± 調整指数
// 父母各最大20点、合計40点満点です。
// ---------------------------------------------------------------------------
...
const educationOptions = (prefix: string) => [
  ...
  { label: '就学のため（全日制）', value: `${prefix}_education_16`, points: 16 },
  { label: '就学のため（定時制・通信制）', value: `${prefix}_education_12`, points: 12 },
];
...
function buildParentQuestions(parentNum: 1 | 2): Question[] {
  ...
  const reasonQuestion: Question = {
    ...
    helpText: '栗東市では父母それぞれの基本指数の合計で選考されます。いちばん近いものをひとつ選んでください。',
    inputType: 'select',
    options: [
      ...
      { label: '学校等に就学中', value: `${prefix}_reason_education`, points: 0 },
...
export const rittoData: MunicipalityData = {
  municipality,
  questions: [
