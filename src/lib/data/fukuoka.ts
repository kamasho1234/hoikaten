...
// ---------------------------------------------------------------------------
// 福岡市 保育園入園 基本点数・調整点数データ
// ---------------------------------------------------------------------------
// 福岡市は点数制で、父母それぞれに基本点数を判定し、
// 低い方の保護者の基本点数が世帯の基本点数になる。
// ---------------------------------------------------------------------------
...
const employmentOptions = (prefix: string) => [
  ...
  { label: '月80〜100時間', value: `${prefix}_employment_110`, points: 110 },
  { label: '月60〜80時間', value: `${prefix}_employment_100`, points: 100 },
];

/** 疾病 */
const illnessOptions = (prefix: string) => [
  { label: 'あてはまらない', value: `${prefix}_illness_none`, points: 0 },
  { label: '入院中・常時病臥', value: `${prefix}_illness_160`, points: 160 },
  { label: '精神疾患・通院安静', value: `${prefix}_illness_130`, points: 130 },
  { label: 'その他通院加療', value: `${prefix}_illness_90`, points: 90 },
];
...
const disabilityOptions = (prefix: string) => [
  ...
  { label: '身体3級 / 精神2-3級 / 療育B', value: `${prefix}_disability_140`, points: 140 },
  { label: '身体4-6級', value: `${prefix}_disability_130`, points: 130 },
];

/** 介護 */
const careOptions = (prefix: string) => [
  { label: 'あてはまらない', value: `${prefix}_care_none`, points: 0 },
  { label: '月120時間以上の付添い・居宅介護', value: `${prefix}_care_130`, points: 130 },
  { label: '月60〜120時間', value: `${prefix}_care_90`, points: 90 },
];
...
const educationOptions = (prefix: string) => [
  ...
  { label: '月60〜120時間', value: `${prefix}_education_70`, points: 70 },
];

/** 求職活動 */
const jobSeekingOptions = (prefix: string) => [
  { label: 'あてはまらない', value: `${prefix}_jobseeking_none`, points: 0 },
  { label: '求職中', value: `${prefix}_jobseeking_50`, points: 50 },
];
...
const adjustmentQuestions: Question[] = [
  {
    ...
    options: [
      ...
      { label: 'はい', value: 'adj_single_parent_yes', points: 75 },
    ],
  },
  {
    id: 'adj_sibling',
    ...
    options: [
      ...
      { label: 'きょうだいが同一施設に在園', value: 'adj_sibling_same_facility', points: 70 },
      { label: 'きょうだい同時申込（多胎児）', value: 'adj_sibling_multiple_birth', points: 50 },
      { label: 'きょうだい同時申込（多胎児以外）', value: 'adj_sibling_simultaneous', points: 35 },
    ],
  },
  {
    id: 'adj_welfare',
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'はい', value: 'adj_nursery_worker_yes', points: 75 },
    ],
  },
];
...
export const fukuokaData: MunicipalityData = {
  municipality,
  questions: [
