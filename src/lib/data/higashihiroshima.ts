...
// ---------------------------------------------------------------------------
// 東広島市 保育園入園 基準指数・調整指数データ
// ---------------------------------------------------------------------------
// 東広島市は「基準指数（父母それぞれ）＋ 調整指数」の加算方式。
// 父母それぞれに基準指数を判定し、合計する。
// 就労は月あたりの就労時間で点数を判定。父母各最大20点。
// 出典: 東広島市こども未来部保育課「保育所等入所のご案内」
//   https://www.city.higashihiroshima.lg.jp/soshiki/kodomomirai/
// ---------------------------------------------------------------------------
...
const illnessOptions = (prefix: string) => [
  ...
  { label: '一般通院', value: `${prefix}_illness_10`, points: 10 },
];
...
const disabilityOptions = (prefix: string) => [
  ...
  { label: '中度（身体3級/療育B1/精神2級）', value: `${prefix}_disability_16`, points: 16 },
...
const childbirthOptions = (prefix: string) => [
  ...
  { label: '出産前後（産前6週〜産後8週）', value: `${prefix}_childbirth_16`, points: 16 },
];

/** 就学 */
const educationOptions = (prefix: string) => [
  { label: 'あてはまらない', value: `${prefix}_education_none`, points: 0 },
  { label: '職業訓練（月20日以上）', value: `${prefix}_education_18`, points: 18 },
  { label: '就学（月16日以上）', value: `${prefix}_education_16`, points: 16 },
  { label: '就学（月12日以上）', value: `${prefix}_education_14`, points: 14 },
];
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '東広島市外にお住まいですか？',
    helpText: '市外からの申込みの場合は減点になります',
    inputType: 'radio',
    options: [
      { label: 'いいえ（東広島市在住）', value: 'adj_outside_city_no', points: 0 },
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '転園の申込みですか？',
    helpText: '現在認可保育園に在園中で別の園に移りたい場合です',
    inputType: 'radio',
    options: [
...
export const higashihiroshimaData: MunicipalityData = {
  municipality,
  questions: [
