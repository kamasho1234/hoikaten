...
// ---------------------------------------------------------------------------
// 桐生市 保育園入園 基本指数・調整指数データ
// 出典: 桐生市子育て支援課「令和8年度 保育施設利用のご案内」
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '桐生市外にお住まいですか？',
    helpText: '市外から桐生市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（桐生市在住）', value: 'adj_outside_city_no', points: 0 },
      { label: 'はい（市外在住）', value: 'adj_outside_city_yes', points: -4 },
    ],
  },
  {
    id: 'adj_grandparent',
...
export const kiryuData: MunicipalityData = {
  municipality,
  questions: [
