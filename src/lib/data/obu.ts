...
// ---------------------------------------------------------------------------
// 大府市 保育園入園 基本指数・調整指数データ
// 出典: 大府市公式ウェブサイト、令和8年度 保育施設利用のご案内
// https://www.city.obu.aichi.jp/kosodate/hoikuen/
// ---------------------------------------------------------------------------
// 大府市は愛知県の基準に準拠し、父母各最大20点の体系を採用しています。
// 公式情報は「添付書類等のダウンロード」から「利用調整基準」で確認できます。
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '大府市外にお住まいですか？',
    helpText: '市外から大府市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（大府市在住）', value: 'adj_outside_city_no', points: 0 },
