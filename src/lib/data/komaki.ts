...
// ---------------------------------------------------------------------------
// 小牧市 保育園入園 基本指数・調整指数データ
// 出典: 小牧市こども未来部幼児教育・保育課「令和8年度 保育施設等利用案内」
// https://www.city.komaki.aichi.jp/kosodate/keywords/24655.html
// 参考: 同県内（刈谷市・安城市）の指数表に準じた愛知県標準方式
// ---------------------------------------------------------------------------
// 小牧市は「基本指数（父母それぞれ）＋ 調整指数」の加算方式。
// 父母各最大20点（合計40点）。
// ---------------------------------------------------------------------------
