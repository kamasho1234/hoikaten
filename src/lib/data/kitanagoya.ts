...
// ---------------------------------------------------------------------------
// 北名古屋市 保育園入園 基本指数・調整指数データ
// 出典: 北名古屋市子ども課「令和8年度 保育施設利用のご案内」
// 愛知県標準方式に準じた推定値
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    id: 'adj_outside_city',
    category: 'adjustment',
    label: '北名古屋市外にお住まいですか？',
    helpText: '市外から北名古屋市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（北名古屋市在住）', value: 'adj_outside_city_no', points: 0 },
