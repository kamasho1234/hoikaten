...
// ---------------------------------------------------------------------------
// 志木市 保育園入園 基本指数・調整指数データ
// 出典: 志木市保育課「令和8年度 保育施設利用案内」（参考値）
// 注: 公式ドキュメントが未確認のため、埼玉県の標準基準を参考に作成しています
// 詳細は必ず志木市保育課（048-473-1764）にご確認ください
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '志木市外にお住まいですか？',
    helpText: '市外から志木市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（志木市在住）', value: 'adj_outside_city_no', points: 0 },
