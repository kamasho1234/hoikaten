...
// ---------------------------------------------------------------------------
// 三郷市 保育園入園 基準指数・調整指数データ
// 出典: 三郷市「令和8年度 保育施設等の利用調整に関する基準」
//       (三郷市子ども未来部保育課)
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    inputType: 'radio',
    options: [
      { label: 'いいえ（三郷市在住）', value: 'adj_outside_city_no', points: 0 },
  ...
  },
  {
    ...
    helpText: '同居の祖父母が無職等で保育できる場合は減点（疾病等で保育できない場合を除く）',
    inputType: 'radio',
    options: [
  ...
  },
  {
    id: 'adj_transfer',
    category: 'adjustment',
    label: '在園中の認可保育所等からの転園希望ですか？',
    helpText: '現在通っている認可保育所等から別の園への転園を希望する場合は減点',
    inputType: 'radio',
    options: [
...
export const misatoData: MunicipalityData = {
  municipality,
  questions: [
