...
// ---------------------------------------------------------------------------
// 金沢市 保育施設等利用調整基準表データ
// 出典：金沢市保育施設等利用調整基準表（別表 第7条関係）
// https://www.kanazawa-kosodate.net/ho/202309.pdf
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '転園を希望していますか？',
    helpText: '金沢市が継続して保育を実施しており、別の保育所等への入所を希望する場合',
    inputType: 'radio',
    options: [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '保護者が保育士・保育教諭・幼稚園教諭として石川中央都市圏の保育所等に勤務していますか？',
    helpText: '金沢市・白山市・かほく市・野々市市・津幡町・内灘町の施設が対象',
    inputType: 'radio',
    options: [
      { label: 'いいえ', value: 'adj_nursery_worker_no', points: 0 },
      { label: 'はい', value: 'adj_nursery_worker_yes', points: 50 },
    ],
  },
];
...
export const kanazawaData: MunicipalityData = {
  municipality,
  questions: [
