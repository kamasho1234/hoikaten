...
// 橿原市 保育園入園 利用調整基準データ
// ---------------------------------------------------------------------------
// 出典: 橿原市「令和7年度保育施設入所案内」
//   https://www.city.kashihara.nara.jp/soshiki/1036/gyomu/5/3/16833.html
//
// 橿原市は点数制。父母それぞれに「基本指数＋調整指数」を計算し、
// 加算方式で合計点を算出する（sum方式）。父母各100点（合計200点満点）。
//
// 注: 詳細な点数体系が公式サイトから完全に確認できないため、
// 奈良市の基準を参考値として設定しています。
// 正確な情報については橿原市役所にお問い合わせください。
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  // ── 加点その1（最高1つのみ加点）──
  {
    ...
    options: [
      ...
      { label: '橿原市内の認可保育施設で保育士・看護師として勤務（予定含む）', value: 'adj_bonus_one_nursery_staff', points: 40 },
...
export const kashiharaData: MunicipalityData = {
  municipality,
  questions: [
