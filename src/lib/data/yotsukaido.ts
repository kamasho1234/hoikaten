...
// ---------------------------------------------------------------------------
// 四街道市 保育園入園 基本指数・調整指数データ
// 出典: 四街道市保育課「令和8年度保育所入所案内」（参考値）
// 注: 公式ドキュメントが未確認のため、千葉県の標準基準を参考に作成しています
// 詳細は必ず四街道市健康こども部保育課（043-421-2238）にご確認ください
// ---------------------------------------------------------------------------
...
const disabilityOptions = (prefix: string) => [
  ...
  { label: '身体障害者手帳3級／療育手帳B', value: `${prefix}_disability_18`, points: 18 },
  { label: '精神障害者保健福祉手帳1・2級', value: `${prefix}_disability_18b`, points: 18 },
  { label: '身体障害者手帳4級以下', value: `${prefix}_disability_14`, points: 14 },
];
...
const educationOptions = (prefix: string) => [
  ...
  { label: '月80時間以上120時間未満の就学', value: `${prefix}_education_12`, points: 12 },
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    helpText: '認可外保育施設・認定家庭保育室等に月極で預託している場合',
    inputType: 'radio',
    options: [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '四街道市外にお住まいですか？',
    helpText: '市外から四街道市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（四街道市在住）', value: 'adj_outside_city_no', points: 0 },
  ...
  },
  {
    id: 'adj_grandparent',
    category: 'adjustment',
    label: '同居している65歳未満の祖父母が保育できる状態ですか？',
    helpText: '同居の祖父母が無職等で日常的に保育できる場合（減点）',
    inputType: 'radio',
    options: [
  ...
  },
  {
    id: 'adj_transfer',
    category: 'adjustment',
    label: '認可保育園からの転園を希望していますか？',
    helpText: '現在認可保育園に在園中で別の認可園への転園を希望する場合（減点）',
    inputType: 'radio',
    options: [
