...
// ---------------------------------------------------------------------------
// 小田原市 保育園入園 基本指数・調整指数データ
// ---------------------------------------------------------------------------
// 小田原市は「基本指数（父母それぞれ）＋ 調整指数」の加算方式。
// 就労は月あたりの就労時間で点数を判定。
...
const careOptions = (prefix: string) => [
  ...
  { label: '常時介護が必要（要介護3以上等）', value: `${prefix}_care_20`, points: 20 },
  { label: '週3日以上の介護', value: `${prefix}_care_16`, points: 16 },
  { label: 'それ以外の介護', value: `${prefix}_care_12`, points: 12 },
];
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '小田原市外からの申込ですか？',
    helpText: '市外在住で小田原市の保育園に申し込む場合は減点されます',
    inputType: 'radio',
    options: [
  ...
  },
  {
    id: 'adj_relative',
    category: 'adjustment',
    label: '65歳未満の同居親族がいますか？',
    helpText: '保育ができる同居親族がいる場合は減点されます',
    inputType: 'radio',
    options: [
