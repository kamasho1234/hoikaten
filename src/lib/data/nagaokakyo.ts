...
// ---------------------------------------------------------------------------
// 長岡京市 保育園入園 基本指数・調整指数データ
// ---------------------------------------------------------------------------
// 出典: 長岡京市「令和7年度保育施設入所案内」
//   https://www.city.nagaokakyo.lg.jp/0000009241.html
//
// 長岡京市は点数制。父母それぞれに「基本指数＋調整指数」を計算し、
// 低い方が児童の点数になる。父母各最大20点（合計40点満点）。
// MVP では min(基本指数) + 調整指数 として簡略化する。
//
// 注: 詳細な点数体系が公式サイトから完全に確認できないため、
// 京都市・宇治市の基準を参考値として設定しています。
// 正確な情報については長岡京市役所にお問い合わせください。
// ---------------------------------------------------------------------------
...
export const nagaokakyoData: MunicipalityData = {
  municipality,
  questions: [
