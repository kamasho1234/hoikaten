...
// ---------------------------------------------------------------------------
// 船橋市 保育園入園 基本点・調整点データ
// 出典: 船橋市「保育所等利用調整基準 早見表（令和8年度版）」
// ---------------------------------------------------------------------------
...
const educationOptions = (prefix: string) => [
  ...
  { label: '月120時間以上', value: `${prefix}_education_8`, points: 8 },
  { label: '月64時間以上120時間未満', value: `${prefix}_education_6`, points: 6 },
];
...
export const funabashiData: MunicipalityData = {
  municipality,
  questions: [
