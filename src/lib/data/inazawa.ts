...
// ---------------------------------------------------------------------------
// 稲沢市 保育園入園 基本指数・調整指数データ
// 出典: 稲沢市こども健康部保育課「令和8年度 保育施設等利用案内」
// https://www.city.inazawa.aichi.jp/kosodate/hoiku/index.html
// 参考: 同県内（刈谷市・安城市・小牧市）の指数表に準じた愛知県標準方式
// ---------------------------------------------------------------------------
// 稲沢市は「基本指数（父母それぞれ）＋ 調整指数」の加算方式。
// 父母各最大20点（合計40点）。
// ---------------------------------------------------------------------------
