...
// ---------------------------------------------------------------------------
// 桶川市 保育園入園 基本指数・調整指数データ
// 出典: 桶川市子ども未来部保育課「令和7年度 保育施設利用のご案内」
// 参考: 埼玉県上尾市の基準を参照（埼玉県内で同基準を使用している自治体が多い）
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '桶川市外にお住まいですか？',
    helpText: '市外から桶川市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（桶川市在住）', value: 'adj_outside_city_no', points: 0 },
