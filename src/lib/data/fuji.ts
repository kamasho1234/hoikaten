...
// ---------------------------------------------------------------------------
// 富士市 保育園入園 基本指数・調整指数データ
// 出典: 富士市子ども育成課「令和8年度 保育施設利用調整基準」
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '富士市外にお住まいですか？',
    helpText: '市外から富士市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（富士市在住）', value: 'adj_outside_city_no', points: 0 },
...
export const fujiData: MunicipalityData = {
  municipality,
  questions: [
