...
// ---------------------------------------------------------------------------
// 富士宮市 保育園入園 基本指数・調整指数データ
// 出典: 富士宮市こども部保育幼稚園課「令和8年度 保育施設等利用案内」
// https://www.city.fujinomiya.lg.jp/citizen/kosodate/hoiku/nyusho.html
// 参考: 同県内（磐田市・藤枝市・富士市）の指数表に準じた静岡県標準方式
// ---------------------------------------------------------------------------
// 富士宮市は「基本指数（父母それぞれ）＋ 調整指数」の加算方式。
// 父母各最大20点（合計40点）。
// ---------------------------------------------------------------------------
...
export const fujinomiyaData: MunicipalityData = {
  municipality,
