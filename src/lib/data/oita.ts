...
// ---------------------------------------------------------------------------
// 大分市 保育園入園 基本指数・調整指数データ
// 出典：令和8年度 大分市保育所等入所選考基準
// https://www.city.oita.oita.jp/o253/kosodate/hoiku/2026sennkoukizyunn.html
// https://www.city.oita.oita.jp/o253/kosodate/hoiku/documents/20260401nyusyosenkousisu.pdf
// ---------------------------------------------------------------------------
...
export const oitaData: MunicipalityData = {
  municipality,
  questions: [
