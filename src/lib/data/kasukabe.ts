...
// ---------------------------------------------------------------------------
// 春日部市 保育園入園 基準指数・調整指数データ
// 出典: 春日部市「令和8年度 保育所等の利用調整に関する基準」
//       (春日部市こども未来部保育課)
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    inputType: 'radio',
    options: [
      { label: 'いいえ（春日部市在住）', value: 'adj_outside_city_no', points: 0 },
  ...
  },
  {
    ...
    helpText: '無職または月64時間未満の就労で保育が可能な場合（減点項目）',
    inputType: 'radio',
    options: [
...
export const kasukabeData: MunicipalityData = {
  municipality,
  questions: [
