...
// ---------------------------------------------------------------------------
// 伊勢原市 保育施設入園 利用調整基準データ
// 出典: 伊勢原市「保育施設等（保育所、認定こども園、小規模保育施設）の利用申し込みについて」
// https://www.city.isehara.kanagawa.jp/docs/2020102700019/
// 参考: 伊勢原市「保育・教育施設等利用ガイドブック」
// https://www.city.isehara.kanagawa.jp/docs/2016072900023/
// ---------------------------------------------------------------------------
// 伊勢原市は「基本表（基本点数）」で優先順位を決定し、
// 同点の場合に「同点調整表」で比較する方式。
// 神奈川県内の標準的な基準を参考に、父母それぞれ最大20点。
...
const disabilityOptions = (prefix: string) => [
  ...
  { label: '身体障害者手帳1・2級／療育手帳A度', value: `${prefix}_disability_20`, points: 20 },
  { label: '身体障害者手帳3級／療育手帳B度／精神1級', value: `${prefix}_disability_16`, points: 16 },
  { label: '身体障害者手帳4級以下／精神2級以下', value: `${prefix}_disability_12`, points: 12 },
];
