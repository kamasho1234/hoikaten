...
// ---------------------------------------------------------------------------
// 小平市 保育園入園 基本指数・調整指数データ
// 出典: 小平市「令和8年度 保育施設入園案内」
// ---------------------------------------------------------------------------
// 小平市は「基本指数（父母それぞれ）＋ 調整指数」の加算方式。
// 就労は月あたりの日数と1日あたりの就労時間で判定。
...
const employmentOptions = (prefix: string) => [
  ...
  { label: '月20日以上かつ日7時間以上', value: `${prefix}_employment_18`, points: 18 },
  ...
  { label: '月64時間以上（それ以外）', value: `${prefix}_employment_10`, points: 10 },
];
...
const disabilityOptions = (prefix: string) => [
  ...
  { label: '身体障害者手帳3級／愛の手帳4度／精神3級', value: `${prefix}_disability_16`, points: 16 },
...
const careOptions = (prefix: string) => [
  ...
  { label: '常時付添看護', value: `${prefix}_care_20`, points: 20 },
...
const educationOptions = (prefix: string) => [
  ...
  { label: '月16日以上', value: `${prefix}_education_16`, points: 16 },
  { label: '月12日以上', value: `${prefix}_education_12`, points: 12 },
];
  ...
  const detailQuestions: Question[] = [
    {
      ...
      helpText: '月あたりの就労日数と1日あたりの就労時間で判定されます',
      inputType: 'radio',
...
const adjustmentQuestions: Question[] = [
  ...
  {
    id: 'adj_kodaira_resident',
    category: 'adjustment',
    label: '小平市に住んでいますか？',
    helpText: '小平市外からの申込みは減点になります',
    inputType: 'radio',
    options: [
      { label: 'はい（小平市在住）', value: 'adj_kodaira_resident_yes', points: 0 },
      { label: 'いいえ（市外在住）', value: 'adj_kodaira_resident_no', points: -10 },
    ],
  },
  {
...
export const kodairaData: MunicipalityData = {
  municipality,
  questions: [
