...
// ---------------------------------------------------------------------------
// 我孫子市 保育園入園 利用調整基準データ
// 出典: 我孫子市「令和8年度 利用調整基準表」(PDF)
// https://www.city.abiko.chiba.jp/kosodate/children/preschool/nursery/vacancy/nyuuennmousikomi.html
// ---------------------------------------------------------------------------
// 我孫子市は「基準点数（父母それぞれ最大10点）＋ 調整点数」の加算方式。
...
function buildParentQuestions(parentNum: 1 | 2): Question[] {
  ...
  const reasonQuestion: Question = {
    ...
    helpText: '我孫子市では父母それぞれの基準点数（各最大10点）の合計で選考されます',
    inputType: 'select',
    options: [
...
export const abikoData: MunicipalityData = {
  municipality,
  questions: [
