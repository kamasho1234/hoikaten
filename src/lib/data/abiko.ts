...
// ---------------------------------------------------------------------------
// 我孫子市 保育園入園 基準点数・調整点数データ
// 出典: 我孫子市「令和8年度保育園等入園のご案内」
// https://www.city.abiko.chiba.jp/kosodate/children/preschool/nursery/vacancy/nyuuennmousikomi.html
// 参考: 我孫子市保育園の入園等に関する規則
// https://www1.g-reiki.net/city.abiko.chiba/reiki_honbun/g023RG00000568.html
// ---------------------------------------------------------------------------
// 我孫子市は「基準点数（父母それぞれ）＋ 調整点数」の加算方式。
// 千葉県内の標準的な基準を参考に、父母それぞれ最大20点。
// 就労は月の就労時間で判定。月160時間以上で満点の20点。
// 同点の場合：基準点数の高い方＞所得の低い方で判定
// ---------------------------------------------------------------------------
