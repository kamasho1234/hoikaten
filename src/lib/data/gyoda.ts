...
// ---------------------------------------------------------------------------
// 行田市 保育園入園 基本指数・調整指数データ
// 出典: 行田市子ども未来課「保育施設利用調整基準」（参考値）
// 注: 詳細な利用調整基準表PDFは行田市公式サイトで最新版をご確認ください
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    category: 'adjustment',
    label: '行田市外にお住まいですか？',
    helpText: '市外から行田市内の保育施設を希望する場合（減点）',
    inputType: 'radio',
    options: [
      { label: 'いいえ（行田市在住）', value: 'adj_outside_city_no', points: 0 },
