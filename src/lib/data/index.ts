...
import { itoData } from './ito';
import { shimizuData } from './shimizu';
import { shiraokaData } from './shiraoka';
import { kitamotoData } from './kitamoto';
import { futtsuData } from './futtsu';
...
import { miyoshiSaitamaData } from './miyoshi-saitama';
...
import { tomigusukuData } from './tomigusuku';
import { yanagawaData } from './yanagawa';
import { miyotaData } from './miyota';
import { hiokiData } from './hioki';
import { mukoData } from './muko';
import { onoData } from './ono';
import { sueData } from './sue';
import { yameData } from './yame';
import { ichikikushikinoData } from './ichikikushikino';
import { yamagaData } from './yamaga';
import { tsunanData } from './tsunan';
import { nogataData } from './nogata';
...
import { chikugoData } from './chikugo';
...
import { kanieData } from './kanie';
import { kumatoriData } from './kumatori';
import { masudaData } from './masuda';
...
import { omihachimanData } from './omihachiman';
...
import { yatomiData } from './yatomi';
import { aisaiData } from './aisai';
import { kiyosuData } from './kiyosu';
import { katoriData } from './katori';
import { daisenData } from './daisen';
import { tsukubamiraiData } from './tsukubamirai';
import { kudamatsuData } from './kudamatsu';
...
import { tsubataData } from './tsubata';
import { takikawaData } from './takikawa';
import { aizumiData } from './aizumi';
import { kikugawaData } from './kikugawa';
import { itoigawaData } from './itoigawa';
import { towadaData } from './towada';
import { mutsuData } from './mutsu';
import { sumotoData } from './sumoto';
import { shiogamaData } from './shiogama';
...
import { tokonameData } from './tokoname';
import { sakaiminatoData } from './sakaiminato';
...
import { zentsujiData } from './zentsuji';
import { dateHokkaidoData } from './date-hokkaido';
import { chikuzenData } from './chikuzen';
import { namegawaData } from './namegawa';
...
import { sakuragawaData } from './sakuragawa';
...
import { kinData } from './kin';
import { shinanoData } from './shinano';
...
import { mutsuzawaData } from './mutsuzawa';
...
const municipalityMap: Record<string, MunicipalityData> = {
  ...
  [kiyoseData.municipality.slug]: kiyoseData,
  ...
  [chikugoData.municipality.slug]: chikugoData,
  ...
  [kanieData.municipality.slug]: kanieData,
  [kumatoriData.municipality.slug]: kumatoriData,
  [masudaData.municipality.slug]: masudaData,
  ...
  [omihachimanData.municipality.slug]: omihachimanData,
  ...
  [yatomiData.municipality.slug]: yatomiData,
  [aisaiData.municipality.slug]: aisaiData,
  [itoData.municipality.slug]: itoData,
  [shimizuData.municipality.slug]: shimizuData,
  [shiraokaData.municipality.slug]: shiraokaData,
  [kitamotoData.municipality.slug]: kitamotoData,
  [futtsuData.municipality.slug]: futtsuData,
  ...
  [miyoshiSaitamaData.municipality.slug]: miyoshiSaitamaData,
  ...
  [tomigusukuData.municipality.slug]: tomigusukuData,
  [yanagawaData.municipality.slug]: yanagawaData,
  [miyotaData.municipality.slug]: miyotaData,
  [hiokiData.municipality.slug]: hiokiData,
  [mukoData.municipality.slug]: mukoData,
  ...
  [yamagaData.municipality.slug]: yamagaData,
  [tsunanData.municipality.slug]: tsunanData,
  [nogataData.municipality.slug]: nogataData,
  ...
  [kiyosuData.municipality.slug]: kiyosuData,
  [katoriData.municipality.slug]: katoriData,
  [daisenData.municipality.slug]: daisenData,
  [tsukubamiraiData.municipality.slug]: tsukubamiraiData,
  [kudamatsuData.municipality.slug]: kudamatsuData,
  ...
  [tsubataData.municipality.slug]: tsubataData,
  [takikawaData.municipality.slug]: takikawaData,
  [aizumiData.municipality.slug]: aizumiData,
  [kikugawaData.municipality.slug]: kikugawaData,
  [itoigawaData.municipality.slug]: itoigawaData,
  [towadaData.municipality.slug]: towadaData,
  [mutsuData.municipality.slug]: mutsuData,
  [sumotoData.municipality.slug]: sumotoData,
  [shiogamaData.municipality.slug]: shiogamaData,
  ...
  [tokonameData.municipality.slug]: tokonameData,
  [sakaiminatoData.municipality.slug]: sakaiminatoData,
  ...
  [zentsujiData.municipality.slug]: zentsujiData,
  [dateHokkaidoData.municipality.slug]: dateHokkaidoData,
  [chikuzenData.municipality.slug]: chikuzenData,
  [namegawaData.municipality.slug]: namegawaData,
  ...
  [sakuragawaData.municipality.slug]: sakuragawaData,
  ...
  [kinData.municipality.slug]: kinData,
  [shinanoData.municipality.slug]: shinanoData,
  ...
  [mutsuzawaData.municipality.slug]: mutsuzawaData,
...
export { tsubataData };
export { takikawaData, aizumiData, kikugawaData };
export { itoigawaData };
export { towadaData };
...
export { asagoData };
export { zentsujiData, dateHokkaidoData };
export { chikuzenData };
