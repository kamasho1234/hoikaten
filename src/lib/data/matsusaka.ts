...
// 出典: 松阪市こども局こども未来課「令和8年度 保育所等利用調整基準」
// https://www.city.matsusaka.mie.jp/site/youho/2022hoikucyousei.html
// 参考: 同県内（四日市市・鈴鹿市・津市）の指数表に準じた三重県標準方式
// ---------------------------------------------------------------------------
// 松阪市は「基本点数（父母それぞれ）＋ 調整指数」の加算方式。
// 父母各最大20点（合計40点）。
// ---------------------------------------------------------------------------
