...
// ---------------------------------------------------------------------------
// 筑紫野市 保育園入園 基準指数・調整指数データ
// ---------------------------------------------------------------------------
// 筑紫野市は「基準指数（父母それぞれ）＋ 調整指数」の加算方式。
// 福岡県内の標準的な基準を採用。父母各最大20点（合計40点満点）。
// 公式情報が見つからないため、同県の春日市基準を参考値として使用。
// ---------------------------------------------------------------------------
...
const adjustmentQuestions: Question[] = [
  ...
  },
  {
    ...
    inputType: 'radio',
    options: [
      { label: 'いいえ（筑紫野市在住）', value: 'adj_outside_city_no', points: 0 },
...
export const chikushinoData: MunicipalityData = {
  municipality,
  questions: [
