...
// ---------------------------------------------------------------------------
// 岡山市 保育園入園 基礎点数・調整点数データ
// 出典: 岡山市「保育利用ガイド（令和8年度版）」
// ---------------------------------------------------------------------------
...
const employmentOptions = (prefix: string) => [
  ...
  { label: '月20日以上かつ週30時間以上40時間未満', value: `${prefix}_employment_90`, points: 90 },
  { label: '月16日以上かつ週24時間以上', value: `${prefix}_employment_80`, points: 80 },
  { label: '月12日以上かつ週16時間以上', value: `${prefix}_employment_70`, points: 70 },
  { label: '月48時間以上（上記以外）', value: `${prefix}_employment_60`, points: 60 },
];
...
const illnessOptions = (prefix: string) => [
  ...
  { label: '通院加療', value: `${prefix}_illness_60`, points: 60 },
];
...
const disabilityOptions = (prefix: string) => [
  ...
  { label: '中度（身体3級等）', value: `${prefix}_disability_80`, points: 80 },
...
const careOptions = (prefix: string) => [
  ...
  { label: '月20日以上かつ週40時間以上の介護', value: `${prefix}_care_100`, points: 100 },
  { label: '月16日以上かつ週24時間以上の介護', value: `${prefix}_care_80`, points: 80 },
  { label: '月48時間以上の介護', value: `${prefix}_care_60`, points: 60 },
];
...
const educationOptions = (prefix: string) => [
  ...
  { label: '月16日以上かつ週16時間以上', value: `${prefix}_education_90`, points: 90 },
  { label: '月16日以上かつ週16時間未満', value: `${prefix}_education_70`, points: 70 },
  { label: '就学予定', value: `${prefix}_education_60`, points: 60 },
];
...
export const okayamaData: MunicipalityData = {
  municipality,
  questions: [
