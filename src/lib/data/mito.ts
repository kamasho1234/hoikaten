...
// ---------------------------------------------------------------------------
// 水戸市 保育園入園 基準指数・調整指数データ
// 出典：水戸市 幼稚園・認定こども園・保育所・地域型保育 利用の御案内（令和8年度）
// https://www.city.mito.lg.jp/site/kosodate/107000.html
// ---------------------------------------------------------------------------
...
export const mitoData: MunicipalityData = {
  municipality,
  questions: [
