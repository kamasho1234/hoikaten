...
<tr><td>ひとり親世帯</td><td>+130</td><td>片親の基本点数100点と合わせて230相当</td></tr>
...
<p>各園の年齢別申込状況は<a href="https://www.city.kobe.lg.jp/a65174/kosodate/yochien/moshikomijokyo.html" target="_blank" rel="noopener">神戸市公式サイト「申込状況」</a>で確認できます。</p>
  ...
  // ========== 制度を知る ==========
  {
    ...
    description:
      "神戸市でひとり親世帯が保育園入園選考で受けられる+130点の加点と、活用できる支援制度をまとめました。",
    image:
      "https://images.unsplash.com/photo-1531983412531-1f49a365ffed?w=800&h=400&fit=crop",
    category: "制度を知る",
    categoryColor: "rose",
    content: `<h2>ひとり親世帯の入園選考</h2>
<p>神戸市ではひとり親世帯に調整点数<span class="highlight">+130点</span>の加点があります。片方の親の基本点数（最大100点）に+130点が加わるため、入園選考では有利に働きます。</p>

<h2>点数のシミュレーション</h2>
<table>
<tr><th>就労状況</th><th>基本点数</th><th>ひとり親加点</th><th>合計</th></tr>
<tr><td>フルタイム（週40時間以上）</td><td>100</td><td>+130</td><td><span class="highlight">230</span></td></tr>
<tr><td>週30時間以上</td><td>90</td><td>+130</td><td>220</td></tr>
<tr><td>週24時間以上</td><td>80</td><td>+130</td><td>210</td></tr>
</table>
...
<p>無償化制度の詳細は<a href="https://www.city.kobe.lg.jp/z/kodomokatekyoku/kosodateshien/mushouka.html" target="_blank" rel="noopener">神戸市「幼児教育・保育の無償化」</a>をご確認ください。</p>
  ...
  },
  {
    slug: "shokuhi-jippi",
    citySlug: "kobe",
    title: "神戸市の保育園の給食費（副食費）はいくら？【令和8年度版】免除条件と金額",
    description: "神戸市の保育園の給食費（副食費）は月いくら？所得・子ども数による副食費免除の条件と申請方法、保育料無償化の範囲と実費負担の全額をわかりやすく解説。令和8年度対応。",
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>単身赴任で配偶者が不在であっても、「ひとり親世帯」の加点（+130点）は適用されません。ひとり親の加点は離婚・死別等の場合に限られます。</p>
</div>
