...
<p>求職活動中の基本点は3点で、就労中（最大10点）の半分以下です。求職中での入園は人気エリアでは困難です。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "funabashi",
    title: "船橋市の保育料はいくら？　上限額と決まり方",
    description:
      "船橋市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>船橋市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>船橋市でいちばん高い階層はいくら？</h2>
<p>船橋市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額60,000円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
...
<p>上記の金額は船橋市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.funabashi.lg.jp/kodomo/hoiku/002/hoikuryouhyou_d/fil/hyoujunhoikuryou.pdf" target="_blank" rel="noopener">船橋市の保育料表</a>をご確認ください。</p>
</div>`,
