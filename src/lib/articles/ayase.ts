...
const articles: Article[] = [
  {
    ...
    description:
      "綾瀬市の認可保育園の申込時期・選考の流れをまとめました。令和8年度4月入園の動き方を解説します。",
    image: "https://images.unsplash.com/photo-1484820540004-14229fe36ca4?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>綾瀬市の4月入園スケジュール</h2>
<p>綾瀬市の認可保育園は毎年秋に翌年度4月入園の一次申込を受付けます。基本指数・調整指数を理解して準備を進めましょう。</p>
...
<p>綾瀬市のホームページで保育園の一覧や前年度のボーダー（最低指数一覧）を確認します。</p>
</div>
</div>
<div class="step">
...
<p>綾瀬市内の保育園を見学して、通勤経路との相性を確認しましょう。</p>
</div>
</div>
<div class="step">
...
<p>月あたり就労時間は正確に記載してもらいましょう。指数に直結します。</p>
</div>
</div>
<div class="step">
...
<p>綾瀬市の基本指数は父母各最大20点（合計40点満点）です。月の就労時間で判定される制度です。</p>
</div>

<div class="info-box">
<p><strong>公式情報</strong></p>
<p>詳しくは<a href="https://www.city.ayase.kanagawa.jp/kosodate/nenreidesagasu/yochien_hoikuen_shogakkougugakuzen/3/1/index.html" target="_blank" rel="noopener">綾瀬市公式サイト 保育園について</a>をご確認ください。</p>
</div>`,
  ...
  },
  {
    ...
    description:
      "綾瀬市の保育園入園選考で使われる基本指数と調整指数のしくみをわかりやすく解説します。",
    image: "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>綾瀬市の選考指数とは</h2>
<p>綾瀬市の認可保育園は「基本指数（父＋母）＋ 調整指数」の合計で選考されます。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>総合指数 ＝ 基本指数（父＋母）＋ 調整指数</p>
</div>
...
<p>綾瀬市外在住の場合は-10点、65歳未満の同居親族がいる場合は-3点など、減点される場合があります。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 60,
  },
  {
    ...
    description:
      "綾瀬市の保育園入園選考で調整指数の加点を最大限に活用する方法を解説します。",
    image: "https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>基本指数40点は出発点</h2>
<p>綾瀬市ではフルタイム共働き世帯は基本指数<span class="highlight">40点</span>で横並びです。差がつくのは調整指数の加点です。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>綾瀬市は加点だけでなく減点項目も多いので注意が必要です。市外在住の場合は-10点の減点があります。</p>
</div>
...
<p>就労証明書の月あたり就労時間は正確に記載してください。実態と異なる記載は入園取消しの対象です。</p>
  ...
  },
  {
    ...
    description:
      "綾瀬市の保育園入園選考で同点だった場合の優先順位の判定方法を解説します。",
    image: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>同点時の判定方法</h2>
<p>綾瀬市の入園選考で総合指数が同点になった場合、さらに優先順位で判定されます。</p>

<h2>同点時に優先される順序</h2>
<ol>
<li>希望順位の高い世帯の児童</li>
<li>その世帯の状況を総合的に判断</li>
</ol>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>綾瀬市の40点制では、フルタイム共働きで40点が基本ラインです。調整指数が重要な選考基準になります。</p>
</div>
...
<p>優先順位は年度によって変更される場合があります。最新の「入園のご案内」で必ず確認しましょう。</p>
  ...
  },
  {
    ...
    description:
      "綾瀬市の保育園入園選考で時短勤務の場合の基本指数への影響を解説します。",
    image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>綾瀬市は月の就労時間で判定</h2>
<p>綾瀬市の基本指数は月の就労時間で決まります。時短勤務の影響を確認しましょう。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>綾瀬市はひとり親世帯への加点が手厚く設定されています。必ず申込書類でひとり親であることを記載しましょう。</p>
</div>

<h2>ひとり親が利用できる支援制度</h2>
<p>綾瀬市ではひとり親世帯向けの様々な支援制度があります。保育園入園時の相談窓口で詳しく説明を受けられます。</p>
...
<p>加点を受けるには、戸籍謄本や児童扶養手当受給証などの書類提出が必要な場合があります。事前に綾瀬市に確認しましょう。</p>
  ...
  },
  {
    ...
    description:
      "綾瀬市の保育園入園選考で育休明けの復帰タイミングが指数に与える影響を解説します。",
    image: "https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>育休復帰予定で加点</h2>
<p>綾瀬市の入園選考では、育児休業を取得して入園月に復帰する場合、調整指数で<span class="highlight">+2点</span>の加点が得られます。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>就労証明書には「復帰予定日」と「復帰後の勤務時間」を正確に記載してもらいましょう。これが指数認定に直結します。</p>
</div>
...
<p>入園月の前月までに復帰してしまうと、加点の対象にならない場合があります。申込時に必ず確認しましょう。</p>
  ...
  },
  {
    ...
    description:
      "綾瀬市の認可保育園の待機児童数や競争率から、入園の難易度を分析します。",
    image: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>綾瀬市の待機児童状況</h2>
<p>綾瀬市の認可保育園の需要と供給のバランスを把握することが、保活戦略の第一歩です。</p>

<h3>保育園の競争率</h3>
<p>綾瀬市内の保育園は地域によって競争率が異なります。駅前や商業施設近くの人気園は倍率が高い傾向にあります。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>前年度の「入所決定者の最低指数一覧」を確認することで、自分の指数で合格できそうな園を見つけることができます。</p>
</div>
...
<div class="warn-box">
<p><strong>注意</strong></p>
<p>待機児童数は毎年変動します。必ず最新の綾瀬市公式情報で確認しましょう。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 42,
  },
  {
    ...
    description:
      "綾瀬市の保育園申込に必要な書類と、記入時の注意点をまとめたチェックリストです。",
...
<div class="warn-box">
<p><strong>注意</strong></p>
<p>書類に記載漏れがあると指数が認定されない場合があります。申込む前に綾瀬市役所に確認することをお勧めします。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 50,
  },
  {
    ...
    description:
      "綾瀬市の保育園入園選考で認可外保育施設の利用が与える影響と加点制度を解説します。",
    image: "https://images.unsplash.com/photo-1503454537688-e47a8b0b5a20?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>認可外保育施設の利用で加点</h2>
<p>綾瀬市の入園選考では、認可外保育施設に月ぎめで預けている場合、調整指数で<span class="highlight">+3点</span>の加点が得られます。</p>
