...
<p>八尾市では過去の入園最低指数を公開していることがあります。保育・こども園課の窓口で確認してみましょう。</p>
  ...
  // ===== 保育料 =====
  {
    slug: "nursery-fees",
    citySlug: "yao",
    title: "八尾市の保育料はいくら？　世帯年収別の目安を紹介",
    description:
      "八尾市の認可保育園の保育料を世帯年収別にわかりやすく紹介します。無償化の対象も解説。",
    image:
      "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&h=400&fit=crop",
    category: "お金の話",
    categoryColor: "rose",
    content: `<h2>保育料の決まり方</h2>
<p>八尾市の認可保育園の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">子どもの年齢</span>で決まります。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>八尾市では第2子の保育料は半額、第3子以降は無料になります（年収制限なし）。きょうだいが多い世帯は大きなメリットです。</p>
</div>

<div class="info-box">
<p><strong>注意</strong></p>
<p>上記はあくまで目安です。正確な保育料は住民税額で決まります。詳しくは八尾市こども未来部保育・こども園課にお問い合わせください。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 42,
  },
