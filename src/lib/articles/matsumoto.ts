...
const articles: Article[] = [
  // ===== 保活の基本 (1) =====
  {
    ...
    citySlug: "matsumoto",
    title: "松本市の保活スケジュール　令和8年度4月入園の流れ",
    description:
      "松本市の認可保育園の申込時期・選考の流れ・結果通知の時期をわかりやすく解説。令和8年度4月入園のスケジュールを中心にまとめました。",
    image:
      "https://images.unsplash.com/photo-1484820540004-14229fe36ca4?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>令和8年度（2026年度）4月入園のスケジュール</h2>
<p>松本市の4月入園は<strong>一次利用調整</strong>と<strong>二次利用調整</strong>の2回に分かれています。申込先は松本市こども部保育課です。</p>

<h3>一次利用調整</h3>
<table>
<tr><th>項目</th><th>日程</th></tr>
<tr><td>申込受付期間</td><td>令和7年10月下旬〜11月中旬</td></tr>
...
<p>松本市の認可保育園は約40か所。エリアや園の特徴を調べましょう。</p>
</div>
</div>
<div class="step">
...
<p>松本市こども部保育課が発行する「保育施設利用のご案内」を入手しましょう。</p>
</div>
</div>
<div class="step">
...
<p>各月の申込締切日は、入園希望月の<span class="highlight">前月10日頃</span>です。詳しくは松本市の公式サイトをご確認ください。</p>`,
  ...
  // ===== 保活の基本 (2) =====
  {
    ...
    citySlug: "matsumoto",
    title: "松本市の保活でよくある失敗と対策5選",
    description:
      "松本市の保活で初めてのママがやりがちな失敗パターンと、その対策をまとめました。",
    image:
      "https://images.unsplash.com/photo-1476703993599-0035a21b17a9?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>失敗1：情報収集のスタートが遅い</h2>
<p>松本市の4月入園の申込は<span class="highlight">10月下旬</span>から始まります。見学の予約が埋まる前に動きましょう。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>遅くとも6月には情報収集を始めましょう。松本市は人口約24万人で、国宝松本城を擁する長野県中部の中核市です。松本駅周辺の園は競争率が高めです。</p>
</div>
...
<p>松本市こども部保育課の窓口で、申込前に書類の事前確認ができます。不安な方は活用しましょう。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 50,
  },
...
<li>同居祖父母が保育可能：<span class="highlight">-3点</span></li>
  ...
  // ===== 点数アップ =====
  {
    ...
    citySlug: "matsumoto",
    title: "松本市で点数を1点でも上げる方法　加点のチェックリスト",
    description:
      "松本市の入園選考で調整指数の加点を最大限に活用する方法を、チェックリスト形式で解説します。",
    image:
      "https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>加点の取りこぼしをなくそう</h2>
<p>松本市の入園選考では<span class="highlight">1点</span>の差が明暗を分けることも。使える加点は漏れなく活用しましょう。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>認可外保育施設に預けながら翌年の4月入園を申し込むと、+3点の加点がつきます。0歳児クラスで認可外に預け、1歳児クラスで認可園を狙うのは松本市でも有効な戦略です。</p>
</div>

<div class="info-box">
<p><strong>注意すべき減点項目</strong></p>
<p>松本市外からの申込は-10点、認可園からの転園は-5点、同居祖父母が保育可能な場合は-3点の減点があります。特に市外からの申込は大幅な減点となるため要注意です。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 60,
  },
  // ===== エリア情報 =====
  {
    slug: "area-guide",
    citySlug: "matsumoto",
    title: "松本市の保育園マップ　エリアごとの入りやすさを比較",
    description:
      "松本市内のエリアごとの保育園の競争率や特徴をまとめました。",
    image:
      "https://images.unsplash.com/photo-1569058242253-92a9c755a0ec?w=800&h=400&fit=crop",
    category: "エリア情報",
    categoryColor: "purple",
    content: `<h2>松本市の保育園事情</h2>
<p>松本市は長野県中部に位置する人口約24万人の中核市で、国宝松本城をはじめとする歴史と文化の街です。認可保育園は約40か所あり、JR松本駅を中心に市街地から郊外まで幅広く分布しています。</p>

<h2>エリアごとの競争率</h2>

<h3>競争率が高いエリア</h3>
<ul>
<li><strong>松本駅周辺・中心市街地</strong>：駅近の園は人気が集中。特に0歳児・1歳児クラスは激戦</li>
<li><strong>南松本・村井エリア</strong>：商業施設が充実しファミリー層が多く、園の競争率が高い傾向</li>
</ul>

<h3>比較的入りやすいエリア</h3>
<ul>
<li><strong>島内・島立エリア</strong>：駅から離れるため、比較的空きがある園も</li>
<li><strong>梓川・波田エリア</strong>：旧合併地域で園児数が減少傾向にあり、穴場の園が見つかることも</li>
</ul>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>松本市は車社会のため、通勤経路上の園を幅広く検討しましょう。冬場は積雪があるため、駐車場の広さや除雪状況も確認しておくと安心です。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 45,
  },
  // ===== 認可外 =====
  {
    slug: "ninkagai-guide",
    citySlug: "matsumoto",
    title: "松本市の認可外保育施設ガイド　認可園との違いは？",
    description:
      "松本市で認可園に入れなかった場合の選択肢として、認可外保育施設について解説します。",
    image:
      "https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=800&h=400&fit=crop",
    category: "認可外保育",
    categoryColor: "teal",
    content: `<h2>認可外保育施設とは？</h2>
<p>認可外保育施設は、認可基準を満たしていないものの、自治体に届出をして運営している保育施設です。松本市内にも複数の認可外保育施設があります。</p>

<h2>認可園との違い</h2>
<table>
<tr><th>項目</th><th>認可</th><th>認可外</th></tr>
<tr><td>保育料</td><td>所得に応じて決定</td><td>施設が設定</td></tr>
<tr><td>申込先</td><td>松本市こども部保育課</td><td>施設に直接</td></tr>
...
<li>施設の安全対策</li>
  ...
  // ===== 小規模保育 =====
  {
    slug: "small-nursery",
    citySlug: "matsumoto",
    title: "松本市の小規模保育って？　メリット・デメリットを解説",
    description:
      "松本市の小規模保育事業の特徴やメリット・デメリット、卒園後の進路について解説します。",
    image:
      "https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>松本市では小規模保育の卒園児に対して、認可園への優先的な利用調整を行っています。3歳の壁を心配しすぎず、まずは入れる園を確保することが大切です。</p>
</div>

<div class="info-box">
<p><strong>情報</strong></p>
<p>松本市内の小規模保育事業所の一覧は、松本市こども部保育課の窓口または公式サイトで確認できます。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 35,
  },
  // ===== 同点対策 =====
  {
    ...
    citySlug: "matsumoto",
    title: "松本市で同点になったらどうなる？　優先順位のしくみ",
    description:
      "松本市の保育園入園選考で同点になった場合の優先順位と、事前にできる対策を解説します。",
    image:
      "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>同点の場合の優先順位</h2>
<p>松本市では選考指数が同点の場合、以下の順番で優先されます。</p>
...
<div class="info-box">
<p><strong>情報</strong></p>
<p>松本市では過去の入園最低指数を公開していることがあります。こども部保育課の窓口で確認してみましょう。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 48,
  },
  // ===== 保育料 =====
  {
    slug: "nursery-fees",
    citySlug: "matsumoto",
    title: "松本市の保育料はいくら？　上限額と決まり方",
    description:
      "松本市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>松本市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>松本市でいちばん高い階層はいくら？</h2>
<p>松本市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額62,600円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>保育料は毎年9月に切り替わります。4月分から8月分は前年度の住民税額、9月分から翌年3月分は当年度の住民税額で決まる自治体が多いため、9月に金額が変わることがあります。</p>
</div>
<h2>きょうだいがいる世帯の軽減</h2>
<p>松本市は次のように案内しています。</p>
<blockquote><p>、又は、在宅障がい児（者）のいる世帯（身体障害者手帳、療育手帳の写し等の提出がある世帯）市民税額77,100円以下の世帯第2子以降における保育料軽減市民税額の金額にかかわらず、第2子以降のお子さんの場合は軽減の対象になります。</p></blockquote>
<div class="info-box">
<p><strong>出典</strong></p>
<p>上記の金額は松本市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.matsumoto.nagano.jp/uploaded/attachment/124079.pdf" target="_blank" rel="noopener">松本市の保育料表</a>をご確認ください。</p>
</div>`,
  ...
  // ===== 見学ガイド =====
  {
    ...
    citySlug: "matsumoto",
    title: "松本市の保育園見学ガイド　チェックポイントと質問リスト",
    description:
      "松本市の保育園見学で確認すべきポイントと、先輩ママが聞いてよかった質問をまとめました。",
    image:
      "https://images.unsplash.com/photo-1544776193-352d25ca82cd?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>見学はいつ行くのがベスト？</h2>
<p><span class="highlight">6月〜9月</span>が見学のベストシーズンです。10月以降は申込直前で混み合います。松本市内の認可保育園は約40か所あるので、気になる園を絞り込んでから見学に行きましょう。</p>
...
<li>駐車場は何台分あるか？（松本市は車利用の家庭が多い）</li>
<li>冬場の除雪対応や暖房設備はどうなっているか？</li>
</ul>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>見学はできるだけ複数の園を回りましょう。比較することで自分に合った園が見えてきます。松本市は冬の寒さが厳しく積雪もあるため、冬場の通園を想定した園選びも大切です。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 38,
  },
