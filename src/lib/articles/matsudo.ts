...
<p>松戸市は基準指数が父母各最大20点（合計40点満点）で、調整指数を加算して選考されます。フルタイム共働きの40点がボリュームゾーンです。</p>
</div>
...
<li>認可外保育施設を月ぎめで利用中：<span class="highlight">+3点</span></li>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>松戸市の40点制では調整指数の幅が比較的大きいため、同点になるケースは20点制の自治体より少ない傾向にあります。ただし人気園では同点の判定になる場合もあります。</p>
</div>

<h2>同点を避けるために</h2>
<p>認可外利用（+3点）や育休復帰（+2点）で加点を積むことが重要です。40点に加点を1つでも多く積むことで同点回避につながります。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>時短勤務でも月140時間以上なら18点です。松戸市の40点制では、片方の親が時短の場合は合計36〜38点になり、フルタイム世帯の40点より2〜4点低くなります。認可外利用（+3点）などの加点でカバーを検討しましょう。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 90,
  },
...
<h3>3. 小規模保育の利用</h3>
<p>小規模保育事業を利用し、卒園時に認可保育園へ転所する方法があります。松戸市は小規模保育も充実しています。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>認可外利用（+3点）と育休復帰（+2点）を翌年度に積むと、合計+5点の加算が見込めます。40点＋5点＝<span class="highlight">45点</span>はかなり有利です。</p>
</div>

<h3>4. 途中入園</h3>
<p>空きが出た場合に途中入園が可能です。松戸市では毎月空き状況を公表しています。</p>
...
<p>空き状況は<a href="https://www.city.matsudo.chiba.jp/kosodate/matsudodekosodate/hoiku/hoikuen/" target="_blank" rel="noopener">松戸市公式サイト</a>で確認できます。</p>
  ...
  },
  {
    ...
    description:
      "松戸市では認可外保育施設の月ぎめ利用で+3点の加点が得られます。その条件を解説します。",
    image: "https://images.unsplash.com/photo-1587654780291-39c9404d7dd0?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>認可外利用の加点</h2>
<p>松戸市では認可外保育施設に月ぎめで預けている場合、調整指数で<span class="highlight">+3点</span>の加点が得られます。</p>
...
<h2>費用の目安</h2>
<p>松戸市内の認可外保育施設の月額料金は施設によって異なりますが、月5万〜8万円程度が一般的です。</p>

<h2>翌年度への布石</h2>
<p>不承諾だった場合に認可外を利用すると、翌年度の申込で+3点の加点がつきます。40点制では3点の差は大きく、43点あれば多くの園で有利になります。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>43点以上あれば多くの園で入園できる可能性が高いです。40点＋認可外利用（+3）＝<span class="highlight">43点</span>が一つの目安です。育休復帰（+2）も加えた<span class="highlight">45点</span>ならさらに安心です。</p>
</div>
...
<div class="warn-box">
<p><strong>注意</strong></p>
<p>求職活動中の基準指数は6点で、就労中（最大20点）の3分の1以下です。求職中での入園は人気エリアでは困難です。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 95,
  },
