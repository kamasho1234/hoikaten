...
<p>最新情報は<a href="https://www.city.kushiro.lg.jp/kosodatekyouiku/kosodate/1008292/1005300/1005308/index.html" target="_blank" rel="noopener">釧路市公式サイト「保育所等の利用について」</a>をご確認ください。</p>
  ...
  },
  {
    ...
    citySlug: "kushiro",
    title: "釧路市の入園点数のしくみ　基本点数と調整点数をやさしく解説",
    description:
      "釧路市の保育園入園選考で使われる点数制度の仕組みを、初めての方にもわかるように解説します。",
    image:
      "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=800&h=400&fit=crop",
    category: "点数・選考",
    categoryColor: "blue",
    content: `<h2>点数制度の全体像</h2>
<p>釧路市の認可保育施設は<strong>合計点数の高い世帯から優先</strong>して利用調整されます。</p>
...
<tr><td>釧路市内の認可保育施設に勤務する保育士等</td><td>+30</td></tr>
...
<p>詳細な利用調整基準表は<a href="https://www.city.kushiro.lg.jp/kosodatekyouiku/kosodate/1008292/1005300/1005308/index.html" target="_blank" rel="noopener">釧路市公式サイト「保育所等の利用について」</a>で確認できます。</p>
  ...
  },
  {
    ...
    description:
      "釧路市の保育園入園選考で有利になる調整点数の加点項目と、活用のポイントを解説します。",
    image:
      "https://images.unsplash.com/photo-1521791136064-7986c2920216?w=800&h=400&fit=crop",
    category: "点数・選考",
    categoryColor: "blue",
    content: `<h2>基本点数40がスタートライン</h2>
<p>釧路市では父母とも外勤フルタイム（月160時間以上）であれば基本点数は<span class="highlight">20＋20＝40</span>になります。多くの共働き家庭がこの水準になるため、差を分けるのは調整点数です。</p>

<h2>主な加点項目と活用のポイント</h2>

<h3>1. 保育施設勤務（+30点 / +28点）</h3>
<p>釧路市内の認可保育施設に保育士・看護師等として勤務を開始する場合や育休から復帰する場合、<span class="highlight">+30点</span>という大きな加算があります。市外の場合は+28点です。</p>
...
<h2>釧路市の特徴：保育士等への手厚い加点</h2>
<p>釧路市は保育施設で働く保護者への加点が+30点と非常に大きいのが特徴です。北海道東部の中心都市として保育人材の確保を重視している姿勢がうかがえます。</p>

<div class="warn-box">
<p><strong>注意</strong></p>
<p>保育料を正当な理由なく滞納し、誠意ある対応がみられない場合は減算の対象となることがあります。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 55,
  },
  {
    ...
    citySlug: "kushiro",
    title: "釧路市の認可保育園と認可外保育施設の違い　選び方ガイド",
    description:
      "釧路市で保育園を選ぶとき知っておきたい、認可保育園と認可外保育施設の違いをまとめました。",
    image:
      "https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?w=800&h=400&fit=crop",
    category: "保育園選び",
    categoryColor: "teal",
    content: `<h2>認可保育園とは</h2>
<p>国が定めた基準（面積、保育士数、設備など）を満たし、釧路市が認可した保育施設です。保育料は世帯の所得に応じて決まり、3歳以上は無償化の対象です。釧路市内には認可保育園が約25か所あります。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>認可外保育施設は利用調整がないため、認可園に入れなかった場合のセーフティネットとして利用できます。釧路市では0〜2歳の住民税非課税世帯は月額42,000円まで無償化の対象です。</p>
</div>
...
<p>釧路市内の保育施設一覧は<a href="https://www.city.kushiro.lg.jp/kosodatekyouiku/kosodate/1008292/1005300/1005308/index.html" target="_blank" rel="noopener">釧路市公式サイト「保育所等の利用について」</a>で確認できます。</p>
  ...
  },
  {
    ...
    citySlug: "kushiro",
    title: "釧路市の保育園見学チェックリスト　見るべきポイント15選",
    description:
      "釧路市で保育園見学に行く前に知っておきたい、チェックすべきポイントをまとめました。",
    image:
      "https://images.unsplash.com/photo-1524813686514-a57563d77965?w=800&h=400&fit=crop",
    category: "保育園選び",
    categoryColor: "teal",
    content: `<h2>見学前の準備</h2>
<p>釧路市では例年6月〜10月が見学シーズンです。希望する園に電話で見学予約を入れましょう。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>釧路市は冬の寒さが厳しく、海霧の影響で夏でも気温が低い日があります。冬場の通園を想定した園選びが重要です。駐車場の広さや除雪状況も確認しましょう。</p>
</div>
...
<div class="warn-box">
<p><strong>注意</strong></p>
<p>釧路市は冬場に氷点下15℃以下になることもあります。暖房設備の種類や室温管理、冬場の送迎動線は必ず確認しましょう。釧路湿原に近い地域では道路状況にも注意が必要です。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 45,
  },
  {
    slug: "ikukyu-hokatsu",
    citySlug: "kushiro",
    title: "育休中の保活ガイド　釧路市で育休明け入園を成功させるコツ",
    description:
      "釧路市で育休中に保活を進めるスケジュールと、入園選考の仕組みを活かす方法を解説します。",
    image:
      "https://images.unsplash.com/photo-1507925921958-8a62f3d1a50d?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>育休中でもフルタイムの基本点数が得られる</h2>
<p>釧路市では育児休業中でも勤務先に在籍していれば、就労証明書に基づいて基本点数が算出されます。フルタイム勤務の方は<span class="highlight">20点</span>が基本点数になります。</p>

<h2>育休中の保活スケジュール</h2>
<div class="step">
<div class="step-num">1</div>
<div class="step-content"><strong>産後〜6か月：情報収集</strong><p>釧路市の公式サイトで保育施設一覧と前年度の入園申込案内を確認します。</p></div>
</div>
<div class="step">
<div class="step-num">2</div>
...
<div class="step">
<div class="step-num">4</div>
<div class="step-content"><strong>11月：申込</strong><p>こども育成課の窓口で書類を提出します。</p></div>
</div>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>通勤可能な範囲の園を複数希望し、真剣に入園を目指している方は影響を受けません。釧路市では利用調整の結果、入所できなかった場合の通知書で育休延長の手続きができます。</p>
</div>
...
<p>育休給付金延長の詳細は<a href="https://www.mhlw.go.jp/stf/seisakunitsuite/bunya/0000160564_00040.html" target="_blank" rel="noopener">厚生労働省「育児休業給付金の支給対象期間延長手続き」</a>をご確認ください。</p>
  ...
  },
  {
    ...
    citySlug: "kushiro",
    title: "釧路市の小規模保育園ガイド　卒園後+5点の加点を活かす戦略",
    description:
      "釧路市の小規模保育事業の特徴と、卒園後に+5点の調整加点が得られるメリットを解説します。",
    image:
...
<h2>卒園後のメリット：+5点</h2>
<p>釧路市では2歳クラスまでの保育施設の卒園児に<span class="highlight">+5点</span>の調整点数が加算されます。</p>
...
<li>釧路市は冬場の移動が大変なため、自宅や職場からの距離に注意</li>
</ul>
...
<p>釧路市内の保育施設一覧は<a href="https://www.city.kushiro.lg.jp/kosodatekyouiku/kosodate/1008292/1005300/1005308/index.html" target="_blank" rel="noopener">釧路市公式サイト「保育所等の利用について」</a>で確認できます。</p>
  ...
  },
  {
    ...
    citySlug: "kushiro",
    title: "釧路市で二人目の保活　きょうだい加点と同園希望を活用",
    description:
      "釧路市で二人目の保活をする際のきょうだい在園加点（+3）や同園希望加点（+10）の仕組みを解説します。",
    image:
      "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800&h=400&fit=crop",
    category: "点数・選考",
    categoryColor: "blue",
    content: `<h2>きょうだい在園で+3点</h2>
<p>釧路市ではすでに保育施設に入園中の兄弟姉妹がいる場合、1人ごとに<span class="highlight">+3点</span>の調整点数が加算されます。</p>

<h2>同園希望で+10点</h2>
<p>きょうだいが入園している保育施設のみに入園を希望する場合、さらに<span class="highlight">+10点</span>が加算されます。これは釧路市の調整点数の中でも大きな加点項目です。</p>
...
<h2>保育料の多子軽減</h2>
<p>釧路市では多子軽減制度があり、第2子以降の保育料が軽減されます。3歳以上は無償化、0〜2歳も第2子以降は保育料が減額されます。</p>
...
<p>同園希望の+10点は、きょうだいが入園している保育施設「のみ」を希望する場合に限られます。他の園も併願する場合はこの加点は適用されません。</p>
  ...
  },
  {
    slug: "hoikuryo-guide",
    citySlug: "kushiro",
    title: "釧路市の保育料ガイド　世帯年収別の目安と軽減制度",
    description:
      "釧路市の保育料の決まり方、無償化の範囲、多子軽減やひとり親世帯向け軽減制度をわかりやすく解説します。",
    image:
      "https://images.unsplash.com/photo-1476703993599-0035a21b17a9?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>保育料の決まり方</h2>
<p>釧路市の保育料は<strong>市町村民税の所得割額</strong>に基づいて階層ごとに設定されます。世帯の課税状況によって月額が決まります。</p>
...
<table>
<tr><th>階層区分</th><th>月額の目安</th></tr>
<tr><td>生活保護世帯</td><td>0円</td></tr>
<tr><td>非課税世帯</td><td>0円</td></tr>
<tr><td>所得割額が低い世帯</td><td>約8,000〜15,000円</td></tr>
<tr><td>中間層</td><td>約25,000〜45,000円</td></tr>
<tr><td>最高階層</td><td>約70,000円台</td></tr>
</table>
...
<p>保育料の詳細は<a href="https://www.city.kushiro.lg.jp/kosodatekyouiku/kosodate/1008292/1005300/1005308/index.html" target="_blank" rel="noopener">釧路市公式サイト「保育所等の利用について」</a>をご確認ください。</p>
  ...
  },
  {
    ...
    citySlug: "kushiro",
    title: "釧路市で保育園に落ちたときの対処法　次にやるべきこと",
    description:
      "釧路市の1次選考で入所できなかった場合の選択肢と、次にとるべきアクションをまとめました。",
    image:
...
<p>1次で辞退が出た枠で再度利用調整が行われます。釧路市では2次選考の申込を受け付けています。希望園の変更・追加も可能です。</p>

<h2>選択肢2：年度途中入園を申し込む</h2>
<p>釧路市では毎月の利用調整があり、空きが出れば途中入園できます。入園希望月の前月初旬が締切なので、毎月忘れずに確認しましょう。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>釧路市は人口約16万人の北海道東部の中心都市です。都市部に比べて待機児童は少ない傾向にありますが、人気の園や0〜1歳児クラスは定員が埋まりやすいです。空き状況を定期的にチェックしましょう。</p>
</div>
...
<p>空き状況は<a href="https://www.city.kushiro.lg.jp/kosodatekyouiku/kosodate/1008292/1005300/1005308/index.html" target="_blank" rel="noopener">釧路市公式サイト「保育所等の利用について」</a>で確認できます。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "kushiro",
    title: "釧路市の保育料はいくら？　上限額と決まり方",
    description:
      "釧路市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>釧路市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>釧路市でいちばん高い階層はいくら？</h2>
<p>釧路市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額93,700円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
...
<p>上記の金額は釧路市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.kushiro.lg.jp/kosodatekyouiku/kosodate/1008292/1005300/1005301/1015848.html" target="_blank" rel="noopener">釧路市の保育料表</a>をご確認ください。</p>
</div>`,
