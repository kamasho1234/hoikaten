...
<p>途中入所や空き状況については<a href="https://www.city.hirakata.osaka.jp/0000046030.html" target="_blank" rel="noopener">枚方市 保育所（園）等の利用調整の受入れ枠等について</a>をご確認ください。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "hirakata",
    title: "枚方市の保育料はいくら？　上限額と決まり方",
    description:
      "枚方市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>枚方市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>枚方市でいちばん高い階層はいくら？</h2>
<p>枚方市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額52,000円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
...
<p>上記の金額は枚方市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.hirakata.osaka.jp/kosodate/cmsfiles/contents/0000016/16509/hoikuryou.hukusyokuhinosshiori(R8.4).pdf" target="_blank" rel="noopener">枚方市の保育料表</a>をご確認ください。</p>
</div>`,
