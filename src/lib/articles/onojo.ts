...
const articles: Article[] = [
  {
    ...
    citySlug: "onojo",
    title: "大野城市の保活スケジュール　申込から内定までの流れ",
    description:
      "大野城市の認可保育園の申込時期・選考の流れをまとめました。令和8年度4月入園の動き方を解説します。",
    image: "https://images.unsplash.com/photo-1484820540004-14229fe36ca4?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>大野城市の4月入園スケジュール</h2>
<p>大野城市の認可保育園は毎年秋に翌年度4月入園の一斉申込を受付けます。子育て支援課が窓口です。</p>
...
<p>市のホームページで保育園の一覧や空き状況を確認します。大野城市には認可保育園が複数あります。</p>
</div>
</div>
<div class="step">
...
<p>気になる園に連絡して見学を予約しましょう。福岡市のベッドタウンとして発展している大野城市は、環境の良い園が多くあります。</p>
</div>
</div>
<div class="step">
...
<p>大野城市は人口約10万人の福岡県中西部の市です。福岡市への通勤圏内として子育て世帯に人気があります。</p>
</div>

<div class="info-box">
<p><strong>公式情報</strong></p>
<p>詳しくは<a href="https://www.city.onojo.fukuoka.jp/" target="_blank" rel="noopener">大野城市公式サイト</a>をご確認ください。</p>
</div>`,
  ...
  },
  {
    ...
    citySlug: "onojo",
    title: "大野城市の入園点数のしくみ　基準指数と調整指数を解説",
    description:
      "大野城市の保育園入園選考で使われる基準指数と調整指数のしくみを解説します。",
    image: "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>大野城市の選考指数とは</h2>
<p>大野城市の認可保育園の入園選考は「基準指数＋調整指数」の合計で行われます。</p>
...
<p>本シミュレーターは福岡県内の近隣自治体の基準を参考値として使用しています。実際の基準は必ず大野城市子育て支援課で確認してください。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 60,
  },
  {
    slug: "score-up-tips",
    citySlug: "onojo",
    title: "大野城市で入園点数を上げるコツ　加点を最大化する方法",
    description:
      "大野城市の保育園入園選考で調整指数の加点を最大限に活用する方法を解説します。",
    image: "https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>基準指数40点は出発点</h2>
<p>大野城市ではフルタイム共働き世帯は基準指数40点で横並びです。差がつくのは調整指数です。</p>
...
<p>同点勝負では市内在住が有利になります。正確な申告と書類準備が合否を分けることもあります。</p>
  ...
  },
  {
    ...
    citySlug: "onojo",
    title: "大野城市のパート・時短勤務の点数　何時間で何点？",
    description:
      "大野城市の保育園入園で、パートや時短勤務の場合にもらえる基準指数を解説します。",
    image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>パート・時短勤務の基準指数</h2>
<p>大野城市では勤務日数と週あたりの勤務時間の組み合わせで基準指数が決まります。</p>
...
<li>就労証明書は正確に記入する</li>
  ...
  },
  {
    ...
    citySlug: "onojo",
    title: "大野城市のひとり親世帯の加点　基準指数との組み合わせ",
    description:
      "大野城市の保育園入園でひとり親世帯が受ける加点と、効果的な活用方法を解説します。",
    image: "https://images.unsplash.com/photo-1506216613332-2bab299ebd7d?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>ひとり親世帯の加点</h2>
<p>大野城市ではひとり親世帯に対して調整指数で加点があります。これは大きなアドバンテージになります。</p>
...
<p>ひとり親であることを証明する書類（戸籍謄本等）は漏れなく提出しましょう。申告漏れは加点を受けられません。</p>
  ...
  },
  {
    ...
    citySlug: "onojo",
    title: "大野城市で育児休業明けの入園　タイミングと加点の活用法",
    description:
      "大野城市の保育園入園で、育児休業からの復帰時期を合わせるための戦略を解説します。",
    image: "https://images.unsplash.com/photo-1519046904884-53103b34b206?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>育児休業明けの加点戦略</h2>
<p>大野城市では育児休業を取得し、入園月に復帰する場合に加点があります。この加点をうまく活用することが重要です。</p>
...
<p>復帰予定日の書類は重要です。入園月に実際に復帰できるよう、会社との調整を早めに済ませましょう。</p>
  ...
  },
  {
    ...
    citySlug: "onojo",
    title: "大野城市の待機児童　いつ入園できるの？",
    description:
      "大野城市の待機児童の状況と、入園しやすい時期・クラスについてまとめました。",
    image: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=800&h=400&fit=crop",
    category: "最新情報",
    categoryColor: "purple",
    content: `<h2>大野城市の待機児童状況</h2>
<p>大野城市は福岡県内の他市に比べて待機児童の状況は異なります。最新の情報を必ず確認しましょう。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>待機児童の状況は年によって変わります。大野城市子育て支援課で最新情報を確認してください。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 40,
  },
  {
    ...
    citySlug: "onojo",
    title: "大野城市の保育園申込　書類チェックリスト",
    description:
      "大野城市の保育園申込に必要な書類をまとめ、漏れのないようチェックリストを用意しました。",
...
<p>大野城市では認可外保育施設に月ぎめで預けている場合、調整指数で加点が得られます。</p>
