...
const articles: Article[] = [
  {
    ...
    citySlug: "kiyose",
    title: "清瀬市の保活スケジュール　申込から内定までの流れ",
    description:
      "清瀬市の認可保育園の申込時期・選考の流れをまとめました。令和8年度4月入園の動き方を解説します。",
    image: "https://images.unsplash.com/photo-1484820540004-14229fe36ca4?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>清瀬市の4月入園スケジュール</h2>
<p>清瀬市の認可保育園は毎年秋に翌年度4月入園の一次申込を受付けます。基準指数を正しく理解して計画的に進めましょう。</p>
...
<p>清瀬市のホームページで保育園の一覧や前年度のボーダー（最低指数一覧）を確認します。</p>
</div>
</div>
<div class="step">
...
<p>清瀬市内の保育園を見学して、通勤経路との相性を確認しましょう。</p>
</div>
</div>
<div class="step">
...
<p>清瀬市の基準指数は父母各最大20点（合計40点満点）です。月の就労時間で判定される制度です。</p>
</div>

<div class="info-box">
<p><strong>公式情報</strong></p>
<p>詳しくは<a href="https://www.city.kiyose.lg.jp/kosodatekyouiku/hoikusyoyouchien/hoikuen/" target="_blank" rel="noopener">清瀬市公式サイト 保育施設のご案内</a>をご確認ください。</p>
</div>`,
  ...
  },
  {
    ...
    citySlug: "kiyose",
    title: "清瀬市の入園点数のしくみ　基準指数と調整指数を解説",
    description:
      "清瀬市の保育園入園選考で使われる基準指数と調整指数のしくみをわかりやすく解説します。",
    image: "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>清瀬市の選考指数とは</h2>
<p>清瀬市の認可保育園は「基準指数（父＋母）＋ 調整指数」の合計で選考されます。参考値ですので、詳細は市の公式資料をご確認ください。</p>
...
<p>このページの数値は参考値です。正確な点数配分は市発行の「保育園等入園・在園のしおり」をご確認ください。</p>
  ...
  },
  {
    slug: "score-up-tips",
    citySlug: "kiyose",
    title: "清瀬市で入園点数を上げるコツ　調整指数の活用法",
    description:
      "清瀬市の認可保育園入園で有利になる調整指数の加点方法をまとめました。",
...
<p>同点回避には調整指数の加点がカギになります。確実に加点される要件がないか、今からチェックしましょう。</p>
  ...
  },
  {
    ...
    citySlug: "kiyose",
    title: "清瀬市の保活　パート・時短勤務での点数の取り方",
    description:
      "パートタイムや時短勤務の場合、清瀬市でどれくらいの点数がつくのか解説します。",
...
<p>基準指数が下がる分、ひとり親加算や地域型保育施設からの転所などで調整指数を増やす必要があります。</p>
  ...
  },
  {
    ...
    citySlug: "kiyose",
    title: "清瀬市の保活　ひとり親世帯の加点と有利な制度",
    description:
      "清瀬市でひとり親世帯が受けられる加点や優遇制度をまとめました。",
    image: "https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=800&h=400&fit=crop",
    category: "点数を稼ぐコツ",
    categoryColor: "rose",
    content: `<h2>ひとり親世帯の加点制度</h2>
<p>ひとり親世帯は清瀬市の保育園入園選考で加点対象です。申告忘れがないように注意しましょう。</p>
...
<li>ひとり親 + 地域型保育からの転所：+2 + 3 = +5点</li>
  ...
  },
  {
    ...
    citySlug: "kiyose",
    title: "清瀬市の保活　育児休業からの復帰タイミング戦略",
    description:
      "清瀬市で育児休業から復帰して保育園に入園する場合のタイミングと加点を解説します。",
...
→ 申込みでは復帰後の20点で判定</p>`,
  ...
  },
  {
    ...
    citySlug: "kiyose",
    title: "清瀬市の保育園　待機児童と入園難易度の動き",
    description:
      "清瀬市の待機児童数や保育園の競争状況、年度による変動を解説します。",
    image: "https://images.unsplash.com/photo-1503454537688-e47a5c0997c1?w=800&h=400&fit=crop",
    category: "保活情報",
    categoryColor: "green",
    content: `<h2>清瀬市の保活状況</h2>
<p>清瀬市の待機児童数や入園難易度の推移を把握することで、現実的な計画が立てられます。</p>

<h3>清瀬市の保育需要</h3>

<div class="point-box">
<p><strong>人口約7.5万の東京都多摩地区</strong></p>
<p>清瀬市は都心へのアクセスが良好な立地のため、保育需要が安定しています。</p>
</div>
...
<li>調整指数の加点要件がないか事前チェック</li>
  ...
  },
  {
    ...
    citySlug: "kiyose",
    title: "清瀬市の保活　申込み書類チェックリスト",
    description:
      "清瀬市の保育園申し込みに必要な書類と準備のチェックリストです。",
    image: "https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "amber",
    content: `<h2>申込み書類の準備</h2>
<p>清瀬市の保育園申し込みに必要な書類を早めに確認して、提出期限に間に合わせましょう。</p>
...
<p>清瀬市の場合、郵送受付または直接持参の両方が可能な場合が多いです。期限内に確実に提出しましょう。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 48,
  },
