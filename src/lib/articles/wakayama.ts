...
<p>保育士の求人情報は<a href="https://www.city.wakayama.wakayama.jp/shisei/1009417/soshiki/1002616/1002641/1002704.html" target="_blank" rel="noopener">和歌山市保育こども園課</a>でも案内しています。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "wakayama",
    title: "和歌山市の保育料はいくら？　上限額と決まり方",
    description:
      "和歌山市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>和歌山市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>和歌山市でいちばん高い階層はいくら？</h2>
<p>和歌山市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額74,000円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>保育料は毎年9月に切り替わります。4月分から8月分は前年度の住民税額、9月分から翌年3月分は当年度の住民税額で決まる自治体が多いため、9月に金額が変わることがあります。</p>
</div>
<h2>きょうだいがいる世帯の軽減</h2>
<p>和歌山市は次のように案内しています。</p>
<blockquote><p>C1、C3、C5、C7、C9階層で生計を同じにする子どもが2人以上いる場合、子どもの年齢に関係なく、第2子以降は無料です。</p></blockquote>
<div class="info-box">
<p><strong>出典</strong></p>
<p>上記の金額は和歌山市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.wakayama.wakayama.jp/kurashi/kosodate/1001104/1010398/1001802.html" target="_blank" rel="noopener">和歌山市の保育料表</a>をご確認ください。</p>
</div>`,
