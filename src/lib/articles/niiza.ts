...
<p>正確な基準表は<a href="https://www.city.niiza.lg.jp/soshiki/93/" target="_blank" rel="noopener">新座市こども未来部保育課</a>に掲載の利用調整基準表をご確認ください。</p>
  ...
  // =========================================================================
  {
    ...
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>60点はどうやって計算される？</h2>
<p>新座市の保育園選考で「60点がボーダー」とよく言われます。この60点の内訳を見てみましょう。</p>

<table>
<tr><th>項目</th><th>点数</th></tr>
<tr><td>保護者1：フルタイム就労（月160時間以上）</td><td>30点</td></tr>
<tr><td>保護者2：フルタイム就労（月160時間以上）</td><td>30点</td></tr>
<tr><td colspan="2"><strong>合計：60点</strong></td></tr>
</table>

<p>つまり<strong>フルタイム共働き</strong>で基本指数が満点の60点。多くの家庭がこの60点で横並びになります。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>60点同士の勝負では、調整指数の加点が合否を分けます。+3〜5点の差が内定・不承諾の差になることがあります。</p>
</div>
...
<h3>ひとり親世帯：+13点または+18点</h3>
<p>祖父母と同居していない場合は+18点、同居している場合は+13点が加算されます。これは最も大きな加点です。ひとり親であることを証明する書類（戸籍謄本等）が必要になります。</p>

<h3>きょうだいが認可園に在園：+3点</h3>
<p>上のお子さんが認可保育園に在園中なら+3点が加算されます。2人目以降の保活では大きなアドバンテージです。</p>

<h3>認可外保育施設を利用：+2点または+4点</h3>
<p>週3日の利用で+2点、週4日以上の利用で+4点が加算されます。育休を切り上げて認可外に預け、復職してから認可に申し込む方法があります。</p>
...
<h3>育休からの復帰予定：+4点</h3>
<p>産休・育休から復帰予定の場合に加算されます。認可外利用の加点と併用できるかは窓口で確認しましょう。</p>
...
<p>各園の空き状況は<a href="https://www.city.niiza.lg.jp/soshiki/93/" target="_blank" rel="noopener">新座市こども未来部保育課</a>で確認できます。</p>
  ...
  // =========================================================================
  {
    ...
    citySlug: "niiza",
    title: "新座市で認可外加点（+2点または+4点）を活用して認可を狙う方法",
    description:
      "新座市で認可外保育施設の利用による加点（週3日で+2点、週4日以上で+4点）を活用して認可保育園に入る戦略と注意点を解説します。",
    image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>認可外加点を使う戦略とは</h2>
<p>新座市では認可外保育施設に子どもを預けている場合に調整指数で加点が加算されます。週3日で+2点、週4日以上で+4点の加点が得られ、60点で横並びになる中、この2～4点の差は大きいです。</p>
...
<p>最新の利用調整結果は<a href="https://www.city.niiza.lg.jp/soshiki/93/" target="_blank" rel="noopener">新座市こども未来部保育課</a>で公開されています。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "niiza",
    title: "新座市の保育料はいくら？　上限額と決まり方",
    description:
      "新座市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>新座市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>新座市でいちばん高い階層はいくら？</h2>
<p>新座市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額66,000円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>保育料は毎年9月に切り替わります。4月分から8月分は前年度の住民税額、9月分から翌年3月分は当年度の住民税額で決まる自治体が多いため、9月に金額が変わることがあります。</p>
</div>
<h2>きょうだいがいる世帯の軽減</h2>
<p>新座市は次のように案内しています。</p>
<blockquote><p>,700円未満(年収360万未満相当）の世帯は、上のお子さんが小学生以上であっても年齢は問わず、年齢の高い順から第1子、第2子、第3子と位置付けられ、第2子は該当する年齢区分の半額、第3子以降は無料となります。</p></blockquote>
<div class="info-box">
<p><strong>出典</strong></p>
<p>上記の金額は新座市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.niiza.lg.jp/uploaded/attachment/34378.pdf" target="_blank" rel="noopener">新座市の保育料表</a>をご確認ください。</p>
</div>`,
