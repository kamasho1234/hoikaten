...
<h3>2. きょうだいが希望園に在園中（+25点）</h3>
<p>上の子が既に希望する保育園に通っている場合に加算されます。同じ園を希望することが条件です。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>フルタイム共働き＋きょうだい在園＋育休明けの場合：基本30＋きょうだい25＋育休明け5＝<span class="highlight">合計60点</span>。この水準であれば多くの園で有利に選考が進みます。</p>
</div>

<h3>3. 育休・産休明け復帰（+5点）</h3>
...
<p>甲府市内の保育施設一覧は<a href="https://www.city.kofu.yamanashi.jp/shisetsu/hoiku/index.html" target="_blank" rel="noopener">甲府市公式サイト 子育て・教育</a>で確認できます。</p>
  ...
  },
  {
    ...
    description:
      "甲府市で育休中に保活を進めるスケジュールと、育休明け加点（+5点）を活かす方法を解説します。",
    image:
      "https://images.unsplash.com/photo-1507925921958-8a62f3d1a50d?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>育休明け加点は+5点</h2>
<p>甲府市では育休・産休から復帰して入園月中に職場復帰する場合、調整指数として<span class="highlight">+5点</span>が加算されます。フルタイム共働き世帯なら基本30＋育休明け5＝<span class="highlight">合計35点</span>になります。</p>
...
<p>甲府市内の保育施設一覧は<a href="https://www.city.kofu.yamanashi.jp/shisetsu/hoiku/index.html" target="_blank" rel="noopener">甲府市公式サイト 子育て・教育</a>で確認できます。</p>
  ...
  },
  {
    ...
    category: "点数・選考",
    categoryColor: "blue",
    content: `<h2>きょうだいが希望園に在園中で+25点</h2>
<p>甲府市では上の子が既に希望する保育園に在園している場合、<span class="highlight">+25点</span>の調整指数が加算されます。同じ園を希望することで送迎の負担も軽減できます。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>フルタイム共働き＋きょうだい在園＋育休明けの場合：基本30＋きょうだい25＋育休明け5＝<span class="highlight">合計60点</span>。同じ園を希望する場合は有利に選考が進みます。</p>
</div>

<table>
<tr><th>パターン</th><th>調整指数</th></tr>
<tr><td>きょうだいが希望園に在園中</td><td>+25</td></tr>
<tr><td>育休・産休明け復帰</td><td>+5</td></tr>
</table>
...
<p>甲府市の保育施設の空き状況は<a href="https://www.city.kofu.yamanashi.jp/shisetsu/hoiku/index.html" target="_blank" rel="noopener">甲府市公式サイト 子育て・教育</a>で確認できます。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "kofu",
    title: "甲府市の保育料はいくら？　上限額と決まり方",
    description:
      "甲府市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>甲府市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>甲府市でいちばん高い階層はいくら？</h2>
<p>甲府市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額48,400円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>保育料は毎年9月に切り替わります。4月分から8月分は前年度の住民税額、9月分から翌年3月分は当年度の住民税額で決まる自治体が多いため、9月に金額が変わることがあります。</p>
</div>
<h2>きょうだいがいる世帯の軽減</h2>
<p>甲府市は次のように案内しています。</p>
<blockquote><p>一世帯内のみ）新制度未移行の幼稚園に通う子どものうち(1)年収360万円未満相当世帯の子ども(2)所得階層にかかわらず、第3子以降の子ども（1）小学校第3学年修了前（同一世帯内のみ）○0歳から2歳までの子どもについては、市民税非課税世帯を対象として利用料が無償化されます。</p></blockquote>
<div class="info-box">
<p><strong>出典</strong></p>
<p>上記の金額は甲府市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.kofu.yamanashi.jp/jidohoiku/kenko/kosodate/hoiku/documents/r8hoikuryou.pdf" target="_blank" rel="noopener">甲府市の保育料表</a>をご確認ください。</p>
</div>`,
