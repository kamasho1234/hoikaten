...
const articles: Article[] = [
  // ===== 保活の基本 (1) =====
  {
    ...
    citySlug: "kasugai",
    title: "春日井市の保活スケジュール　令和8年度4月入園の流れ",
    description:
      "春日井市の認可保育園の申込時期・選考の流れ・結果通知の時期をわかりやすく解説。令和8年度4月入園のスケジュールを中心にまとめました。",
    image:
      "https://images.unsplash.com/photo-1484820540004-14229fe36ca4?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>令和8年度（2026年度）4月入園のスケジュール</h2>
<p>春日井市の4月入園は<strong>一次利用調整</strong>と<strong>二次利用調整</strong>の2回に分かれています。申込先は春日井市こども未来部保育課です。</p>
...
<p>春日井市の認可保育園は約40か所。エリアや園の特徴を調べましょう。</p>
</div>
</div>
<div class="step">
...
<p>春日井市が発行する「保育施設利用のご案内」を入手しましょう。</p>
</div>
</div>
<div class="step">
...
<p>各月の申込締切日は、入園希望月の<span class="highlight">前月10日頃</span>です。詳しくは春日井市の公式サイトをご確認ください。</p>`,
  ...
  // ===== 保活の基本 (2) =====
  {
    ...
    citySlug: "kasugai",
    title: "春日井市の保活でよくある失敗と対策5選",
    description:
      "春日井市の保活で初めてのママがやりがちな失敗パターンと、その対策をまとめました。",
    image:
      "https://images.unsplash.com/photo-1476703993599-0035a21b17a9?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>失敗1：情報収集のスタートが遅い</h2>
<p>春日井市の4月入園の申込は<span class="highlight">11月</span>から始まります。見学の予約が埋まる前に動きましょう。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>遅くとも6月には情報収集を始めましょう。春日井市は人口約31万人で名古屋のベッドタウンとして子育て世帯が多く、駅周辺の園は競争率が高めです。</p>
</div>

<h2>失敗2：希望園を少なく書く</h2>
<p>春日井市では希望園を複数記入できます。1〜2園しか書かないと不承諾のリスクが高まります。通える範囲の園はできるだけ多く書きましょう。</p>
...
<p>春日井市こども未来部保育課の窓口で、申込前に書類の事前確認ができます。不安な方は活用しましょう。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 50,
  },
...
<li>同居祖父母が保育可能：<span class="highlight">-3点</span></li>
  ...
  // ===== 点数アップ =====
  {
    ...
    citySlug: "kasugai",
    title: "春日井市で点数を1点でも上げる方法　加点のチェックリスト",
    description:
      "春日井市の入園選考で調整指数の加点を最大限に活用する方法を、チェックリスト形式で解説します。",
    image:
      "https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>加点の取りこぼしをなくそう</h2>
<p>春日井市の入園選考では<span class="highlight">1点</span>の差が明暗を分けることも。使える加点は漏れなく活用しましょう。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>認可外保育施設に預けながら翌年の4月入園を申し込むと、+3点の加点がつきます。0歳児クラスで認可外に預け、1歳児クラスで認可園を狙うのは春日井市でも有効な戦略です。</p>
</div>

<div class="info-box">
<p><strong>注意すべき減点項目</strong></p>
<p>春日井市外からの申込は-10点、認可園からの転園は-5点、同居祖父母が保育可能な場合は-3点の減点があります。特に市外からの申込は大幅な減点となるため要注意です。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 60,
  },
  // ===== エリア情報 =====
  {
    slug: "area-guide",
    citySlug: "kasugai",
    title: "春日井市の保育園マップ　エリアごとの入りやすさを比較",
    description:
      "春日井市内のエリアごとの保育園の競争率や特徴をまとめました。",
    image:
      "https://images.unsplash.com/photo-1569058242253-92a9c755a0ec?w=800&h=400&fit=crop",
    category: "エリア情報",
    categoryColor: "purple",
    content: `<h2>春日井市の保育園事情</h2>
<p>春日井市は愛知県尾張地方に位置する人口約31万人の市で、名古屋市のベッドタウンとして発展しています。JR中央本線の春日井駅・勝川駅を中心に住宅地が広がり、認可保育園は約40か所あります。</p>

<h2>エリアごとの競争率</h2>

<h3>競争率が高いエリア</h3>
<ul>
<li><strong>勝川駅周辺</strong>：名古屋へのアクセスが良く、再開発でマンションが増加。特に0歳児・1歳児クラスは激戦</li>
<li><strong>春日井駅周辺</strong>：駅近の園は人気が集中。ファミリー層が多い</li>
</ul>

<h3>比較的入りやすいエリア</h3>
<ul>
<li><strong>高蔵寺エリア</strong>：高蔵寺ニュータウンを含む広いエリアで、園の選択肢が多い</li>
<li><strong>味美・牛山エリア</strong>：名鉄小牧線沿線で、駅前の園以外は比較的空きがある</li>
</ul>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>春日井市は名古屋への通勤者が多く、勝川駅周辺は特に人気です。希望する園だけでなく、通勤経路上の園も含めて幅広く検討しましょう。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 45,
  },
  // ===== 認可外 =====
  {
    slug: "ninkagai-guide",
    citySlug: "kasugai",
    title: "春日井市の認可外保育施設ガイド　認可園との違いは？",
    description:
      "春日井市で認可園に入れなかった場合の選択肢として、認可外保育施設について解説します。",
    image:
      "https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=800&h=400&fit=crop",
    category: "認可外保育",
    categoryColor: "teal",
    content: `<h2>認可外保育施設とは？</h2>
<p>認可外保育施設は、認可基準を満たしていないものの、自治体に届出をして運営している保育施設です。春日井市内にも複数の認可外保育施設があります。</p>
...
<li>施設の安全対策</li>
  ...
  // ===== 小規模保育 =====
  {
    slug: "small-nursery",
    citySlug: "kasugai",
    title: "春日井市の小規模保育って？　メリット・デメリットを解説",
    description:
      "春日井市の小規模保育事業の特徴やメリット・デメリット、卒園後の進路について解説します。",
    image:
      "https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>春日井市では小規模保育の卒園児に対して、認可園への優先的な利用調整を行っています。3歳の壁を心配しすぎず、まずは入れる園を確保することが大切です。</p>
</div>

<div class="info-box">
<p><strong>情報</strong></p>
<p>春日井市内の小規模保育事業所の一覧は、春日井市こども未来部保育課の窓口または公式サイトで確認できます。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 35,
  },
  // ===== 同点対策 =====
  {
    ...
    citySlug: "kasugai",
    title: "春日井市で同点になったらどうなる？　優先順位のしくみ",
    description:
      "春日井市の保育園入園選考で同点になった場合の優先順位と、事前にできる対策を解説します。",
    image:
      "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>同点の場合の優先順位</h2>
<p>春日井市では選考指数が同点の場合、以下の順番で優先されます。</p>

<ol>
<li>ひとり親世帯</li>
<li>希望する保育施設にきょうだいが在園している世帯</li>
<li>基本指数が高い世帯（調整指数による加点が少ない＝就労状況が安定）</li>
<li>春日井市の居住期間が長い世帯</li>
<li>所得が低い世帯</li>
</ol>
...
<div class="info-box">
<p><strong>情報</strong></p>
<p>春日井市では過去の入園最低指数を公開していることがあります。保育課の窓口で確認してみましょう。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 48,
  },
  // ===== 保育料 =====
  {
    slug: "nursery-fees",
    citySlug: "kasugai",
    title: "春日井市の保育料はいくら？　世帯年収別の目安を紹介",
    description:
      "春日井市の認可保育園の保育料を世帯年収別にわかりやすく紹介します。無償化の対象も解説。",
    image:
      "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&h=400&fit=crop",
    category: "お金の話",
    categoryColor: "rose",
    content: `<h2>保育料の決まり方</h2>
<p>春日井市の認可保育園の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">子どもの年齢</span>で決まります。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>春日井市では第2子の保育料は半額、第3子以降は無料になります（年収制限なし）。きょうだいが多い世帯は大きなメリットです。</p>
</div>

<div class="info-box">
<p><strong>注意</strong></p>
<p>上記はあくまで目安です。正確な保育料は住民税額で決まります。詳しくは春日井市こども未来部保育課にお問い合わせください。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 42,
  },
  // ===== 見学ガイド =====
  {
    ...
    citySlug: "kasugai",
    title: "春日井市の保育園見学ガイド　チェックポイントと質問リスト",
    description:
      "春日井市の保育園見学で確認すべきポイントと、先輩ママが聞いてよかった質問をまとめました。",
    image:
      "https://images.unsplash.com/photo-1544776193-352d25ca82cd?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>見学はいつ行くのがベスト？</h2>
<p><span class="highlight">6月〜9月</span>が見学のベストシーズンです。10月以降は申込直前で混み合います。春日井市内の認可保育園は約40か所あるので、気になる園を絞り込んでから見学に行きましょう。</p>
...
<li>駐車場は何台分あるか？（春日井市は車利用の家庭が多い）</li>
</ul>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>見学はできるだけ複数の園を回りましょう。比較することで自分に合った園が見えてきます。春日井市は車社会なので、駐車場の有無や送迎のしやすさも重要なチェックポイントです。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 38,
  },
