...
<p>豊川市はフルタイム共働きの場合、父20点＋母20点＝基本指数40点が基準ラインです。調整指数の加点で差がつきやすいので、該当する項目がないか確認しましょう。</p>
  ...
  // 3. 就労証明書の書き方
  {
    ...
    citySlug: "toyokawa",
    title: "豊川市の就労証明書｜様式ダウンロード先と記入例【令和8年度】",
    description:
      "豊川市の保育園申込みに使う就労証明書について、公式の様式ダウンロード先へのリンクと、点数の付き方・記入例・よくある不備をまとめています。会社に依頼する前に確認してください。",
    category: "書類準備",
    categoryColor: "amber",
    image:
...
<p>就労証明書の様式・記入例は<a href="https://www.city.toyokawa.lg.jp/kosodate_kyoiku/hoikuen_kodomoen_yochien/5/15174.html" target="_blank" rel="noopener">豊川市「保育施設入所について」</a>からダウンロードできます。この記事では、その様式をどう書くと点数にどう響くかを説明します。</p>
</div>
<h2>就労証明書とは</h2>
...
<div class="info-box">
<p><strong>公式情報</strong></p>
<p>詳しくは<a href="https://www.city.toyokawa.lg.jp/kosodate_kyoiku/hoikushisetsu/index.html" target="_blank" rel="noopener">豊川市 子ども健康部保育課のページ</a>をご確認ください。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 40,
  },
...
<div class="info-box">
<p><strong>公式情報</strong></p>
<p>保育料の詳細は<a href="https://www.city.toyokawa.lg.jp/kosodate_kyoiku/hoikushisetsu/index.html" target="_blank" rel="noopener">豊川市 子ども健康部保育課のページ</a>で確認できます。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 50,
  },
  {
    slug: "nursery-fees",
    citySlug: "toyokawa",
    title: "豊川市の保育料はいくら？　上限額と決まり方",
    description:
      "豊川市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>豊川市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>豊川市でいちばん高い階層はいくら？</h2>
<p>豊川市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額58,000円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
...
<p>上記の金額は豊川市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.toyokawa.lg.jp/kosodate_kyoiku/hoikuen_kodomoen_yochien/5/12552.html" target="_blank" rel="noopener">豊川市の保育料表</a>をご確認ください。</p>
</div>`,
