...
const articles: Article[] = [
  {
    ...
    citySlug: "nisshin",
    title: "日進市の保活スケジュール　申込から内定までの流れ",
    description:
      "日進市の認可保育園の申込時期・選考の流れをまとめました。令和8年度4月入園の動き方を解説します。",
    image: "https://images.unsplash.com/photo-1484820540004-14229fe36ca4?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>日進市の4月入園スケジュール</h2>
<p>日進市の認可保育園は毎年秋に翌年度4月入園の一次申込を受付けます。基本指数・調整指数を理解して準備を進めましょう。</p>
...
<p>日進市のホームページで保育園の一覧や前年度のボーダーを確認します。</p>
</div>
</div>
<div class="step">
...
<p>日進市内の保育園を見学して、通勤経路との相性を確認しましょう。</p>
</div>
</div>
<div class="step">
...
<p>詳しくは<a href="https://www.city.nisshin.lg.jp/department/kenko/hoiku/6/2/2/hoiku/17569.html" target="_blank" rel="noopener">日進市公式サイト 保育園等利用申込について</a>をご確認ください。</p>
</div>`,
  ...
  },
  {
    ...
    citySlug: "nisshin",
    title: "日進市の入園点数のしくみ　基本指数と調整指数を解説",
    description:
      "日進市の保育園入園選考で使われる基本指数と調整指数のしくみをわかりやすく解説します。",
    image: "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>日進市の選考点数とは</h2>
<p>日進市の認可保育園は「基本指数（父＋母）＋ 調整指数」の合計で選考されます。</p>
...
<p>入園希望度の高い順（優先番号）で判定されます。希望順位も重要な選考要因です。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 60,
  },
  {
    slug: "score-up-tips",
    citySlug: "nisshin",
    title: "日進市で入園点数を上げるコツ　調整指数チェックリスト",
    description:
      "日進市の保育園入園選考で調整指数の加点を最大限に活用する方法を解説します。",
    image: "https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>基本点数40点は出発点</h2>
<p>日進市ではフルタイム共働き世帯は基本点数<span class="highlight">40点</span>で横並びです。差がつくのは調整点数の加点です。</p>

<h2>加点チェックリスト</h2>
<table>
<tr><th>項目</th><th>点数</th><th>条件</th></tr>
<tr><td>ひとり親世帯（就労・内定中）</td><td>+5点</td><td>母子・父子家庭で就労中または内定</td></tr>
<tr><td>きょうだい在園</td><td>+3点</td><td>希望する保育施設にきょうだいが在園</td></tr>
<tr><td>認可外保育施設利用</td><td>+3点</td><td>認可外に月ぎめで利用中</td></tr>
<tr><td>生活保護</td><td>+3点</td><td>生活保護を受けている場合</td></tr>
<tr><td>きょうだい同時申込</td><td>+2点</td><td>2人以上きょうだいと同時申込</td></tr>
<tr><td>育休復帰予定</td><td>+2点</td><td>入園月に職場復帰する場合</td></tr>
</table>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>日進市では同点の場合、抽選の優先番号で判定されます。申込むときの優先順位も重要です。</p>
</div>
...
<p>就労証明書の月あたり就労時間は正確に記載してください。実態と異なる記載は入園取消しの対象です。</p>
  ...
  },
  {
    ...
    citySlug: "nisshin",
    title: "日進市で同点になったらどうなる？抽選ルールを解説",
    description:
      "日進市の保育園入園選考で同点だった場合の抽選と優先順位の判定方法を解説します。",
    image: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>日進市の同点時の判定方法</h2>
<p>日進市の入園選考で総合点数が同点になった場合、抽選により優先順位を決定します。</p>

<h2>優先番号による判定</h2>
<p>同点の場合は、市が決定した「優先番号」により判定されます。優先番号は公開抽選会で決定されるため、公平性が確保されています。</p>

<h3>優先番号とは</h3>
<ul>
<li>市が実施する公開抽選により決定される</li>
<li>同点者の中で優先順位が高い番号から入園承諾される</li>
<li>抽選会の日時はあらかじめ市から通知される</li>
</ul>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>日進市は公開抽選により透明性を確保しています。同点者の間では運の要素も関わってきます。</p>
</div>

<div class="warn-box">
<p><strong>注意</strong></p>
<p>優先番号の詳細については、「令和8年度 日進市保育所等利用案内」で必ず確認しましょう。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 45,
  },
  {
    ...
    citySlug: "nisshin",
    title: "日進市で時短勤務だと点数はどう変わる？",
    description:
      "日進市の保育園入園選考で時短勤務の場合の基本指数への影響を解説します。",
    image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>日進市は月の就労時間で判定</h2>
<p>日進市の基本指数は月の就労時間で決まります。時短勤務の影響を確認しましょう。</p>
...
<p>復職後のフルタイム勤務条件を就労証明書に記載してもらえるか、勤務先に確認しましょう。育休中でも復職後の勤務条件で点数が判定されます。</p>
  ...
  },
  {
    ...
    citySlug: "nisshin",
    title: "日進市でひとり親の場合　高加点と支援制度を解説",
    description:
      "日進市の保育園入園選考でひとり親世帯が受ける加点と、利用できる支援制度をまとめました。",
    image: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>ひとり親世帯の高加点</h2>
<p>日進市の入園選考で、ひとり親世帯（就労中または就労内定あり）は調整指数で<span class="highlight">+5点</span>の加点が得られます。これは他の加点項目の中でも最高額です。</p>

<h3>加点の対象</h3>
<ul>
<li>母子家庭で就労中または就労内定がある</li>
<li>父子家庭で就労中または就労内定がある</li>
</ul>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>日進市はひとり親世帯を優遇する基準になっています。ひとり親であることと就労条件を明確に記載しましょう。</p>
</div>

<h2>ひとり親が利用できる支援制度</h2>
<p>日進市ではひとり親世帯向けの様々な支援制度があります。保育園入園時の相談窓口で詳しく説明を受けられます。</p>
...
<div class="warn-box">
<p><strong>注意</strong></p>
<p>加点を受けるには、戸籍謄本や児童扶養手当受給証などの書類提出が必要な場合があります。事前に日進市に確認しましょう。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 48,
  },
  {
    ...
    citySlug: "nisshin",
    title: "日進市の育休明けのタイミング　入園点数への影響",
    description:
      "日進市の保育園入園選考で育休明けの復帰タイミングが点数に与える影響を解説します。",
    image: "https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>育休復帰予定で加点</h2>
<p>日進市の入園選考では、育休・産休から復帰する場合、調整指数で<span class="highlight">+2点</span>の加点が得られます。</p>

<h3>加点の条件</h3>
<ul>
<li>育児休業または産休中である</li>
<li>入園月中に職場復帰予定である</li>
<li>就労証明書などで証明できる</li>
</ul>

<h2>育休中の点数判定</h2>
<p>育児休業中の保護者の基本指数は、復職後の勤務条件で判定されます。フルタイム復帰予定であれば、育休中でも20点が認定されます。</p>
...
<p>入園月の前月までに復帰してしまうと、加点の対象にならない場合があります。申込時に必ず確認しましょう。</p>
  ...
  },
  {
    ...
    citySlug: "nisshin",
    title: "日進市の待機児童の現状　入園の難易度を解説",
    description:
      "日進市の認可保育園の待機児童数や競争率から、入園の難易度を分析します。",
    image: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>日進市の待機児童状況</h2>
<p>日進市の認可保育園の需要と供給のバランスを把握することが、保活戦略の第一歩です。</p>

<h3>保育園の競争率</h3>
<p>日進市内の保育園は地域によって競争率が異なります。駅前や商業施設近くの人気園は倍率が高い傾向にあります。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>前年度の入園決定の最低点数を確認することで、自分の点数で合格できそうな園を見つけることができます。</p>
</div>
...
<div class="warn-box">
<p><strong>注意</strong></p>
<p>待機児童数は毎年変動します。必ず最新の日進市公式情報で確認しましょう。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 42,
  },
  {
    ...
    citySlug: "nisshin",
    title: "日進市の申込書類チェックリスト　書き漏れを防ぐ",
    description:
      "日進市の保育園申込に必要な書類と、記入時の注意点をまとめたチェックリストです。",
...
<div class="warn-box">
<p><strong>注意</strong></p>
<p>書類に記載漏れがあると点数が認定されない場合があります。申込む前に日進市役所に確認することをお勧めします。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 50,
  },
  {
    ...
    citySlug: "nisshin",
    title: "日進市で認可外保育施設を利用する場合の加点",
    description:
      "日進市の保育園入園選考で認可外保育施設の利用が与える影響と加点制度を解説します。",
    image: "https://images.unsplash.com/photo-1503454537688-e47a8b0b5a20?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>認可外保育施設の利用で加点</h2>
<p>日進市の入園選考では、認可外保育施設に月ぎめで預けている場合、調整指数で<span class="highlight">+3点</span>の加点が得られます。</p>
