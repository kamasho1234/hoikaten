...
<p>最新の利用調整基準は<a href="https://www.city.fukushima.fukushima.jp/material/files/group/55/R8hoikujisshikizyun.pdf" target="_blank" rel="noopener">福島市「保育所保育実施基準（利用調整）の考え方」（PDF）</a>をご確認ください。育休延長の手続きについては<a href="https://www.mhlw.go.jp/stf/seisakunitsuite/bunya/0000160564_00040.html" target="_blank" rel="noopener">厚生労働省の公式ページ</a>もご参照ください。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "fukushima",
    title: "福島市の保育料はいくら？　上限額と決まり方",
    description:
      "福島市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>福島市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>福島市でいちばん高い階層はいくら？</h2>
<p>福島市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額67,000円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
...
<p>上記の金額は福島市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.fukushima.fukushima.jp/kosodate-kyoiku/hokenjo-yochien/2/13531.html" target="_blank" rel="noopener">福島市の保育料表</a>をご確認ください。</p>
</div>`,
