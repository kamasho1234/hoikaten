...
<p>仙台市の無償化の詳細は<a href="https://www.city.sendai.jp/nintechosa/kurashi/kenkotofukushi/kosodate/hoikujo/annai/hoikushisetsu.html" target="_blank" rel="noopener">仙台市公式サイト</a>をご確認ください。</p>
  ...
  // ===== 制度を知る =====
  {
    slug: "shokuhi-jippi",
    citySlug: "sendai",
    title: "仙台市の保育園の給食費（副食費）はいくら？【令和8年度版】免除条件と金額",
    description:
      "仙台市の保育園の給食費（副食費）は月いくら？所得・子ども数による副食費免除の条件と申請方法、保育料無償化の範囲と実費負担の全額をわかりやすく解説。令和8年度対応。",
    image:
      "https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800&h=400&fit=crop",
    category: "制度を知る",
    categoryColor: "rose",
...
<p>転園の手続きについては、お住まいの区の区役所保育給付課にお問い合わせください。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "sendai",
    title: "仙台市の保育料はいくら？　上限額と決まり方",
    description:
      "仙台市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>仙台市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>仙台市でいちばん高い階層はいくら？</h2>
<p>仙台市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額70,000円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>保育料は毎年9月に切り替わります。4月分から8月分は前年度の住民税額、9月分から翌年3月分は当年度の住民税額で決まる自治体が多いため、9月に金額が変わることがあります。</p>
</div>
<h2>きょうだいがいる世帯の軽減</h2>
<p>仙台市は次のように案内しています。</p>
<blockquote><p>第2子以降の保育料無償化について｜仙台市このサイトではJavaScriptを使用したコンテンツ・機能を提供しています。</p></blockquote>
<div class="info-box">
<p><strong>出典</strong></p>
<p>上記の金額は仙台市が公表している保育料表によります。階層ごとの正確な金額は<a href="http://www.city.sendai.jp/izumi-kodomokate/kurashi/kenkotofukushi/kosodate/hoikujo/hoikushisetsu/ichiran/documents/riyoushahutankettei.pdf" target="_blank" rel="noopener">仙台市の保育料表</a>をご確認ください。</p>
</div>`,
