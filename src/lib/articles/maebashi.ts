...
<h3>自営協力者・農業の場合</h3>
<p>前橋市では自営協力者・農業の場合、外勤と比べて<span class="highlight">1点ずつ低い</span>点数になります。自営協力者・農業では月150時間以上でも最大9点ですが、外勤では月150時間以上で最大10点です。</p>
...
<p>制度改正の詳細は<a href="https://www.mhlw.go.jp/stf/seisakunitsuite/bunya/0000160564_00040.html" target="_blank" rel="noopener">厚生労働省「育児休業給付金の支給対象期間延長手続き」</a>をご確認ください。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "maebashi",
    title: "前橋市の保育料はいくら？　上限額と決まり方",
    description:
      "前橋市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>前橋市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>前橋市でいちばん高い階層はいくら？</h2>
<p>前橋市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額46,800円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>保育料は毎年9月に切り替わります。4月分から8月分は前年度の住民税額、9月分から翌年3月分は当年度の住民税額で決まる自治体が多いため、9月に金額が変わることがあります。</p>
</div>
<h2>きょうだいがいる世帯の軽減</h2>
<p>前橋市は次のように案内しています。</p>
<blockquote><p>保育料の多子軽減制度について同一世帯で3人以上の子どもを扶養している場合には、第3子以後の保育料（延長保育及び一時預かり事業を除く）は無料となります。</p></blockquote>
<div class="info-box">
<p><strong>出典</strong></p>
<p>上記の金額は前橋市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.maebashi.gunma.jp/kosodate_kyoiku/5/2/11004.html" target="_blank" rel="noopener">前橋市の保育料表</a>をご確認ください。</p>
</div>`,
