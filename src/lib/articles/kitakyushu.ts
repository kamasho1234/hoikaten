...
<p>利用調整基準の詳細は<a href="https://www.city.kitakyushu.lg.jp/contents/12100069.html" target="_blank" rel="noopener">北九州市公式サイト「保育所等の利用のごあんない」</a>で確認できます。</p>
  ...
  // ===== 保活の実践 (11) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市の保育園見学ガイド　チェックポイントと質問リスト",
    description:
...
<p>北九州市の認可保育園は、各園に直接電話して見学日を予約します。6月〜9月が見学のベストシーズンです。園の日常を見られる平日の午前中（9:30〜11:00頃）がおすすめです。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>北九州市は7区（門司区・小倉北区・小倉南区・若松区・八幡東区・八幡西区・戸畑区）にまたがり、区によって園の数や特徴が異なります。通勤経路を考慮し、複数のエリアを見学するのがおすすめです。</p>
</div>
...
<p>保育施設の一覧は<a href="https://www.city.kitakyushu.lg.jp/ko-katei/12100035.html" target="_blank" rel="noopener">北九州市公式サイト</a>で確認できます。</p>
  ...
  // ===== 年齢別入園 (12) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市で0歳入園と1歳入園どちらが有利？",
    description:
      "北九州市で0歳4月入園と1歳4月入園の競争率の違い、それぞれのメリット・デメリットを比較します。",
    image:
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>北九州市では1歳児クラスの定員は0歳からの持ち上がり分を差し引いた残りが募集枠になります。人気園では1歳の募集が数名のみになることもあるため、0歳入園も選択肢に入れましょう。</p>
</div>
...
<p>各園の受入月齢は<a href="https://www.city.kitakyushu.lg.jp/ko-katei/12100035.html" target="_blank" rel="noopener">北九州市公式サイトの保育施設一覧</a>で確認できます。</p>
  ...
  // ===== ひとり親の保活 (13) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市のひとり親家庭の保活ガイド　加点と支援制度",
    description:
      "北九州市でひとり親家庭が保育園に入園する際の加点・保育料減免・利用できる支援制度をまとめました。",
    image:
      "https://images.unsplash.com/photo-1476703993599-0035a21b17a9?w=800&h=400&fit=crop",
    category: "世帯別ガイド",
    categoryColor: "rose",
    content: `<h2>ひとり親家庭の利用調整上の扱い</h2>
<p>北九州市では、ひとり親家庭は<span class="highlight">調整点数で加点</span>を受けられます。基本点数は片方の保護者分（最大220点）のみですが、調整点数が加算されるため、合計点は一定水準を確保できます。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>ひとり親でフルタイム就労の場合、基本点数220点＋調整点数で合計450点前後になるのが一般的です。具体的な点数は世帯の状況により異なりますので、区役所の子ども・家庭相談コーナーで確認しましょう。</p>
</div>
...
<p>児童扶養手当の金額は毎年度改定されます。最新額は<a href="https://www.city.kitakyushu.lg.jp/ko-katei/12200010.html" target="_blank" rel="noopener">北九州市公式サイト</a>でご確認ください。</p>
  ...
  // ===== 育休タイミング (14) =====
  {
    slug: "ikukyu-timing",
    citySlug: "kitakyushu",
    title: "北九州市で育休復帰のベストタイミングは？加点との関係",
    description:
      "北九州市で育休復帰のタイミングと入園選考の加点の関係を解説。入園月復帰と翌月復帰の点数差を比較します。",
    image:
      "https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=800&h=400&fit=crop",
    category: "育休・復職",
    categoryColor: "teal",
    content: `<h2>育休復帰時期と加点の関係</h2>
<p>北九州市では、育休からの復帰時期によって調整点数が変わります。</p>

<table>
<tr><th>復帰タイミング</th><th>調整点数</th></tr>
<tr><td>入園月に復帰</td><td><span class="highlight">+170点</span></td></tr>
<tr><td>入園翌月に復帰</td><td>+140点</td></tr>
<tr><td>復帰予定なし（求職中扱い）</td><td>加点なし</td></tr>
</table>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>入園月復帰と翌月復帰では<span class="highlight">30点</span>の差があります。激戦区ではこの差が合否を分けることもあります。勤務先と相談し、可能であれば入園月復帰を目指しましょう。</p>
</div>
...
<div class="info-box">
<p><strong>公式情報</strong></p>
<p>復帰に関する手続きの詳細は<a href="https://www.city.kitakyushu.lg.jp/contents/12100069.html" target="_blank" rel="noopener">北九州市「保育所等の利用のごあんない」</a>をご確認ください。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 68,
  },
  // ===== 認可外保育施設の選び方 (15) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市の認可外保育施設の選び方と注意点",
    description:
      "北九州市の認可外保育施設（認可外保育園・企業主導型保育所など）の種類・選び方・認可園との違いを解説します。",
    image:
      "https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=800&h=400&fit=crop",
    category: "施設の種類",
    categoryColor: "amber",
    content: `<h2>北九州市の認可外保育施設の種類</h2>
<table>
<tr><th>種類</th><th>特徴</th></tr>
<tr><td>認可外保育園</td><td>都道府県に届出。独自の保育方針で運営</td></tr>
...
<ul>
<li>福岡県の「認可外保育施設指導監督基準」を満たしているか</li>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>認可外保育施設に通わせている実績は、翌年度の認可園申込時に調整点数の加点対象になる場合があります。認可園の「滑り止め」としても検討しましょう。</p>
</div>
...
<p>北九州市内の認可外保育施設の一覧・指導監督結果は<a href="https://www.city.kitakyushu.lg.jp/ko-katei/12100035.html" target="_blank" rel="noopener">北九州市公式サイト</a>で公開されています。</p>
  ...
  // ===== 双子の保活 (16) =====
  {
    slug: "futago-hokatsu",
    citySlug: "kitakyushu",
    title: "北九州市で双子・多胎児の保活を成功させるコツ",
    description:
      "北九州市で双子（多胎児）の保育園入園を目指す際の加点制度・同園希望の扱い・実践的なアドバイスをまとめました。",
    image:
      "https://images.unsplash.com/photo-1609220136736-443140cffec6?w=800&h=400&fit=crop",
    category: "世帯別ガイド",
    categoryColor: "rose",
    content: `<h2>双子の保活で知っておくべきこと</h2>
<p>双子を同じ保育園に入れたい場合、2人分の空き枠が必要になるため、単体よりハードルが上がります。北九州市では多胎児への配慮がありますが、確実に同園になるとは限りません。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>希望園の記入順が重要です。双子を確実に同じ園に入れたい場合、定員に余裕のある園を第1希望にすることも戦略の一つです。区役所の窓口で相談すると、空き状況を踏まえたアドバイスがもらえます。</p>
</div>
...
<div class="warn-box">
<p><strong>注意</strong></p>
<p>保育料の多子軽減の算定方法は年度により変更になる場合があります。最新情報は区役所の子ども・家庭相談コーナーでご確認ください。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 50,
  },
  // ===== 保活体験談 (17) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市の保活体験談　先輩ママが語るリアルな保活事情",
    description:
      "北九州市で保活を経験した先輩ママの体験談をもとに、実際の保活の流れ・苦労・成功のコツを紹介します。",
    image:
      "https://images.unsplash.com/photo-1531983412531-1f49a365ffed?w=800&h=400&fit=crop",
    category: "保活の実践",
    categoryColor: "green",
    content: `<h2>体験談1：小倉北区で1歳入園を目指したAさん</h2>
<p>「小倉北区の人気園を第1希望にしていましたが、1歳クラスは募集3名に対して申込が10名以上。フルタイム共働き＋育休復帰加点の610点でしたが、第1希望は不承諾でした。第3希望の園に内定し、結果的にはとても良い園でした。」</p>
...
<h2>体験談2：八幡西区で0歳入園を選んだBさん</h2>
<p>「1歳入園は激戦と聞いて、0歳4月入園を選びました。生後6か月での入園は不安でしたが、保育士さんが丁寧に対応してくれて、子どもも楽しそうに通っています。」</p>
...
<li>認可外も並行して検討する</li>
  ...
  // ===== 待機児童データ (18) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市の待機児童数の推移と最新データ",
    description:
      "北九州市の待機児童数の推移・隠れ待機児童の実態・区別の傾向を公式データをもとに解説します。",
    image:
      "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=400&fit=crop",
    category: "データで見る保活",
    categoryColor: "blue",
    content: `<h2>北九州市の待機児童数の推移</h2>
<p>北九州市は国の定義による待機児童数を毎年4月1日時点で公表しています。近年は待機児童ゼロを達成する年もありますが、「隠れ待機児童（特定の園のみ希望等で待機児童にカウントされない児童）」は一定数います。</p>

<div class="warn-box">
<p><strong>注意</strong></p>
<p>待機児童数は毎年度の公式発表で変動します。以下は傾向を示すものであり、最新の正確な数値は北九州市の公式発表をご確認ください。</p>
</div>

<h2>区別の傾向</h2>
<p>北九州市7区のうち、<span class="highlight">小倉北区・小倉南区・八幡西区</span>は人口が多く、保育需要も高い傾向があります。一方、門司区や若松区は比較的入りやすい傾向です。</p>
...
<p>最新の待機児童数は<a href="https://www.city.kitakyushu.lg.jp/ko-katei/12100035.html" target="_blank" rel="noopener">北九州市公式サイト</a>で確認できます。</p>
  ...
  // ===== 小規模保育 (19) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市の小規模保育事業所ガイド　0〜2歳児の選択肢",
    description:
...
<p>定員6〜19名の少人数で、0歳〜2歳児を対象とした認可保育施設です。北九州市内にも多数設置されています。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>小規模保育事業所の卒園児は、3歳児の認可園申込時に調整点数が加算される場合があります。「小規模→認可園」のルートも有力な保活戦略です。</p>
</div>
...
<p>小規模保育事業所の一覧・連携施設は<a href="https://www.city.kitakyushu.lg.jp/ko-katei/12100035.html" target="_blank" rel="noopener">北九州市公式サイト</a>で確認できます。</p>
  ...
  // ===== 第2子の保活 (20) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市で第2子の保活　きょうだい加点を最大限活かす方法",
    description:
      "北九州市で第2子の保育園入園を有利に進めるための、きょうだい加点の仕組みと戦略を解説します。",
    image:
      "https://images.unsplash.com/photo-1476703993599-0035a21b17a9?w=800&h=400&fit=crop",
    category: "世帯別ガイド",
    categoryColor: "rose",
    content: `<h2>きょうだい加点の仕組み</h2>
<p>北九州市では、きょうだいが既に認可保育園に在園している場合、<span class="highlight">+170点</span>の調整点数が加算されます。これは非常に大きな加点で、入園に大きく有利に働きます。</p>

<h2>きょうだい同園を目指す場合</h2>
<p>上の子と同じ園を第1希望にすると、きょうだい加点に加えて同園希望の配慮も受けられます。フルタイム共働き＋育休復帰＋きょうだい加点で<span class="highlight">780点</span>に達し、ほぼ確実に入園できるラインです。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>きょうだい加点は「申込時点で在園していること」が条件です。上の子が卒園するタイミングと下の子の入園タイミングに注意しましょう。</p>
</div>
...
<div class="info-box">
<p><strong>公式情報</strong></p>
<p>きょうだい加点の詳細は<a href="https://www.city.kitakyushu.lg.jp/contents/12100069.html" target="_blank" rel="noopener">北九州市「保育所等の利用のごあんない」</a>をご確認ください。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 73,
  },
  // ===== 自営業の点数 (21) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市で自営業・フリーランスの保活　点数と必要書類",
    description:
      "北九州市で自営業・フリーランスが保育園を申し込む際の点数計算・必要書類・注意点を解説します。",
    image:
      "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>自営業・フリーランスの基本点数</h2>
<p>北九州市では、自営業・フリーランスも会社員と同じ基準で点数が計算されます。月120時間以上の就労であれば<span class="highlight">220点（満点）</span>です。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>開業して間もない場合は確定申告書がないこともあります。その場合は開業届と業務契約書・受注実績等で代替できるか、区役所の窓口で事前に確認しましょう。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 56,
  },
  // ===== 内職の点数 (22) =====
  {
    slug: "naishoku-score",
    citySlug: "kitakyushu",
    title: "北九州市で内職・在宅ワークの場合の保育園点数は？",
    description:
      "北九州市で内職や在宅ワークをしている場合の保育園入園の点数・必要書類・注意点を解説します。",
    image:
      "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>在宅ワーク・内職の点数</h2>
<p>北九州市では、在宅ワーク・内職も「居宅外就労」か「居宅内就労」かで区分されます。居宅内就労（自宅での仕事）の場合でも、月120時間以上であれば満点の220点が付きます。</p>

<h2>居宅外就労と居宅内就労の違い</h2>
<table>
<tr><th>区分</th><th>例</th><th>基本点数（月120h以上）</th></tr>
<tr><td>居宅外就労</td><td>会社勤め・パート</td><td>220点</td></tr>
<tr><td>居宅内就労</td><td>在宅ワーク・内職・自宅開業</td><td>220点</td></tr>
</table>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>北九州市は居宅内・居宅外で点数差をつけていません。ただし、就労時間の証明方法が異なるため、必要書類を事前に確認しましょう。</p>
</div>
...
<div class="warn-box">
<p><strong>注意</strong></p>
<p>内職で就労時間が月120時間に満たない場合は、基本点数が130点に下がります。就労時間の計算方法は区役所でご確認ください。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 48,
  },
  // ===== 求職中の保活 (23) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市で求職中でも保育園に入れる？点数と対策",
    description:
      "北九州市で求職中（これから働く予定）の場合の保育園申込の点数・入園後の就労開始期限を解説します。",
    image:
      "https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>求職中の基本点数</h2>
<p>北九州市では、求職中（求職活動中）の場合も保育園の申込が可能です。ただし、基本点数は就労中と比べて<span class="highlight">大幅に低く</span>なります。</p>

<div class="warn-box">
<p><strong>注意</strong></p>
<p>求職中の基本点数は就労中（220点）と比べて低く設定されています。具体的な点数は年度によって変わる場合があるため、最新の「保育所等の利用のごあんない」で確認してください。</p>
</div>
...
<p>まずは短時間のパートでも就労実績を作り、「就労中」として申し込むほうが点数上は有利です。</p>
  ...
  // ===== 転職タイミング (24) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市で保活中に転職しても大丈夫？点数への影響",
    description:
      "北九州市で保育園の申込前後に転職した場合の点数への影響・必要な手続き・注意点を解説します。",
    image:
      "https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=800&h=400&fit=crop",
    category: "育休・復職",
    categoryColor: "teal",
    content: `<h2>転職と点数の関係</h2>
<p>転職しても就労時間が変わらなければ、基本点数に影響はありません。月120時間以上の就労であれば220点（満点）です。</p>

<h2>転職時に必要な手続き</h2>
<table>
<tr><th>タイミング</th><th>必要な対応</th></tr>
<tr><td>申込前に転職</td><td>新しい勤務先の就労証明書を提出</td></tr>
<tr><td>申込後〜内定前に転職</td><td>速やかに新しい就労証明書を区役所に提出</td></tr>
<tr><td>内定後〜入園後に転職</td><td>変更届と新しい就労証明書を提出</td></tr>
</table>

<div class="warn-box">
<p><strong>注意</strong></p>
<p>転職により一時的に無職期間が生じると、その期間は「求職中」扱いになり、基本点数が下がります。保活中の転職は、退職と入社のタイミングを慎重に調整しましょう。</p>
</div>
...
<p>育休中に転職する場合、「育休復帰加点」が適用されなくなる可能性があります。転職を検討している場合は、入園が決まってからのほうが安全です。</p>
  ...
  // ===== 2歳入園 (25) =====
  {
    slug: "age2-nyuen",
    citySlug: "kitakyushu",
    title: "北九州市で2歳児クラスに入園するには？空き状況と対策",
    description:
      "北九州市の2歳児クラスの入園事情・空き状況の傾向・小規模保育からの転園について解説します。",
    image:
      "https://images.unsplash.com/photo-1555252333-9f8e92e65df9?w=800&h=400&fit=crop",
    category: "年齢別入園",
    categoryColor: "purple",
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>年度途中の入園も選択肢に入れましょう。4月以外にも空きが出ることがあり、毎月の空き状況は区役所で確認できます。</p>
</div>

<h2>小規模保育からの転園</h2>
<p>小規模保育事業所（0〜2歳）を卒園した子どもは、3歳児の認可園申込で加点がつく場合があります。「2歳まで小規模→3歳で認可園」は有力なルートです。</p>

<div class="info-box">
<p><strong>公式情報</strong></p>
<p>空き状況は<a href="https://www.city.kitakyushu.lg.jp/contents/12100143.html" target="_blank" rel="noopener">北九州市公式サイト</a>で確認できます。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 53,
  },
  // ===== 3歳以降の移行 (26) =====
  {
    slug: "age3-ikou",
    citySlug: "kitakyushu",
    title: "北九州市で3歳からの保育園・幼稚園　移行のポイント",
    description:
      "北九州市で3歳以降の保育園継続・幼稚園への転園・認定こども園への移行について解説します。",
    image:
      "https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=800&h=400&fit=crop",
    category: "年齢別入園",
    categoryColor: "purple",
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>北九州市では、幼稚園の預かり保育も充実しつつあります。保育園にこだわらず、認定こども園や預かり保育付き幼稚園も選択肢に入れると視野が広がります。</p>
</div>
...
<p>無償化の詳細は<a href="https://www.city.kitakyushu.lg.jp/ko-katei/12100035.html" target="_blank" rel="noopener">北九州市公式サイト</a>で確認できます。</p>
  ...
  // ===== 0歳児入園の詳細 (27) =====
  {
    slug: "nyuyoji-age0",
    citySlug: "kitakyushu",
    title: "北九州市の0歳児入園ガイド　受入月齢と園選びのコツ",
    description:
      "北九州市で0歳児クラスに入園する際の受入月齢・必要な準備・園選びのポイントを解説します。",
    image:
      "https://images.unsplash.com/photo-1555252333-9f8e92e65df9?w=800&h=400&fit=crop",
    category: "年齢別入園",
    categoryColor: "purple",
    content: `<h2>0歳児の受入月齢</h2>
<p>北九州市の認可保育園では、園によって受入開始月齢が異なります。産休明け（生後57日）から受け入れる園もあれば、生後6か月からの園もあります。</p>
...
<p>各園の受入月齢は<a href="https://www.city.kitakyushu.lg.jp/ko-katei/12100035.html" target="_blank" rel="noopener">北九州市公式サイトの保育施設一覧</a>で確認できます。</p>
  ...
  // ===== 認定こども園 (28) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市の認定こども園ガイド　保育園との違いと選び方",
    description:
      "北九州市の認定こども園の種類・保育園との違い・入園手続き・メリット・デメリットを解説します。",
    image:
      "https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=800&h=400&fit=crop",
    category: "施設の種類",
    categoryColor: "amber",
...
<tr><td>申込先</td><td>区役所（2号・3号）</td><td>区役所</td></tr>
</table>
...
<h2>北九州市の認定こども園の数</h2>
<p>北九州市には複数の認定こども園があり、幼保連携型・幼稚園型などの類型があります。それぞれ特色が異なるため、見学して比較するのがおすすめです。</p>
...
<p>認定こども園の一覧は<a href="https://www.city.kitakyushu.lg.jp/ko-katei/12100035.html" target="_blank" rel="noopener">北九州市公式サイト</a>で確認できます。</p>
  ...
  // ===== 企業主導型保育 (29) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市の企業主導型保育所とは？利用方法とメリット",
    description:
...
<p>企業主導型保育所の検索は<a href="https://www.kigyounaihoiku.jp/" target="_blank" rel="noopener">企業主導型保育事業ポータル</a>で可能です。</p>
  ...
  // ===== 夜間保育 (30) =====
  {
    slug: "yakan-hoiku",
    citySlug: "kitakyushu",
    title: "北九州市の夜間保育・延長保育ガイド",
    description:
      "北九州市で夜間勤務やシフト勤務の方が利用できる夜間保育・延長保育の選択肢と利用方法を解説します。",
    image:
      "https://images.unsplash.com/photo-1484820540004-14229fe36ca4?w=800&h=400&fit=crop",
    category: "施設の種類",
    categoryColor: "amber",
    content: `<h2>延長保育について</h2>
<p>北九州市の認可保育園では、通常の保育時間（7:00〜18:00等）に加えて、延長保育を実施している園があります。延長保育は最長19:00〜20:00頃までの園が多いです。</p>

<h2>夜間保育について</h2>
<p>夜間専門の認可保育園は全国的に数が少なく、北九州市でも限られています。夜間勤務の方は、以下の選択肢を検討しましょう。</p>
...
<p>延長保育の実施園は<a href="https://www.city.kitakyushu.lg.jp/ko-katei/12100035.html" target="_blank" rel="noopener">北九州市公式サイト</a>で確認できます。</p>
  ...
  // ===== 無償化制度 (31) =====
  {
    slug: "mushoka-seido",
    citySlug: "kitakyushu",
    title: "北九州市の幼児教育・保育無償化　対象と自己負担額",
    description:
      "北九州市の幼児教育・保育無償化制度の対象施設・対象年齢・自己負担として残る費用を整理しました。",
    image:
      "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=800&h=400&fit=crop",
    category: "お金・制度",
    categoryColor: "teal",
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>年収360万円未満相当の世帯や第3子以降は、副食費も免除される場合があります。詳細は区役所でご確認ください。</p>
</div>
...
<p>無償化の詳細は<a href="https://www.city.kitakyushu.lg.jp/ko-katei/12100035.html" target="_blank" rel="noopener">北九州市公式サイト</a>で確認できます。</p>
  ...
  // ===== 食費の実費負担 (32) =====
  {
    slug: "shokuhi-jippi",
    citySlug: "kitakyushu",
    title: "北九州市の保育園の給食費（副食費）はいくら？免除条件も解説",
    description:
      "北九州市の保育園の給食費（副食費）の目安金額・免除対象者・支払い方法を解説します。",
    image:
      "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=400&fit=crop",
    category: "お金・制度",
    categoryColor: "teal",
...
<h2>副食費の目安</h2>
<p>北九州市の認可保育園の副食費は、<span class="highlight">月額4,500円前後</span>が一般的です。園によって多少異なります。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>副食費の免除は自動適用される場合と申請が必要な場合があります。該当する可能性がある方は、入園時に区役所で確認しましょう。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 48,
  },
  // ===== 保育料の計算 (33) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市の保育料の計算方法　0〜2歳児の保育料はいくら？",
    description:
      "北九州市の0〜2歳児の保育料の計算方法・所得階層別の目安金額・多子軽減制度を解説します。",
    image:
      "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=400&fit=crop",
    category: "お金・制度",
    categoryColor: "teal",
    content: `<h2>保育料の決まり方</h2>
<p>北九州市の保育料は、<span class="highlight">世帯の市民税所得割額</span>に基づいて決まります。毎年9月に前年度の税額から当年度の税額に切り替わります。</p>

<h2>保育料の目安</h2>
<p>北九州市は国の基準額よりも独自に軽減を行っています。世帯年収によって大きく異なりますが、0〜2歳児の場合は月額0円〜約5万円の範囲です。</p>
...
<p>多子軽減の算定対象は、小学校就学前の子どもをカウントする方法が基本です。ただし年収360万円未満相当の世帯は年齢制限なく上の子をカウントできます。</p>
  ...
  // ===== 税金控除 (34) =====
  {
    slug: "zeikin-koujo",
    citySlug: "kitakyushu",
    title: "保育料と税金の関係　北九州市で使える控除・助成制度",
    description:
      "北九州市で保育園を利用する世帯が活用できる税金控除・助成制度をまとめました。",
    image:
      "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=800&h=400&fit=crop",
    category: "お金・制度",
    categoryColor: "teal",
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>保育料を下げたい場合はiDeCoや医療費控除など「所得控除」に該当する制度が有効です。税理士や区役所の窓口で相談するのがおすすめです。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 52,
  },
  // ===== 就労証明書 (35) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市の就労証明書｜様式ダウンロード先と記入例【令和8年度】",
    description:
      "北九州市の保育園申込みに使う就労証明書について、公式の様式ダウンロード先へのリンクと、点数の付き方・記入例・よくある不備をまとめています。会社に依頼する前に確認してください。",
    image:
      "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=800&h=400&fit=crop",
    category: "書類・手続き",
    categoryColor: "green",
...
<p>就労証明書の様式・記入例は<a href="https://www.city.kitakyushu.lg.jp/contents/12100069.html" target="_blank" rel="noopener">北九州市公式サイト</a>からダウンロードできます。この記事では、その様式をどう書くと点数にどう響くかを説明します。</p>
</div>
<h2>就労証明書とは</h2>
...
<tr><td>就労時間</td><td>月の就労時間を正確に。120時間以上かどうかで基本点数が変わる</td></tr>
...
<li>就労時間の記載が曖昧（「約○時間」ではなく具体的に）</li>
  ...
  // ===== 申請書類一覧 (36) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市の保育園申込に必要な書類一覧　チェックリスト付き",
    description:
      "北九州市の認可保育園申込に必要な書類を一覧にまとめました。チェックリストとして活用してください。",
    image:
      "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=800&h=400&fit=crop",
    category: "書類・手続き",
    categoryColor: "green",
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>書類に不備があると受付できない場合があります。提出前に区役所の子ども・家庭相談コーナーで事前チェックを受けるのがおすすめです。</p>
</div>

<div class="info-box">
<p><strong>公式情報</strong></p>
<p>申請書類の様式は<a href="https://www.city.kitakyushu.lg.jp/contents/12100069.html" target="_blank" rel="noopener">北九州市公式サイト</a>からダウンロードできます。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 68,
  },
  // ===== 2次申請の流れ (37) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市の2次利用調整（2次募集）の流れと対策",
    description:
      "北九州市の2次利用調整のスケジュール・申込方法・1次で不承諾になった場合の対策を解説します。",
    image:
      "https://images.unsplash.com/photo-1484820540004-14229fe36ca4?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>2次利用調整とは</h2>
<p>1次利用調整で定員に達しなかった園の空き枠について行われる選考です。1次で不承諾になった方は自動的に2次の対象になります。</p>

<h2>2次利用調整のスケジュール（目安）</h2>
<table>
<tr><th>項目</th><th>日程</th></tr>
<tr><td>受入可能児童数の公開</td><td>3月上旬</td></tr>
<tr><td>申込受付</td><td>3月上旬</td></tr>
<tr><td>結果通知</td><td>3月下旬</td></tr>
</table>

<h2>2次で入園するためのポイント</h2>
<ul>
<li>受入可能児童数が公開されたら、空きのある園を確認</li>
<li>希望園の変更が可能な場合は、空きのある園に変更を検討</li>
<li>区役所に連絡して最新の空き状況を確認する</li>
</ul>
...
<p>2次でも不承諾だった場合は、認可外保育施設やファミリー・サポート・センターの利用、育休延長を検討しましょう。</p>
  ...
  // ===== 転居と保活 (38) =====
  {
    slug: "tenkyo-hokatsu",
    citySlug: "kitakyushu",
    title: "北九州市への転入・市内転居時の保育園手続きガイド",
    description:
      "北九州市に転入する場合や市内で転居する場合の保育園の申込方法・転園手続き・注意点を解説します。",
    image:
      "https://images.unsplash.com/photo-1484820540004-14229fe36ca4?w=800&h=400&fit=crop",
    category: "書類・手続き",
    categoryColor: "green",
    content: `<h2>他市から北九州市に転入する場合</h2>
<p>転入前でも北九州市の保育園に申込が可能です。転入先の区の区役所に相談しましょう。</p>
...
<p>既に認可保育園に通っている場合、転居先が通園可能な範囲であれば、そのまま通い続けることもできます。転園を希望する場合は、転居先の区役所で転園申込を行います。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>転入時期によっては、4月入園の1次申込に間に合わない場合があります。転入予定がわかった段階で、早めに転入先の区役所に連絡するのが重要です。</p>
</div>

<div class="warn-box">
<p><strong>注意</strong></p>
<p>転園の場合、転園先の園に空きがないと転園できません。空き状況は区役所で確認しましょう。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 50,
  },
  // ===== 教育と保育の違い (39) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "保育園と幼稚園の違いは？北九州市での選び方",
    description:
      "北九州市における保育園と幼稚園の違い・それぞれのメリット・認定こども園という第3の選択肢を解説します。",
    image:
      "https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=800&h=400&fit=crop",
    category: "施設の種類",
    categoryColor: "amber",
...
<h2>共働き世帯はどちらを選ぶ？</h2>
<p>フルタイム共働きの場合は保育園が一般的ですが、北九州市では預かり保育（17:00〜18:00頃まで）を実施する幼稚園も増えています。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>「教育も保育も両方ほしい」という方には認定こども園がおすすめです。北九州市内にも複数あり、保育園と同じ利用調整で入園できます（2号・3号認定）。</p>
</div>
...
<p>保育の必要性の認定を受ければ、幼稚園の預かり保育も月額11,300円まで無償化の対象になります。</p>`,
  ...
  // ===== 保活カレンダー (40) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市の保活カレンダー　月別やることリスト",
    description:
      "北九州市で令和8年度4月入園を目指す方向けの、月別保活カレンダー・やることリストです。",
    image:
      "https://images.unsplash.com/photo-1484820540004-14229fe36ca4?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
...
<tr><td>4月〜5月</td><td>情報収集開始。北九州市の保育施設の種類やエリアの特徴を調べる</td></tr>
<tr><td>6月〜8月</td><td>保育園見学。5園以上は見学しておくと安心</td></tr>
<tr><td>9月</td><td>「保育所等の利用（入所）のごあんない」を入手。書類準備開始</td></tr>
<tr><td>10月</td><td>就労証明書を勤務先に依頼。申込書類を記入</td></tr>
<tr><td>10月〜11月</td><td>1次利用調整の申込書類を区役所に提出</td></tr>
<tr><td>12月〜1月</td><td>結果を待つ。認可外の見学・申込も並行</td></tr>
<tr><td>2月</td><td>1次結果通知。内定の場合は入園準備。不承諾の場合は2次へ</td></tr>
<tr><td>3月</td><td>2次利用調整。入園準備（持ち物の購入・慣らし保育の調整）</td></tr>
</table>
...
<div class="info-box">
<p><strong>公式情報</strong></p>
<p>申込スケジュールの詳細は<a href="https://www.city.kitakyushu.lg.jp/contents/12100069.html" target="_blank" rel="noopener">北九州市「保育所等の利用のごあんない」</a>をご確認ください。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 72,
  },
  // ===== 点数の相場感 (41) =====
  {
    slug: "souba-tensuu",
    citySlug: "kitakyushu",
    title: "北九州市の保育園入園に必要な点数の相場感",
    description:
      "北九州市の保育園入園選考で実際にどのくらいの点数があれば安心なのか、世帯パターン別に解説します。",
    image:
      "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>点数の目安</h2>
<table>
<tr><th>点数帯</th><th>入園の可能性</th></tr>
<tr><td>780点〜（きょうだい加点あり）</td><td>ほぼ確実に入園可能</td></tr>
<tr><td>610点（フルタイム＋育休復帰）</td><td>多くの園で入園可能。激戦区はギリギリ</td></tr>
<tr><td>580点（フルタイム＋翌月復帰）</td><td>園を選べば入園可能</td></tr>
<tr><td>440点（フルタイム加点なし）</td><td>人気園は厳しい。郊外の園を検討</td></tr>
<tr><td>350点以下</td><td>認可園は厳しい。認可外も検討</td></tr>
</table>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>北九州市の点数スケールは他市と異なり、最大440点＋調整点数という高得点型です。単純に他市の点数と比較できないので注意してください。</p>
</div>

<h2>同点の場合の優先順位</h2>
<p>同点の場合は、北九州市独自の優先基準（所得が低い世帯を優先など）で順位が決まります。610点同士の勝負になった場合、この優先基準が合否を分けます。</p>

<div class="info-box">
<p><strong>公式情報</strong></p>
<p>利用調整基準の詳細は<a href="https://www.city.kitakyushu.lg.jp/contents/12100069.html" target="_blank" rel="noopener">北九州市「保育所等の利用のごあんない」</a>をご確認ください。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 78,
  },
  // ===== 区別の倍率 (42) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市の区別・保育園入園の難易度と傾向",
    description:
      "北九州市7区（門司・小倉北・小倉南・若松・八幡東・八幡西・戸畑）の保育園入園の難易度傾向を解説します。",
    image:
      "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=400&fit=crop",
    category: "データで見る保活",
    categoryColor: "blue",
    content: `<h2>北九州市7区の傾向</h2>
<table>
<tr><th>区</th><th>入園難易度（目安）</th><th>特徴</th></tr>
<tr><td>小倉北区</td><td>高い</td><td>市中心部。商業・オフィス街に近く需要が高い</td></tr>
<tr><td>小倉南区</td><td>やや高い</td><td>住宅地が多く子育て世帯が多い</td></tr>
<tr><td>八幡西区</td><td>やや高い</td><td>人口が多く、保育需要も高い</td></tr>
<tr><td>戸畑区</td><td>普通</td><td>面積は小さいが園の数は一定数ある</td></tr>
<tr><td>八幡東区</td><td>やや低い</td><td>人口減少傾向で比較的入りやすい</td></tr>
<tr><td>若松区</td><td>低い</td><td>北九州市の中では比較的入りやすい</td></tr>
<tr><td>門司区</td><td>低い</td><td>市の東端。園に空きがある傾向</td></tr>
</table>

<div class="warn-box">
<p><strong>注意</strong></p>
<p>上記は一般的な傾向です。同じ区内でも園によって大きく異なります。また年度や年齢クラスによっても変動します。最新の空き状況は区役所で確認してください。</p>
</div>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>通勤経路上の別の区の園も選択肢に入れると、選べる園の幅が広がります。特に小倉北区勤務で自宅が小倉南区の場合、通勤途中の園も候補になります。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 75,
  },
  // ===== 育休延長リスク (43) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市で育休延長する場合のリスクと注意点",
    description:
      "北九州市で保育園に入れず育休を延長する場合のリスク・手続き・翌年度の保活への影響を解説します。",
    image:
      "https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=800&h=400&fit=crop",
    category: "育休・復職",
    categoryColor: "teal",
...
<h2>延長に必要な書類</h2>
<p>勤務先に「保育所等利用不承諾通知書」を提出する必要があります。この通知書は、入園申込をして不承諾になった場合に北九州市から発行されます。</p>

<h2>育休延長のリスク</h2>
<ul>
<li>翌年度は1歳児（または2歳児）クラスに申込→募集枠が少ない</li>
<li>育休延長期間が終了（2歳）しても入園できない場合、退職リスクがある</li>
<li>育児休業給付金が減額（180日以降は50%→67%→50%）</li>
</ul>
...
<p>育休延長を見据える場合でも、0歳の4月入園を申し込んでおくことを強くおすすめします。不承諾通知書をもらうためにも申込が必要です。</p>
  ...
  // ===== 復職準備 (44) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市で保育園内定後の復職準備チェックリスト",
    description:
      "北九州市で保育園の内定が出た後にやるべきこと・復職準備のチェックリスト・慣らし保育の目安をまとめました。",
    image:
      "https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=800&h=400&fit=crop",
    category: "育休・復職",
    categoryColor: "teal",
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>北九州市には病児・病後児保育を実施する施設があります。子どもの急な発熱時に備えて、事前に登録しておきましょう。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 60,
  },
  // ===== 3人目の保活 (45) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市で3人目の保活　保育料無料と加点のメリット",
    description:
      "北九州市で第3子の保育園入園を目指す場合の加点・保育料無料制度・きょうだい在園の活用法を解説します。",
    image:
      "https://images.unsplash.com/photo-1476703993599-0035a21b17a9?w=800&h=400&fit=crop",
    category: "世帯別ガイド",
    categoryColor: "rose",
    content: `<h2>第3子の保育料</h2>
<p>北九州市では、小学校就学前の子どもが3人以上いる世帯の第3子以降は、保育料が<span class="highlight">無料</span>です。さらに副食費も免除される場合があります。</p>

<h2>第3子の入園選考での優位性</h2>
<ul>
<li>きょうだいが在園していれば<span class="highlight">+170点</span>の加点</li>
<li>フルタイム共働き＋育休復帰＋きょうだい加点で780点に到達可能</li>
<li>780点あればほぼ確実に希望園に入園可能</li>
</ul>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>第3子は経済的にも選考上も非常に有利です。上の子と同じ園を第1希望にすれば、ほぼ確実に入園できるでしょう。</p>
</div>
...
<p>上の子が卒園して小学校に入ると、多子カウントの対象外になる場合があります（年収360万円未満相当の世帯を除く）。きょうだいの年齢差に注意しましょう。</p>`,
  ...
  // ===== 単身赴任 (46) =====
  {
    slug: "tanshin-funin",
    citySlug: "kitakyushu",
    title: "北九州市で単身赴任中の保活　点数と必要書類",
    description:
      "配偶者が単身赴任中の場合の北九州市の保育園点数・世帯の扱い・必要書類を解説します。",
    image:
      "https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=800&h=400&fit=crop",
    category: "世帯別ガイド",
    categoryColor: "rose",
    content: `<h2>単身赴任中の点数計算</h2>
<p>配偶者が単身赴任中でも、婚姻関係にある場合は<span class="highlight">父母両方の点数が合算</span>されます。ひとり親扱いにはなりません。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>単身赴任で日中ワンオペ育児になることは、保育の必要性を示す重要な事情です。申込書の備考欄や別紙で状況を説明しましょう。</p>
</div>

<div class="warn-box">
<p><strong>注意</strong></p>
<p>単身赴任の扱いは自治体によって異なります。北九州市での具体的な取り扱いは、区役所の子ども・家庭相談コーナーで事前に確認してください。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 40,
  },
  // ===== 祖父母同居 (47) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市で祖父母同居の場合の保育園入園への影響",
    description:
      "北九州市で祖父母と同居している場合の保育園入園選考への影響・点数への影響・対策を解説します。",
    image:
      "https://images.unsplash.com/photo-1476703993599-0035a21b17a9?w=800&h=400&fit=crop",
    category: "世帯別ガイド",
    categoryColor: "rose",
    content: `<h2>祖父母同居は不利になる？</h2>
<p>北九州市では、同居の祖父母がいる場合、<span class="highlight">祖父母が保育できる状態かどうか</span>が確認されることがあります。ただし、祖父母が就労中・高齢・介護が必要などの場合は、保育の必要性は変わりません。</p>
...
<div class="warn-box">
<p><strong>注意</strong></p>
<p>近隣に住む祖父母（同居ではない）は選考に影響しません。住民票上の「世帯」が同一かどうかがポイントです。具体的な扱いは区役所でご確認ください。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 52,
  },
  // ===== 不承諾への対応 (48) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市で保育園不承諾になったら？次にやるべきこと",
    description:
      "北九州市の保育園選考で不承諾になった場合の対処法・2次申込・認可外の選び方を解説します。",
    image:
      "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=400&fit=crop",
    category: "保活の実践",
    categoryColor: "green",
...
<h3>すぐにやること</h3>
<ol>
<li><strong>2次利用調整に備える</strong>：1次で不承諾の場合、自動的に2次の対象になります</li>
<li><strong>区役所に相談</strong>：空きのある園の情報を確認</li>
...
<p>不承諾通知書は育休延長の手続きに必要です。大切に保管してください。</p>
  ...
  // ===== 待機児童対策 (49) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市の待機児童対策　市の取り組みと今後の見通し",
    description:
      "北九州市が実施している待機児童対策・保育施設の整備計画・今後の見通しをまとめました。",
    image:
      "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=400&fit=crop",
    category: "データで見る保活",
    categoryColor: "blue",
    content: `<h2>北九州市の取り組み</h2>
<p>北九州市は子ども家庭局を中心に、以下の待機児童対策を進めています。</p>
...
<h2>北九州市の特徴</h2>
<p>北九州市は人口約93万人の政令指定都市ですが、人口減少傾向にあります。そのため、地域によっては保育需要が減少し、空き枠が生じている園もあります。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>市全体では待機児童は少ないものの、小倉北区や小倉南区などの人気エリアでは依然として入園が難しい園があります。「北九州市なら簡単に入れる」とは限りませんので、早めの準備を心がけましょう。</p>
</div>
...
<p>北九州市の子育て支援施策の詳細は<a href="https://www.city.kitakyushu.lg.jp/ko-katei/index.html" target="_blank" rel="noopener">北九州市子ども家庭局</a>のページで確認できます。</p>
  ...
  // ===== 転園申込 (50) =====
  {
    ...
    citySlug: "kitakyushu",
    title: "北九州市で保育園を転園したい場合の申込方法と注意点",
    description:
      "北九州市で保育園の転園を希望する場合の申込方法・転園が認められるケース・注意点を解説します。",
    image:
      "https://images.unsplash.com/photo-1484820540004-14229fe36ca4?w=800&h=400&fit=crop",
    category: "書類・手続き",
    categoryColor: "green",
    content: `<h2>転園の申込方法</h2>
<p>転園を希望する場合は、区役所の子ども・家庭相談コーナーに転園申込書を提出します。通常の入園申込と同様に利用調整（点数による選考）が行われます。</p>
...
<tr><td>申込時期</td><td>4月転園は10月〜11月の申込。途中転園は前月10日頃まで</td></tr>
</table>
