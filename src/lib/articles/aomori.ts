...
<p>空き状況は<a href="https://www.city.aomori.aomori.jp/kodomo_kyoiku/ninteikodomoen_youchien_hoikusho/1009841/1009920.html" target="_blank" rel="noopener">青森市公式サイト「令和8年度保育所等空き状況一覧」</a>で確認できます。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "aomori",
    title: "青森市の保育料はいくら？　上限額と決まり方",
    description:
      "青森市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>青森市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>青森市でいちばん高い階層はいくら？</h2>
<p>青森市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額25,000円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
...
<p>上記の金額は青森市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.aomori.aomori.jp/_res/projects/default_project/_page_/001/003/552/2026hoikuryou.pdf" target="_blank" rel="noopener">青森市の保育料表</a>をご確認ください。</p>
</div>`,
