...
<h2>同点時の優先順位</h2>
<p>福井市では同一点数の場合、さらに別の調整点数表で優先順位が決まります。詳細は福井市の公式基準をご確認ください。</p>
...
<div class="warn-box">
<p><strong>注意</strong></p>
<p>同点時の優先順位はさまざまな調整項目が組み合わせられます。詳細は福井市の公式基準をご確認ください。</p>
</div>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>同点時の調整項目は複数あり、組み合わせで優先順位が決まります。詳細な基準については福井市の公式資料でご確認いただくことをお勧めします。</p>
</div>
