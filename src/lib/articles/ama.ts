...
<h3>あま市の選考指数の特徴</h3>
<p>あま市では<span class="highlight">就労形態（外勤・内勤・内職）</span>と<span class="highlight">月の勤務日数・1日の労働時間</span>の組み合わせで選考指数が決まります。就労による選考指数は外勤（フルタイム相当）で最大9点、内勤・農業で最大7点ですが、入院や災害など他の保育必要理由では最大10点となります。</p>
...
<h3>2. 外勤・フルタイムで最高9点を目指す（就労による場合）</h3>
<p>外勤・自営（外勤）で月20日以上・8時間以上の就労であれば9点が取得できます。内勤（テレワーク等）の場合は同じ勤務量でも7点となるため、出勤形態の確認が必要です。なお、就労以外の保育必要理由（入院、災害など）では最大10点まで可能です。</p>
...
<p>詳細はあま市の子育て支援・保育担当窓口にお問い合わせください。詳細は<a href="https://www.city.ama.aichi.jp/kurashi/1002024/hoikuenn/1009663.html" target="_blank" rel="noopener">あま市保育施設入園選考基準</a>をご参照ください。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "ama",
    title: "あま市の保育料はいくら？　上限額と決まり方",
    description:
      "あま市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>あま市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>あま市でいちばん高い階層はいくら？</h2>
<p>あま市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額48,000円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
...
<p>上記の金額はあま市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.ama.aichi.jp/kurashi/1002024/hoikuenn/1002054.html" target="_blank" rel="noopener">あま市の保育料表</a>をご確認ください。</p>
</div>`,
