...
<li>兄弟姉妹が在園中の園を希望：<span class="highlight">+5点</span></li>
</ul>
...
<tr><td>ひとり親世帯</td><td>+20点</td><td>ひとり親であること</td></tr>
<tr><td>生活保護世帯</td><td>+10点</td><td>生活保護を受給中</td></tr>
<tr><td>兄弟姉妹が在園中</td><td>+5点</td><td>在園中の園への申込</td></tr>
...
<p>最新情報は<a href="https://www.city.setagaya.lg.jp/01044/1561.html" target="_blank" rel="noopener">世田谷区公式サイト「令和8年4月入園について」</a>をご確認ください。</p>
  ...
  },
  {
    ...
    citySlug: "setagaya",
    title: "世田谷区の就労証明書｜様式ダウンロード先と記入例【令和8年度】",
    description:
      "世田谷区の保育園申込みに使う就労証明書について、公式の様式ダウンロード先へのリンクと、点数の付き方・記入例・よくある不備をまとめています。会社に依頼する前に確認してください。",
    image: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<div class="info-box">
<p><strong>まずは公式の様式をダウンロード</strong></p>
<p>就労証明書の様式・記入例は<a href="https://www.city.setagaya.lg.jp/01044/1561.html" target="_blank" rel="noopener">世田谷区公式サイト</a>からダウンロードできます。この記事では、その様式をどう書くと点数にどう響くかを説明します。</p>
</div>
<h2>就労証明書とは</h2>
...
<p>世田谷区は指数制（各保護者最大50点）を採用しています。就労証明書に記載された就労時間・日数によって以下の指数が付与されます。</p>
<table>
