...
<h3>基本指数（父母各最大15点、合計最大30点）</h3>
<table>
<tr><th>就労状況</th><th>指数</th></tr>
<tr><td>週4日以上かつ1日7時間以上の就労・通学</td><td>10</td></tr>
<tr><td>月64時間以上の就労・通学</td><td>6</td></tr>
<tr><td>その他</td><td>0</td></tr>
</table>

<h3>具体例</h3>
<div class="point-box">
<p><strong>例）父：フルタイム（10点）＋ 母：フルタイム（10点）＝ 基本20点</strong></p>
...
<p>認可外保育施設に月64時間以上有料で預けると+5点。宝塚市では30点満点の中で5点の差は大きいです。</p>
</div>
<div class="point-box">
<p><strong>戦略2：就労基準の確認</strong></p>
<p>フルタイム（週4日以上かつ1日7時間以上）で10点、月64時間以上で6点です。可能な限り高い基準を満たせないか確認しましょう。</p>
</div>
<div class="point-box">
...
<p>65歳未満の無職の祖父母と同居している場合、-3点の減算があります。同居の定義を市に確認しておきましょう。</p>
  ...
  // =========================================================================
  {
    ...
    citySlug: "takarazuka",
    title: "フルタイム共働き20点は安心？宝塚市のボーダーライン事情",
    description:
      "宝塚市でフルタイム共働き（基本20点）なら入園できるのか？人気エリアの実情と調整加点の重要性を解説します。",
    image:
      "https://images.unsplash.com/photo-1521791136064-7986c2920216?w=800&h=400&fit=crop",
    category: "点数のしくみ",
    categoryColor: "blue",
    content: `<h2>基本20点がスタートライン</h2>
<p>宝塚市では父母ともフルタイム（週4日以上かつ1日7時間以上）の場合、父10点＋母10点＝<span class="highlight">基本20点</span>になります。調整指数で最大10点追加されるため、最高30点になります。</p>

<h2>宝塚市の保育園事情</h2>
<p>宝塚市は人口約23万人、兵庫県阪神北地域に位置する住宅都市です。子育て世帯も多く、特に宝塚駅・逆瀬川駅周辺の人気園では20点以上の世帯が多数並びます。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>30点満点では安心できません。調整加点が勝負を分けます。きょうだい在園（+3〜+6）、認可外利用（+5）、育休復帰（+3）など、該当する加点がないか確認しましょう。</p>
</div>
...
<h2>就労時間が少ない場合</h2>
<p>月64時間程度の就労の場合、両親で6点＋6点＝基本12点。10点の基本点との差は8点です。宝塚市では大きなハンデになりえます。</p>
...
<p>宝塚市内の認可保育施設は約30か所あり、公立保育所・私立保育園・認定こども園（保育部分）・地域型保育（小規模保育）が含まれます。</p>`,
  ...
  // =========================================================================
  {
    slug: "ninkagai-katen",
    citySlug: "takarazuka",
    title: "認可外保育施設で+5点　宝塚市の加点を得る条件と活用法",
    description:
      "宝塚市で認可外保育施設の利用実績により調整指数+5点を得るための条件と手続きを解説します。",
    image:
      "https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?w=800&h=400&fit=crop",
    category: "認可外",
    categoryColor: "rose",
    content: `<h2>認可外利用で+5点の加点</h2>
<p>宝塚市では認可外保育施設に月64時間以上有料で預けている場合、<span class="highlight">+5点</span>の調整加点が得られます。</p>

<h2>30点満点の中で5点は大きい</h2>
<p>宝塚市の基本指数は父母合計で最大30点。フルタイム共働きの20点に認可外の+5点を加えれば25点になり、加点のない世帯との差は明確です。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>20点＋認可外+5点＝25点。さらにきょうだい在園（+3〜+6）があれば大幅に有利になります。</p>
</div>
...
<h2>育休と点数の関係</h2>
<div class="info-box">
<p>宝塚市では、育児休業取得中で入園に伴い復帰する場合、調整指数で<strong>+3点</strong>の加算があります。</p>
</div>
...
<p>育休復帰の調整加点（+3点）は入園に伴い復帰する場合に適用されます。上の子が在園していても、下の子の申込に対しての加算です。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 46,
  },
...
<div class="info-box">
<p>宝塚市内の認可外保育施設や企業主導型保育事業所は、市を通さず各施設に直接申込できます。認可外に預けて就労実績を作り、翌年の申込で+5点の加点を得る戦略が有効です。</p>
</div>
