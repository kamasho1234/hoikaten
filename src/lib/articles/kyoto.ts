...
<p>無償化制度の詳細は<a href="https://www.city.kyoto.lg.jp/hagukumi/page/0000054110.htmlpage/0000227761.html" target="_blank" rel="noopener">京都市公式サイト</a>をご確認ください。</p>
  ...
  },
  {
    slug: "shokuhi-jippi",
    citySlug: "kyoto",
    title: "京都市の保育園の給食費（副食費）はいくら？【令和8年度版】免除条件と金額",
    description: "京都市の保育園の給食費（副食費）は月いくら？所得・子ども数による副食費免除の条件と申請方法、保育料無償化の範囲と実費負担の全額をわかりやすく解説。令和8年度対応。",
...
<p>金額は園によって異なります。正確な金額は各園にお問い合わせください。</p>
  ...
  },
  {
    ...
    citySlug: "kyoto",
    title: "京都市の保育料計算【令和8年度版】年収別シミュレーション・早見表",
    description: "京都市の認可保育園の保育料を年収・子ども数別に詳しく解説。市民税所得割額に基づく階層区分早見表、無償化（3歳〜）の対象確認、副食費・第2子以降の減免制度まで。令和8年度対応。",
    image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&h=400&fit=crop",
    category: "お金・制度",
    categoryColor: "rose",
