...
const articles: Article[] = [
  {
    ...
    citySlug: "sakado",
    title: "坂戸市の保活スケジュール　申込から内定までの流れ",
    description:
      "坂戸市の認可保育園の申込時期・選考の流れをまとめました。令和8年度4月入園の動き方を解説します。",
    image: "https://images.unsplash.com/photo-1484820540004-14229fe36ca4?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>坂戸市の4月入園スケジュール</h2>
<p>坂戸市の認可保育園は毎年秋に翌年度4月入園の申込を受付けます。選考基準表に基づき利用調整が行われます。</p>
...
<p>坂戸市のホームページで保育園の一覧や前年度のボーダーを確認します。</p>
</div>
</div>
<div class="step">
...
<p>坂戸市内の保育園を見学して、通勤経路との相性を確認しましょう。</p>
</div>
</div>
<div class="step">
...
<p>4月申込の期限は例年11月中旬です。期限厳守で提出しましょう。</p>
</div>
</div>
...
<p>この情報は参考値です。正確な基準は、坂戸市の「保育園入園案内」で必ず確認してください。</p>
  ...
  },
  {
    ...
    description:
      "坂戸市の保育園入園選考で調整指数の加点を最大限に活用する方法を解説します。参考値です。",
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>坂戸市は入所決定者の最低指数を公開しています。園ごとのボーダーを確認して、自分の点数で入園できそうな園を探しましょう。</p>
</div>
...
<p>この情報は参考値です。就労証明書の月あたり就労時間は正確に記載してください。実態と異なる記載は入園取消しの対象です。</p>
  ...
  },
  {
    ...
    citySlug: "sakado",
    title: "坂戸市で同点になったらどうなる？優先順位を解説",
    description:
      "坂戸市の保育園入園選考で同点だった場合の優先順位の判定方法を解説します。参考値です。",
    image: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>同点時の判定方法</h2>
<p>坂戸市の入園選考で利用調整指数が同点になった場合、さらに優先順位で判定されます。参考値をご紹介します。</p>
...
<div class="warn-box">
<p><strong>注意</strong></p>
<p>優先順位は年度によって変更される場合があります。この情報は参考値です。最新の案内で必ず確認してください。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 45,
  },
  {
    ...
    citySlug: "sakado",
    title: "坂戸市で時短勤務だと点数はどう変わる？",
    description:
      "坂戸市の保育園入園選考で時短勤務の場合の基本指数への影響を解説します。参考値です。",
    image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>坂戸市は月の就労時間で判定</h2>
<p>坂戸市の基本指数は月の就労時間で決まります。時短勤務の影響を確認しましょう。参考値です。</p>
...
<p>復職後のフルタイム勤務条件を就労証明書に記載してもらえるか、勤務先に確認しましょう。育休中でも復職後の勤務条件で指数が判定されます。</p>
  ...
  },
  {
    ...
    citySlug: "sakado",
    title: "坂戸市でひとり親の場合　加点と支援制度",
    description:
      "坂戸市の保育園入園選考でひとり親世帯が受ける加点と支援内容を解説します。参考値です。",
...
<h2>埼玉県のひとり親支援制度</h2>
<p>坂戸市が属する埼玉県では、ひとり親世帯向けの保育料軽減制度があります。詳細は市の福祉事務所に問い合わせてください。</p>

<div class="warn-box">
<p><strong>注意</strong></p>
<p>この情報は参考値です。正確な加点額は、坂戸市の公式案内で必ず確認してください。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 52,
  },
  {
    ...
    citySlug: "sakado",
    title: "坂戸市の育児休業と入園タイミング　復帰予定者の加点",
    description:
      "坂戸市で育児休業から復帰する場合の入園タイミングと加点を解説します。参考値です。",
...
<h2>育児休業延長の仕組み</h2>
<p>保育園に非承認となった場合、育児休業を延長できます（最長2歳まで）。翌年度の申込みに向けて準備を進めましょう。</p>
...
<p>この情報は参考値です。復帰時期の確認書等が必要です。勤務先に確認の上、書類を準備してください。</p>
  ...
  },
  {
    ...
    citySlug: "sakado",
    title: "坂戸市の保育園入園待ちの現状　待機児童について",
    description:
      "坂戸市の保育園入園の待機児童状況と年度別の動向を解説します。参考値です。",
    image: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>坂戸市の待機児童状況</h2>
<p>坂戸市の待機児童数は、埼玉県内でも比較的少ない水準にあります。ただし、年齢クラスと地域によって差があります。</p>

<h2>園ごとの競争差</h2>
<p>駅周辺の人気園は競争が激しいですが、市の周辺地域の園には比較的空きがある場合もあります。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>坂戸市は保育園の定員を段階的に増やしており、入園しやすい環境を整備中です。複数の園をリストアップして申込みましょう。</p>
</div>

<h2>途中入園の可能性</h2>
<p>4月入園で非承認になった場合でも、年度途中に空きが出た場合の利用調整で入園できる可能性があります。</p>

<div class="warn-box">
<p><strong>注意</strong></p>
<p>この情報は参考値です。最新の待機児童数は坂戸市の公式発表で確認してください。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 45,
  },
  {
    ...
    citySlug: "sakado",
    title: "坂戸市の保育園申込　書類チェックリスト",
    description:
      "坂戸市の認可保育園申込に必要な書類をリストアップしました。漏れなく準備するためのチェックリストです。",
    image: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>申込に必要な書類</h2>
<p>坂戸市の認可保育園申込に必要な書類をまとめました。チェックリストとしてご活用ください。</p>
...
<div class="warn-box">
<p><strong>注意</strong></p>
<p>書類の不備は選考に影響します。提出前に坂戸市の案内で最新の書類リストを確認してください。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 48,
  },
  {
    ...
    citySlug: "sakado",
    title: "坂戸市で認可外保育施設を活用する方法　加点のコツ",
    description:
      "坂戸市では認可外保育施設の月ぎめ利用で加点が得られます。その活用法を解説します。",
