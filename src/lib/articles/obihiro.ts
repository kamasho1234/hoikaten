...
<p>途中入園の空き状況は<a href="https://www.city.obihiro.hokkaido.jp/kyoiku/kosodate/hoiku/1010107.html" target="_blank" rel="noopener">帯広市公式サイト「保育所・認定こども園等」</a>で確認できます。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "obihiro",
    title: "帯広市の保育料はいくら？　上限額と決まり方",
    description:
      "帯広市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>帯広市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>帯広市でいちばん高い階層はいくら？</h2>
<p>帯広市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額91,400円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
...
<p>上記の金額は帯広市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.obihiro.hokkaido.jp/_res/projects/default_project/_page_/001/004/598/r8hoikuryou.pdf" target="_blank" rel="noopener">帯広市の保育料表</a>をご確認ください。</p>
</div>`,
