...
<p>求職活動中の基準点数は4点で、就労中（最大20点）と大きな差があります。求職中での入園は中心部では困難です。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "takamatsu",
    title: "高松市の保育料はいくら？　上限額と決まり方",
    description:
      "高松市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>高松市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>高松市でいちばん高い階層はいくら？</h2>
<p>高松市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額53,000円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>保育料は毎年9月に切り替わります。4月分から8月分は前年度の住民税額、9月分から翌年3月分は当年度の住民税額で決まる自治体が多いため、9月に金額が変わることがあります。</p>
</div>
<h2>きょうだいがいる世帯の軽減</h2>
<p>高松市は次のように案内しています。</p>
<blockquote><p>障害児通所支援を利用している児童が、第2子の場合：費用の5％と月額上限額を比較して低い方第3子以降の場合：無償ページの上部へPDF形式のファイルを開くには、AdobeAcrobatReaderDC（旧AdobeReader）が必要です。</p></blockquote>
<div class="info-box">
<p><strong>出典</strong></p>
<p>上記の金額は高松市が公表している保育料表によります。階層ごとの正確な金額は<a href="http://www.city.takamatsu.kagawa.jp/kurashi/kosodate/youchien_hoiku/kodomoen/hoiku.files/14hutankingaku.pdf" target="_blank" rel="noopener">高松市の保育料表</a>をご確認ください。</p>
</div>`,
