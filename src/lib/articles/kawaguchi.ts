...
<div class="warn-box">
<p><strong>注意</strong></p>
<p>川口市では育児休業から復帰して入園する場合に+1点の加点が得られます。育休復帰のタイミングを計画的に検討しましょう。</p>
</div>`,
    publishedAt: "2026-03-28",
    popularity: 100,
  },
...
<div class="warn-box">
<p><strong>注意</strong></p>
<p>川口市では認可保育施設の利用は調整指数に影響しないため、認可外保育を活用する場合は実績を申し込み書に記入しましょう。</p>
</div>`,
    publishedAt: "2026-03-28",
    popularity: 75,
  },
...
<p>求職活動中の基本指数は6点で、就労中（最大20点）の3分の1以下です。求職中での入園は人気エリアでは困難です。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "kawaguchi",
    title: "川口市の保育料はいくら？　上限額と決まり方",
    description:
      "川口市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>川口市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>川口市でいちばん高い階層はいくら？</h2>
<p>川口市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額69,000円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>保育料は毎年9月に切り替わります。4月分から8月分は前年度の住民税額、9月分から翌年3月分は当年度の住民税額で決まる自治体が多いため、9月に金額が変わることがあります。</p>
</div>
<h2>きょうだいがいる世帯の軽減</h2>
<p>川口市は次のように案内しています。</p>
<blockquote><p>,101円未満）の世帯である・同一世帯内の小学校3年生以下のお子さんの人数を数えた場合に、幼稚園を利用しているお子さんが第3子以降である無償化のために必要となる手続きについて利用料や預かり保育利用料に対する施設等利用費の支給（無償化）を受けるためには、施設等利用給付認定を受ける必要があります。</p></blockquote>
<div class="info-box">
<p><strong>出典</strong></p>
<p>上記の金額は川口市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.kawaguchi.lg.jp/material/files/group/79/tyousyuukijunnhyou_R4.pdf" target="_blank" rel="noopener">川口市の保育料表</a>をご確認ください。</p>
</div>`,
