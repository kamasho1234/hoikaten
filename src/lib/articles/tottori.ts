...
<p>最新の入所案内は<a href="https://www.city.tottori.lg.jp/site/kosodate/20071.html" target="_blank" rel="noopener">鳥取市公式サイト「令和8年度 保育所等入所申込みのご案内」</a>をご確認ください。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "tottori",
    title: "鳥取市の保育料はいくら？　上限額と決まり方",
    description:
      "鳥取市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>鳥取市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>鳥取市でいちばん高い階層はいくら？</h2>
<p>鳥取市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額58,000円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
...
<p>上記の金額は鳥取市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.tottori.lg.jp/uploaded/attachment/47205.pdf" target="_blank" rel="noopener">鳥取市の保育料表</a>をご確認ください。</p>
</div>`,
