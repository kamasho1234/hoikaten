...
const articles: Article[] = [
  // ===== 保活の基本 (1) =====
  {
    ...
    title: "東松山市の保活スケジュール　令和8年度4月入園の流れ",
    description:
      "東松山市の認可保育園の申込時期・選考の流れ・結果通知の時期をわかりやすく解説。令和8年度4月入園のスケジュールを中心にまとめました。",
    image:
      "https://images.unsplash.com/photo-1484820540004-14229fe36ca4?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>令和8年度（2026年度）4月入園のスケジュール</h2>
<p>東松山市の4月入園は<strong>一次利用調整</strong>と<strong>二次利用調整</strong>の2回に分かれています。申込先は東松山市保育課です。</p>
...
<p>東松山市の認可保育園は約25か所。エリアや園の特徴を調べましょう。</p>
</div>
</div>
<div class="step">
...
<p>東松山市が発行する「保育施設利用のご案内」を入手しましょう。</p>
</div>
</div>
<div class="step">
...
<p>各月の申込締切日は、入園希望月の<span class="highlight">前月10日頃</span>です。詳しくは東松山市の公式サイトをご確認ください。</p>`,
  ...
  // ===== 基本指数 =====
  {
    ...
    citySlug: "higashimatsuyama",
    title: "東松山市の保育園入園　基本指数と調整指数の計算方法",
    description:
      "東松山市の保育園入園選考に使われる点数システムを徹底解説。自分の点数を計算してみましょう。",
    image:
      "https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>東松山市の点数システムについて</h2>
<p>東松山市では「基本指数」と「調整指数」の合計で入園者を決定します。参考値として、フルタイム共働き世帯の基本指数は約40点です。</p>
...
<ul>
<li>ひとり親世帯の就労：+5点</li>
<li>きょうだいが保育施設に入所中：+0.5点</li>
<li>きょうだいを同一施設に通所させるための転所希望：+2点</li>
<li>認可外保育施設利用中：+1点</li>
<li>育休明けで復帰予定：+1点</li>
<li>生活保護受給：+3点</li>
</ul>
...
<li>認可園からの転園：-5点</li>
  ...
  // ===== 点数アップ =====
  {
    slug: "score-up-tips",
    citySlug: "higashimatsuyama",
    title: "東松山市で保育園に入りやすくするための点数アップ作戦",
    description:
      "東松山市の保育園入園で点数を上げるための実践的な対策を5つ紹介します。",
    image:
...
<h3>1. 認可外保育施設の活用（+1点）</h3>
<p>認可園に入れない場合、認可外保育施設に預けることで翌年度の申請時に+1点がつきます。特に0歳児で認可園に入れなかった場合、認可外を選択肢に入れると1年後の加点につながります。</p>

<h3>2. 育休明けタイミングの活用（+1点）</h3>
<p>入園月中に職場復帰する予定があれば、+1点の加点がつきます。スケジュール調整が可能であれば、復帰時期を入園月に合わせることも検討しましょう。</p>

<h3>3. きょうだいの活用（+0.5点または+2点）</h3>
<p>上の子が既に同じ園に在園中であれば+0.5点、きょうだいを同一施設に通所させるための転所希望なら+2点がつきます。複数の子どもがいる場合は活用のチャンスです。</p>
...
<p>複数の加点を組み合わせることで、確実に点数を上げられます。使える加点は漏れなく活用しましょう。</p>
  ...
  // ===== 同点対策 =====
  {
    ...
    citySlug: "higashimatsuyama",
    title: "東松山市で同点になったらどうなる？　優先順位のしくみ",
    description:
      "東松山市の保育園入園選考で同点になった場合の優先順位と、事前にできる対策を解説します。",
    image:
      "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>同点の場合の優先順位</h2>
<p>東松山市では選考指数が同点の場合、以下の順番で優先されます（参考値）。</p>

<ol>
<li>ひとり親世帯</li>
<li>希望する保育施設にきょうだいが在園している世帯</li>
<li>基本指数が高い世帯（調整指数による加点が少ない＝就労状況が安定）</li>
<li>東松山市の居住期間が長い世帯</li>
<li>所得が低い世帯</li>
</ol>
...
<p>東松山市の公式サイトで、前年度の選考ボーダーラインが公開されていることがあります。参考にしましょう。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 58,
  },
...
<p>東松山市でもパート勤務や時短勤務での入園は可能です。ただし、就労時間によって点数が変わるため、計画が重要です。</p>
...
<p>月48時間のパート（月6日×8時間）よりも月64時間（月8日×8時間）のパートの方が、4点高くなります。ボーダーラインが近い場合は、この4点が決定的な差になることもあります。</p>
  ...
  // ===== ひとり親 =====
  {
    ...
    citySlug: "higashimatsuyama",
    title: "東松山市　ひとり親家庭の保育園入園　加点と優遇措置",
    description:
      "母子家庭・父子家庭が東松山市で保育園に入るときの加点と優遇措置をまとめました。",
    image:
      "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>ひとり親家庭の加点</h2>
<p>東松山市では、ひとり親世帯（母子家庭・父子家庭）で就労中または就労が内定している場合、+5点の加点がつきます。</p>
...
<p>ひとり親加算（+5点）に認可外利用（+1点）と育休明け復帰（+1点）を組み合わせることで、調整指数で合計+7点の加点が見込めます。</p>
</div>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 58,
  ...
  // ===== 育休タイミング =====
  {
    ...
    citySlug: "higashimatsuyama",
    title: "東松山市　育休からの復帰タイミング　保育園入園を成功させるには",
    description:
...
<p>育休からの復帰と保育園入園はセットで計画することが成功のカギです。東松山市では入園月中に職場復帰すれば+1点の加点がつきます。</p>
...
<p>+2点は小さく見えますが、同点でのボーダーラインが近い場合は決定的な差になります。復帰タイミングの調整は重要です。</p>
  ...
  // ===== 待機児童 =====
  {
    ...
    citySlug: "higashimatsuyama",
    title: "東松山市の保育園　待機児童と入園難易度",
    description:
      "東松山市の待機児童数と入園難易度の推移、競争率が高い時期と入りやすい園の見つけ方。",
    image:
      "https://images.unsplash.com/photo-1544776278-ca5e3af521d7?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>東松山市の待機児童状況</h2>
<p>東松山市は埼玉県北部の中規模都市で、人口約8.9万人。保育園の数は約25か所とコンパクトながら、入園競争は年ごと、園ごとに異なります。</p>
...
<p>東松山市の公式サイトで保育施設ごとの利用可能状況を公開しています。定期的にチェックしましょう。</p>
</div>
</div>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>東松山市は規模が大きすぎず小さすぎず、園ごとの特色がはっきりしています。複数の園を見学して、狙い目を見つけることが大切です。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 48,
  },
  // ===== 申込チェック =====
  {
    ...
    citySlug: "higashimatsuyama",
    title: "東松山市　保育園申込のチェックリスト　書類漏れで不利にならない方法",
    description:
      "東松山市の保育園申込で必要な書類と提出期限、提出漏れで損しないための確認リストです。",
    image:
      "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
...
<p>書類の不備や記載漏れは、加点の取りこぼしや、場合によっては選考自体に影響します。提出前に必ず複数回チェックしましょう。</p>
  ...
  // ===== 認可外 =====
  {
    ...
    citySlug: "higashimatsuyama",
    title: "東松山市の認可外保育施設ガイド　認可園との違いは？",
    description:
      "東松山市で認可園に入れなかった場合の選択肢として、認可外保育施設について解説します。",
    image:
      "https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=800&h=400&fit=crop",
    category: "認可外保育",
    categoryColor: "teal",
    content: `<h2>認可外保育施設とは？</h2>
<p>認可外保育施設は、認可基準を満たしていないものの、自治体に届出をして運営している保育施設です。東松山市内にも複数の認可外保育施設があります。</p>

<h2>認可園との違い</h2>
<table>
<tr><th>項目</th><th>認可</th><th>認可外</th></tr>
<tr><td>保育料</td><td>所得に応じて決定</td><td>施設が設定</td></tr>
<tr><td>申込先</td><td>東松山市保育課</td><td>施設に直接</td></tr>
