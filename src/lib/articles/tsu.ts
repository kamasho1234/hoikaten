...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>利用調整指数 ＝ 父の基本指数（最大11点） ＋ 母の基本指数（最大11点） ＋ 調整指数</p>
</div>

<h2>基本指数とは</h2>
<p>保護者それぞれの「保育を必要とする事由」を指数化したものです。1人あたり<span class="highlight">最大11点</span>、父母合わせて<span class="highlight">最大22点</span>です。</p>
<table>
...
<h3>1. ひとり親家庭（+10点または+20点）</h3>
<p>母子家庭・父子家庭の場合に加算されます。配偶者のいない者およびその子以外の同居人がいない世帯は+20点、それ以外のひとり親家庭は+10点です。津市の調整指数で大きな加点項目です。</p>

<h3>2. きょうだいが希望園に在園中（+20点または+30点）</h3>
<p>上の子が既に利用している保育施設に別のお子さんが希望する場合、+20点が加算されます。同じ園を希望して申込む場合は+30点になります。送迎の負担も軽減できます。</p>

<h3>3. 認可外保育施設に預託中（+1点）</h3>
<p>認可外保育施設や親戚等に月極で預けている場合に加算されます。認可園に入れなかった場合のつなぎとして認可外に預けることで、次年度の選考で有利になります。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>フルタイム共働き＋きょうだい在園（+30点）＋認可外預託の場合の組み合わせで指数が大きく変わります。きょうだい加点の形態によって調整指数が異なります。</p>
</div>

<h3>4. 産前産後休業または育児休業から復帰（+23点）</h3>
<p>4月1日からの利用調整では前年度内に職場復帰した場合を含みます。育休明けの4月入園を目指す方は忘れずに申告しましょう。</p>

<h3>5. きょうだい同時申込（+4点）</h3>
...
<p>津市は夏場の気温が高くなるため、室内の空調設備やプール・水遊びの環境も確認しましょう。また車社会のため、駐車場の広さと送迎時の動線は特に重要です。</p>
  ...
  },
  {
    ...
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>育休・産休から復帰する場合は+23点</h2>
<p>津市では産前産後休業または育児休業から復帰する場合、調整指数として<span class="highlight">+23点</span>が加算されます。育休明けの4月入園を目指す場合は必ず申告しましょう。</p>

<h2>認可外預託で+1点または+5点</h2>
<p>認可外保育施設に月極で預けている場合は<span class="highlight">+1点</span>が加算されます。市外の保育施設を利用している場合も同様に+1点です。市内の保育所等を利用中で他の保育所等を希望する場合は<span class="highlight">+5点</span>になります。</p>
...
<p>津市内の保育施設一覧は<a href="https://www.info.city.tsu.mie.jp/www/contents/1001000008103/index.html" target="_blank" rel="noopener">津市公式サイト「保育所・認定こども園」</a>で確認できます。</p>
  ...
  },
  {
    ...
    category: "点数・選考",
    categoryColor: "blue",
    content: `<h2>きょうだいが希望園に在園中で+20点または+30点</h2>
<p>津市では対象児童のきょうだいが既に利用している保育施設に別のお子さんが希望する場合、<span class="highlight">+20点</span>の調整指数が加算されます。同じ園を希望して申込む場合は<span class="highlight">+30点</span>になります。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>フルタイム共働き＋きょうだい在園（+30点）＋育休明け（+23点）の場合、調整指数が大きく加算されます。同じ園を希望する場合は特に有利に選考が進みます。</p>
</div>

<h2>きょうだい同時申込は+4点</h2>
<p>2人以上のきょうだいを同時に保育施設へ申し込む場合に<span class="highlight">+4点</span>が加算されます。双子や年子の場合に該当します。</p>

<table>
<tr><th>パターン</th><th>調整指数</th></tr>
<tr><td>きょうだいが希望園に在園中</td><td>+20〜30</td></tr>
<tr><td>きょうだい同時申込</td><td>+4</td></tr>
<tr><td>育休・産休明け復帰</td><td>+23</td></tr>
</table>
...
<p>認可外保育施設は利用調整がないため、空きがあればすぐに入れます。認可外に預けることで翌年度は<span class="highlight">+1点</span>の加算が得られます。市内の保育所等を利用中で他の保育所等を希望する場合は<span class="highlight">+5点</span>になります。</p>
...
<li>認可外保育施設の利用または市内保育所の利用中転園で加点を確保する</li>
...
<p>空き状況は<a href="https://www.info.city.tsu.mie.jp/www/contents/1001000008103/index.html" target="_blank" rel="noopener">津市公式サイト「保育所・認定こども園」</a>で確認できます。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "tsu",
    title: "津市の保育料はいくら？　上限額と決まり方",
    description:
      "津市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>津市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>津市でいちばん高い階層はいくら？</h2>
<p>津市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額48,000円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
...
<p>上記の金額は津市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.info.city.tsu.mie.jp/_res/projects/default_project/_page_/001/002/735/hoikuryou.pdf" target="_blank" rel="noopener">津市の保育料表</a>をご確認ください。</p>
</div>`,
