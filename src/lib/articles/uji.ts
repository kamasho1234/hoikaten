...
<p>宇治市の入園選考は「ポイント制」で行われます。父母それぞれの基本指数（最大20点）のうち低い方の点数に、調整指数を加減して最終的な選考点数が決まります（基本指数の最大は20点）。</p>
...
<p>宇治市の入園選考では、フルタイム共働きの場合、両親とも<span class="highlight">20点</span>がベースラインです。基本指数の最大が20点で、調整指数を加えた点数で選考されます。</p>
