...
<p>各保育施設の概要と連携施設は<a href="https://www.city.akashi.lg.jp/kodomo/ikusei_shitsu/hoiku/hoikushoannai.html" target="_blank" rel="noopener">明石市公式サイト「各保育施設の概要」</a>で確認できます。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "akashi",
    title: "明石市の保育料はいくら？　上限額と決まり方",
    description:
      "明石市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>明石市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>明石市でいちばん高い階層はいくら？</h2>
<p>明石市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額62,500円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>保育料は毎年9月に切り替わります。4月分から8月分は前年度の住民税額、9月分から翌年3月分は当年度の住民税額で決まる自治体が多いため、9月に金額が変わることがあります。</p>
</div>
<h2>きょうだいがいる世帯の軽減</h2>
<p>明石市は次のように案内しています。</p>
<blockquote><p>なお、明石市では認可施設において第2子以降の保育料を無料化しておりますので、幼児教育・保育の無償化実施以後は0歳～2歳クラスの住民税課税世帯で、第1子の児童のみ保育料をご負担いただくこととなります。</p></blockquote>
<div class="info-box">
<p><strong>出典</strong></p>
<p>上記の金額は明石市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.akashi.lg.jp/documents/1458/20252026hoikuryouryoukinn.pdf" target="_blank" rel="noopener">明石市の保育料表</a>をご確認ください。</p>
</div>`,
