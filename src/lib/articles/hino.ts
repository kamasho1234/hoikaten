...
<p>最新の待機児童・空き状況は<a href="https://www.city.hino.lg.jp/kosodate/hoikuen/nyuen/index.html" target="_blank" rel="noopener">日野市公式サイト</a>で確認できます。</p>
  ...
  },
  {
    ...
    citySlug: "hino",
    title: "日野市の保育料計算【令和8年度版】年収別シミュレーション・早見表",
    description:
      "日野市の認可保育園の保育料を年収・子ども数別に詳しく解説。市民税所得割額に基づく階層区分早見表、無償化（3歳〜）の対象確認、副食費・第2子以降の減免制度まで。令和8年度対応。",
    image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&h=400&fit=crop",
    category: "お金・制度",
    categoryColor: "amber",
    content: `<h2>日野市の保育料はどうやって決まる？</h2>
<p>日野市の認可保育園の保育料（利用者負担額）は、<strong>世帯の市区町村民税所得割額</strong>によって決まります。東京都の基準に基づき階層区分が設定されており、所得が高いほど保育料も高くなる応能負担方式です。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>3歳以上は保育料が無償化されますが、<span class="highlight">副食費（給食の食材費）は別途負担</span>が必要です。ただし低所得世帯や第3子以降は免除される場合があります。</p>
</div>
...
<p class="text-xs text-muted-foreground">※上記は目安です。詳細は日野市の公式保育料表をご確認ください。</p>
...
<h2>副食費について（3歳以上）</h2>
<p>3歳以上は保育料が無償化されますが、副食費（おかず代）は月額4,500円程度の実費負担があります。ただし以下の場合は免除されます。</p>
<ul>
<li>年収360万円未満相当の世帯（低所得）</li>
<li>第3子以降の子ども</li>
</ul>
