...
<p>浦安市は基本指数が父母各最大50点（合計100点満点）で、調整指数を加算して選考されます。フルタイム共働きで100点が基本ラインです。</p>
</div>
...
<p>浦安市ではフルタイム共働き世帯は基本指数<span class="highlight">100点</span>で横並びです。差がつくのは調整指数の加点です。</p>

<h2>加点チェックリスト</h2>
<table>
<tr><th>項目</th><th>点数</th><th>条件</th></tr>
<tr><td>保護者が死亡・未婚・拘禁・別居等</td><td>+10点</td><td>保護者が不在の場合</td></tr>
<tr><td>育休復帰予定</td><td>+10点</td><td>入園月に職場復帰する場合</td></tr>
<tr><td>きょうだいが3人以上</td><td>+4点</td><td>未就学児のきょうだいが3人以上の場合</td></tr>
<tr><td>きょうだいが2人</td><td>+3点</td><td>未就学児のきょうだいが2人の場合</td></tr>
<tr><td>きょうだいが1人</td><td>+2点</td><td>未就学児のきょうだいが1人の場合</td></tr>
<tr><td>生活保護</td><td>+7点</td><td>生活保護を受けている場合</td></tr>
</table>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>浦安市では110点以上あれば多くの園で入園できる可能性が高いです。100点＋きょうだい複数（+4-10）＝<span class="highlight">110点以上</span>が一つの目安です。</p>
</div>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>浦安市の100点制では調整指数の加点幅が大きいため、フルタイム共働き＋認可外利用で103点を目指すのが現実的です。同点の場合は上記の条件で差がつきます。</p>
</div>

<h2>新浦安エリアは特に同点が多い</h2>
<p>新浦安エリアはタワーマンションが集中し、共働き世帯が多いため100点の同点が発生しやすい地域です。調整指数の加点が重要になります。</p>
...
<p>浦安市は100点満点のため、片方の保護者が時短で10点下がると合計90点になり、フルタイム世帯との差が大きくなります。育休復帰（+10点）や未就学児きょうだい複数（+2-4点）などの調整指数でカバーすることを検討しましょう。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 90,
  },
...
<h3>3. 翌年度の申込で加点を狙う</h3>
<p>翌年度の申込では、育休復帰（+10点）や未就学児きょうだい複数（+2-4点）などの調整指数で有利になる可能性があります。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>育休復帰（+10点）と未就学児きょうだい3人以上（+4点）を翌年度に積むと、合計+14点の加算が見込めます。100点＋14点＝<span class="highlight">114点</span>で入園の可能性が大きく上がります。</p>
</div>
...
<p>空き状況は<a href="https://www.city.urayasu.lg.jp/kodomo/hoiku/" target="_blank" rel="noopener">浦安市公式サイト</a>で確認できます。</p>
  ...
  },
  {
    ...
    citySlug: "urayasu",
    title: "浦安市で未就学児きょうだいの加点を活用する方法",
    description:
      "浦安市では未就学児のきょうだいが複数いる場合に調整指数で加点が得られます。その仕組みを解説します。",
    image: "https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>きょうだい人数による加点</h2>
<p>浦安市では未就学児のきょうだいが複数いる場合、調整指数で加点が得られます。</p>

<table>
<tr><th>きょうだい人数</th><th>加点</th></tr>
<tr><td>3人以上</td><td><span class="highlight">+4点</span></td></tr>
<tr><td>2人</td><td><span class="highlight">+3点</span></td></tr>
<tr><td>1人</td><td><span class="highlight">+2点</span></td></tr>
</table>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>きょうだいが3人以上いると+4点の加点があります。浦安市の100点制では重要な加点です。</p>
</div>

<h2>加点に含まれる条件</h2>
<ul>
<li>未就学児のきょうだい（現在保育園に在園していないお子さんを含む）</li>
<li>同時申込の場合</li>
<li>過去に受け入れた場合も対象になる場合があります</li>
</ul>

<h2>活用のポイント</h2>
<p>フルタイム共働き（100点）ときょうだい3人以上（+4点）で104点になります。不承諾を避けるため、第二希望・第三希望の園も含めて複数園を希望することをお勧めします。</p>

<div class="info-box">
<p><strong>詳細</strong></p>
<p>具体的な適用条件は浦安市の利用調整基準をご確認ください。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 75,
  },
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>新浦安エリアのタワマン世帯はフルタイム共働きが多く、100点で横並びになりやすいです。通勤経路上の園も含めて幅広く希望園を検討しましょう。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 60,
  },
...
<h2>ボリュームゾーン</h2>
<p>フルタイム共働き世帯は基本指数<span class="highlight">100点</span>で横並びです。調整指数の加点で差がつきます。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>103点以上あれば多くの園で入園できる可能性が高いです。100点＋認可外利用（+3）＝<span class="highlight">103点</span>が一つの目安です。きょうだい在園があれば+3点でさらに有利になります。</p>
</div>
...
<div class="info-box">
<p><strong>注意</strong></p>
<p>求職活動中の基本指数は6点で、就労中（最大50点）の3分の1以下です。求職中での入園は人気エリアでは困難です。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 95,
  },
  {
    slug: "nursery-fees",
    citySlug: "urayasu",
    title: "浦安市の保育料はいくら？　上限額と決まり方",
    description:
      "浦安市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>浦安市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>浦安市でいちばん高い階層はいくら？</h2>
<p>浦安市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額52,000円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
...
<p>上記の金額は浦安市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.urayasu.lg.jp/kodomo/hoiku/hoikuen/1042934/1042935.html" target="_blank" rel="noopener">浦安市の保育料表</a>をご確認ください。</p>
</div>`,
