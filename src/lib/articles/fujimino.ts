...
<h2>基本指数とは？</h2>
<p>父母それぞれの「保育が必要な理由」を点数化したものです。1人あたり最大<span class="highlight">120点</span>で、父母合計の最大は<span class="highlight">240点</span>。</p>
<p>最も多い「就労」の場合、月150時間以上で満点の100点になります。</p>

<table>
<tr><th>就労状況</th><th>指数</th></tr>
<tr><td>月150時間以上</td><td>100</td></tr>
<tr><td>月140時間以上150時間未満</td><td>95</td></tr>
<tr><td>月130時間以上140時間未満</td><td>90</td></tr>
<tr><td>月120時間以上130時間未満</td><td>85</td></tr>
<tr><td>月110時間以上120時間未満</td><td>80</td></tr>
</table>
...
<h3>主な加算項目</h3>
<ul>
<li>ひとり親世帯（生活保護除く）：<span class="highlight">+130点</span></li>
<li>きょうだいが在園中（1人）：<span class="highlight">+10点</span></li>
<li>きょうだい同時申込または別々の施設に在園で転所を希望：<span class="highlight">+20点</span></li>
<li>認可外保育施設等への保育委託（条件により）：<span class="highlight">+20点または+10点</span></li>
<li>生活保護世帯：<span class="highlight">+30点</span></li>
<li>多胎児：<span class="highlight">+10点</span></li>
</ul>

<h3>主な減算項目</h3>
<ul>
<li>60歳未満の祖父母と同居（保育不可証明書類なし）：<span class="highlight">-50点</span></li>
<li>入所辞退（1回ごとに）：<span class="highlight">-20点</span></li>
</ul>`,
    publishedAt: "2026-04-26",
    popularity: 65,
  },
...
<ul>
<li>ひとり親で就労中 → <span class="highlight">+130点</span></li>
<li>きょうだいが希望施設に在園中 → <span class="highlight">+10点</span></li>
<li>認可外保育施設に月16日かつ月64時間以上で預けている → <span class="highlight">+20点</span></li>
<li>生活保護を受給中 → <span class="highlight">+30点</span></li>
<li>きょうだいを同時に申込 → <span class="highlight">+20点</span></li>
<li>多胎児である → <span class="highlight">+10点</span></li>
</ul>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>認可外保育施設に月16日かつ月64時間以上で預けながら翌年の4月入園を申し込むと、+20点の加点がつきます。0歳児クラスで認可外に預け、1歳児クラスで認可園を狙うのはふじみ野市でも有効な戦略です。</p>
</div>

<div class="info-box">
<p><strong>注意すべき減点項目</strong></p>
<p>60歳未満の祖父母が同居していて保育不可証明書類がない場合は-50点、入所を辞退した場合は1回につき-20点の減点があります。特に祖父母が同居している場合は大幅な減点となるため要注意です。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 60,
  },
...
<p>ふじみ野市ではひとり親世帯（母子家庭・父子家庭）で就労している場合、調整指数で<span class="highlight">130点</span>の加点が付きます。</p>

<h2>基本指数は通常通り</h2>
<p>ひとり親の加点は調整指数に含まれるため、基本指数（就労の点数）は両親家庭と同じ基準で評価されます。例えば、月150時間以上勤務なら基本指数100点、調整指数130点で合計230点になります。</p>

<h2>同点時の優先順位</h2>
<p>ふじみ野市の同点時の優先ルールでは、ひとり親世帯が第1優先とされています。つまり、<strong>フルタイムで働くひとり親と両親がどちらも100点+100点で200点の場合、ひとり親世帯が優先されます</strong>。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>ひとり親世帯＋認可外保育利用中（月16日かつ月64時間以上）なら+20点、きょうだい同時申込なら+20点が重ねてつくので、合計で最大170点の調整指数を獲得できます。</p>
</div>

<h2>就学中のひとり親</h2>
<p>就学中で月150時間以上の就学が確認できれば、基本指数100点+調整指数130点で230点になります。</p>
...
<p>ひとり親であることを証明するため、戸籍謄本や児童扶養手当受給証等の提出が必要になります。申し込み時に保育課に確認しましょう。</p>
  ...
  // ===== 育休タイミング =====
  {
    ...
    category: "入園のコツ",
    categoryColor: "rose",
    content: `<h2>出産で変わる基本指数</h2>
<p>出産予定月及びその前後2か月の計5か月間は、保育が必要な理由が「出産」となり、基本指数100点（母親のみ）が付きます。</p>

<h2>入園月のタイミング</h2>
<p>出産に関連する基本指数100点は、出産関連期間中に限定されます。育休から復帰して保育園入園を希望する場合は、基本指数は復帰時の状況（就労など）で評価されます。</p>

<div class="point-box">
<p><strong>おすすめの入園月</strong></p>
<p>4月入園がおすすめです。出産予定月から計算して、翌年の4月に保育園入園を申し込むというパターンが一般的です。</p>
</div>

<h2>出産と復帰のタイミング</h2>
<table>
<tr><th>入園時期</th><th>基本指数</th><th>備考</th></tr>
<tr><td>出産予定月から5か月以内の入園</td><td>100点（出産）</td><td>母親が該当。その他事由より優先度が高い</td></tr>
<tr><td>出産予定月から5か月後以降の入園</td><td>就労などで評価</td><td>出産事由の期限切れ後は、復職状況で評価</td></tr>
</table>

<h2>出産前後の申し込み</h2>
<p>出産予定日の前から申し込みが可能です。ふじみ野市の公式サイトで申し込みのタイミングについて確認しましょう。</p>

<div class="info-box">
<p><strong>注意</strong></p>
<p>申し込み書類には出産予定日や育休明け予定日を記入する欄があります。これらの日付で基本指数や調整指数の対象判定が行われます。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 50,
  },
...
<p>ふじみ野市の認可外保育施設一覧は、ふじみ野市こども・元気健康部保育課の窓口で確認できます。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "fujimino",
    title: "ふじみ野市の保育料はいくら？　上限額と決まり方",
    description:
      "ふじみ野市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>ふじみ野市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>ふじみ野市でいちばん高い階層はいくら？</h2>
<p>ふじみ野市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額55,600円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
...
<p>上記の金額はふじみ野市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.fujimino.saitama.jp/material/files/group/26/hoikuryou.pdf" target="_blank" rel="noopener">ふじみ野市の保育料表</a>をご確認ください。</p>
</div>`,
