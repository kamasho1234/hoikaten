...
<p>詳細はさぬき市の子育て・保育担当窓口にお問い合わせください。詳細は<a href="https://www.city.sanuki.lg.jp/section/reiki_int/reiki_honbun/o111RG00001187.html" target="_blank" rel="noopener">さぬき市保育施設等の利用調整に関する要綱</a>をご参照ください。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "sanuki",
    title: "さぬき市の保育料はいくら？　上限額と決まり方",
    description:
      "さぬき市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>さぬき市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>さぬき市でいちばん高い階層はいくら？</h2>
<p>さぬき市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額53,000円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
...
<p>上記の金額はさぬき市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.sanuki.lg.jp/material/files/group/18/hoikuryou.pdf" target="_blank" rel="noopener">さぬき市の保育料表</a>をご確認ください。</p>
</div>`,
