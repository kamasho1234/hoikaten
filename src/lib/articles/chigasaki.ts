...
<div class="info-box">
<p><strong>公式情報</strong></p>
<p>全項目は<a href="https://www.city.chigasaki.kanagawa.jp/kosodate/1024751/hoikuen/index.html" target="_blank" rel="noopener">茅ヶ崎市こども育成部保育課</a>で確認できます。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 65,
  },
...
<div class="info-box">
<p><strong>公式情報</strong></p>
<p>二次募集や途中入園の情報は<a href="https://www.city.chigasaki.kanagawa.jp/kosodate/1024751/hoikuen/index.html" target="_blank" rel="noopener">茅ヶ崎市こども育成部保育課</a>で確認できます。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 40,
  },
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>認可外保育施設の加点は+3点です。育休復帰予定（+2点）など他の加点と組み合わせることで、茅ヶ崎市での保活において当落を分ける結果につながります。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 55,
  },
...
<div class="info-box">
<p><strong>公式情報</strong></p>
<p>最新の情報は<a href="https://www.city.chigasaki.kanagawa.jp/kosodate/1024751/hoikuen/index.html" target="_blank" rel="noopener">茅ヶ崎市こども育成部保育課</a>で確認できます。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 35,
  },
...
<p>上記は過去の傾向をもとにした参考値です。最新の内定最低指数は茅ヶ崎市のホームページで確認できます。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "chigasaki",
    title: "茅ヶ崎市の保育料はいくら？　上限額と決まり方",
    description:
      "茅ヶ崎市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>茅ヶ崎市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>茅ヶ崎市でいちばん高い階層はいくら？</h2>
<p>茅ヶ崎市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額72,800円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
...
<p>上記の金額は茅ヶ崎市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.chigasaki.kanagawa.jp/_res/projects/default_project/_page_/001/004/734/201910hoikuryo.pdf" target="_blank" rel="noopener">茅ヶ崎市の保育料表</a>をご確認ください。</p>
</div>`,
