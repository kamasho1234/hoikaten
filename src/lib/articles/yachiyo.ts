...
<p>求職活動中の基本指数は6点で、就労中（最大20点）の3分の1以下です。求職中での入園は人気エリアでは困難です。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "yachiyo",
    title: "八千代市の保育料はいくら？　上限額と決まり方",
    description:
      "八千代市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>八千代市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>八千代市でいちばん高い階層はいくら？</h2>
<p>八千代市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額67,900円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>保育料は毎年9月に切り替わります。4月分から8月分は前年度の住民税額、9月分から翌年3月分は当年度の住民税額で決まる自治体が多いため、9月に金額が変わることがあります。</p>
</div>
<h2>きょうだいがいる世帯の軽減</h2>
<p>八千代市は次のように案内しています。</p>
<blockquote><p>・77,101円未満の要保護世帯※は第1子は半額以下（保育料基準額表の下部参照​），第2子は無料に軽減します※要保護世帯とはひとり親世帯，同一世帯内に身体障害者手帳・療育手帳・精神障害者保健福祉手帳の交付，または特別児童扶養手当・国民年金の障害基礎年金の支給を受けている方がいる場合をいいます。</p></blockquote>
<div class="info-box">
<p><strong>出典</strong></p>
<p>上記の金額は八千代市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.yachiyo.lg.jp/uploaded/attachment/40312.pdf" target="_blank" rel="noopener">八千代市の保育料表</a>をご確認ください。</p>
</div>`,
