...
<p>大府市の基準点数は父母各最大20点（合計40点満点）です。月の就労時間で判定される制度です。</p>
</div>
...
<p>大府市ではフルタイム共働き世帯は基準点数<span class="highlight">40点</span>で横並びです。差がつくのは調整点数の加点です。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>大府市の40点制では、フルタイム共働きで40点が基本ラインです。調整点数の1点が当落を分けることがあります。</p>
</div>
...
<div class="warn-box">
<p><strong>注意</strong></p>
<p>1日6時間×週5日＝月約120時間の時短勤務の場合、基準点数は<span class="highlight">18点</span>です。フルタイムの20点と比べて2点下がります。</p>
</div>
...
<p>大府市の入園選考で、ひとり親世帯は調整点数で<span class="highlight">+5点</span>の加点が得られます。</p>
...
<p>大府市の入園選考では、育児休業を取得して入園月に復帰する場合、調整点数で<span class="highlight">+2点</span>の加点が得られます。</p>
...
<p>大府市の入園選考では、認可外保育施設に月ぎめで預けている場合、調整点数で<span class="highlight">+3点</span>の加点が得られます。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>認可外に1年利用した場合、翌年度申込時の調整点数で+3点の加点が得られるため、入園実現の確度が上がります。</p>
</div>
