...
<p>選考基準の詳細は<a href="https://www.city.takasaki.gunma.jp/page/6308.html" target="_blank" rel="noopener">高崎市公式ホームページ</a>の入所ガイドで確認できます。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "takasaki",
    title: "高崎市の保育料はいくら？　上限額と決まり方",
    description:
      "高崎市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>高崎市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>高崎市でいちばん高い階層はいくら？</h2>
<p>高崎市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額51,280円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
...
<p>上記の金額は高崎市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.takasaki.gunma.jp/uploaded/attachment/7534.pdf" target="_blank" rel="noopener">高崎市の保育料表</a>をご確認ください。</p>
</div>`,
