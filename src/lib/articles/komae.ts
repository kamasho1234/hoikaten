...
const articles: Article[] = [
  {
    ...
    citySlug: "komae",
    title: "狛江市の保活スケジュール　申込から内定までの流れ",
    description:
      "狛江市の認可保育園の申込時期・選考の流れをまとめました。令和8年度4月入園の動き方を解説します。",
    image: "https://images.unsplash.com/photo-1484820540004-14229fe36ca4?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>狛江市の4月入園スケジュール</h2>
<p>狛江市の認可保育園は毎年秋に翌年度4月入園の一次申込を受付けます。実施基準指数表を理解して準備を進めましょう。</p>
...
<p>狛江市のホームページで保育園の一覧や前年度のボーダー（最低指数一覧）を確認します。</p>
</div>
</div>
<div class="step">
...
<p>狛江市内の保育園を見学して、通勤経路との相性を確認しましょう。</p>
</div>
</div>
<div class="step">
...
<p>狛江市の基準指数は父母各最大20点（合計40点満点）です。月の就労時間で判定される制度です。</p>
</div>

<div class="info-box">
<p><strong>公式情報</strong></p>
<p>詳しくは<a href="https://komae-kosodate.net/article_docs/2543.html" target="_blank" rel="noopener">狛江市こまえ子育てねっと 令和8年4月認可保育所等入所 申込受付のご案内</a>をご確認ください。</p>
</div>`,
  ...
  },
  {
    ...
    citySlug: "komae",
    title: "狛江市の入園点数のしくみ　基準指数と調整指数を解説",
    description:
      "狛江市の保育園入園選考で使われる実施基準指数と調整指数のしくみをわかりやすく解説します。",
    image: "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>狛江市の選考指数とは</h2>
<p>狛江市の認可保育園は「実施基準指数（父＋母）＋ 調整指数」の合計で選考されます。</p>
...
<div class="info-box">
<p><strong>公式情報</strong></p>
<p>全項目は<a href="https://komae-kosodate.net/download/2544.html" target="_blank" rel="noopener">狛江市公式サイト</a>の「令和8年度保育施設入園申込関連書式」で確認できます。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 60,
  },
  {
    slug: "score-up-tips",
    citySlug: "komae",
    title: "狛江市で入園点数を上げるコツ　加点チェックリスト",
    description:
      "狛江市の保育園入園選考で調整指数の加点を最大限に活用する方法を解説します。",
    image: "https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>基準指数40点は出発点</h2>
<p>狛江市ではフルタイム共働き世帯は基準指数<span class="highlight">40点</span>で横並びです。差がつくのは調整指数の加点です。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>狛江市は入所決定者の最低指数一覧を公開しています。園ごとのボーダーを確認して、自分の点数で入園できそうな園を探しましょう。</p>
</div>
...
<p>就労証明書の月あたり就労時間は正確に記載してください。実態と異なる記載は入園取消しの対象です。</p>
  ...
  },
  {
    ...
    citySlug: "komae",
    title: "狛江市で同点になったらどうなる？優先順位を解説",
    description:
      "狛江市の保育園入園選考で同点だった場合の優先順位の判定方法を解説します。",
    image: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>同点時の判定方法</h2>
<p>狛江市の入園選考で利用調整指数が同点になった場合、さらに優先順位で判定されます。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>狛江市の40点制では、フルタイム共働きで40点が基本ラインです。調整指数の1点が当落を分けることがあります。</p>
</div>
...
<p>優先順位は年度によって変更される場合があります。最新の「入園のしおり」で必ず確認しましょう。</p>
  ...
  },
  {
    ...
    citySlug: "komae",
    title: "狛江市で時短勤務だと点数はどう変わる？",
    description:
      "狛江市の保育園入園選考で時短勤務の場合の基準指数への影響を解説します。",
    image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>狛江市は月の就労時間で判定</h2>
<p>狛江市の基準指数は月の就労時間で決まります。時短勤務の影響を確認しましょう。</p>
...
<p>復職後のフルタイム勤務条件を就労証明書に記載してもらえるか、勤務先に確認しましょう。育休中でも復職後の勤務条件で指数が判定されます。</p>
  ...
  },
  {
    ...
    citySlug: "komae",
    title: "狛江市のひとり親加点　2点獲得の条件と活用法",
    description:
      "狛江市の保育園入園選考でひとり親世帯が受けられる加点について解説します。",
    image: "https://images.unsplash.com/photo-1506784183857-c026f2c4c4c7?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>ひとり親世帯の加点</h2>
<p>狛江市ではひとり親世帯が調整指数で<span class="highlight">+2点</span>の加点を受けられます。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>基準指数40点制の狛江市では、+2点の加点は大きなアドバンテージです。調整指数の一部です。</p>
</div>
...
<div class="info-box">
<p><strong>公式情報</strong></p>
<p>詳しくは<a href="https://komae-kosodate.net/article_docs/2543.html" target="_blank" rel="noopener">狛江市こまえ子育てねっと</a>で確認できます。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 48,
  },
  {
    ...
    citySlug: "komae",
    title: "狛江市の育休明けのタイミング　入園月に復職する場合の加点",
    description:
      "狛江市で育児休業を取得し、入園月に復帰する場合の加点条件を解説します。",
    image: "https://images.unsplash.com/photo-1503454537688-e6ea6ca8759f?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>育休復帰予定の加点</h2>
<p>狛江市では育児休業から入園月に復帰する予定の場合、調整指数で<span class="highlight">+1点</span>の加点が得られます。</p>
...
<div class="warn-box">
<p><strong>注意</strong></p>
<p>育休延長を希望する場合でも加点が受けられる仕組みが整備されています。対応について狛江市役所に相談しましょう。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 42,
  },
  {
    ...
    citySlug: "komae",
    title: "狛江市の待機児童の状況と入園難易度",
    description:
      "狛江市の保育園入園の待機児童数や競争率、入園難易度の現状をまとめました。",
    image: "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=800&h=400&fit=crop",
    category: "エリア情報",
    categoryColor: "teal",
    content: `<h2>狛江市の待機児童状況</h2>
<p>狛江市は多摩川沿いの人気エリアで、子育て世帯が多く集まっています。待機児童状況を確認しましょう。</p>

<h2>狛江市の入園難易度</h2>
<p>狛江市の認可保育園入園決定率は約71.6%で、東京都内でも競争が厳しい自治体の一つです。フルタイム共働き世帯の基準指数40点では、調整指数の加点で差がつきます。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>狛江市は入所決定者の最低指数一覧を公開しており、園ごとのボーダー点数が確認できます。自分の点数で入園できる園を見つけることが重要です。</p>
</div>
...
<div class="info-box">
<p><strong>公式情報</strong></p>
<p>最新の待機児童数や保育施設の空き情報は<a href="https://www.city.komae.tokyo.jp/index.cfm/43,32314,586,3431,html" target="_blank" rel="noopener">狛江市公式サイト 保育施設空き情報</a>で確認できます。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 50,
  },
  {
    ...
    citySlug: "komae",
    title: "狛江市の申込書類チェックリスト　必要書類の確認",
    description:
      "狛江市の保育園入園申込に必要な書類をチェックリストでまとめました。",
    image: "https://images.unsplash.com/photo-1507842872343-583f20270319?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>申込書類の確認</h2>
<p>狛江市の保育園入園申込には複数の書類が必要です。提出期限までに余裕を持って準備しましょう。</p>
...
<h2>提出方法と期限</h2>
<p>狛江市では毎年秋（例年10月〜11月）に一次申込を受け付けています。詳しい提出期限と提出場所は入園のしおりで確認しましょう。</p>
...
<p>詳しくは<a href="https://komae-kosodate.net/article_docs/2543.html" target="_blank" rel="noopener">狛江市こまえ子育てねっと</a>で確認できます。</p>
  ...
  },
  {
    ...
    citySlug: "komae",
    title: "狛江市で認可外保育と加点　認証保育所の活用法",
    description:
      "狛江市では認可外保育施設の利用で加点が得られます。その活用方法を解説します。",
    image: "https://images.unsplash.com/photo-1587654780291-39c9404d7dd0?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>認証保育所等の利用による加点</h2>
<p>狛江市では認証保育所等に月ぎめで預けている場合、調整指数で<span class="highlight">+2点</span>の加点が得られます。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>月ぎめの契約が条件です。40点制の狛江市では調整指数の2点は大きなアドバンテージです。</p>
</div>
