...
<h3>浅口市の就労評価の特徴</h3>
<p>浅口市では<span class="highlight">週の就労日数（週5日以上・週4日以上・週3日以上）</span>と<span class="highlight">週の合計就労時間（40時間以上〜12時間以上）</span>の組み合わせで基本点数が決まります。父または母の基本点数は、居宅外（外勤等）で最大10点、居宅内（在宅・農業等）で最大9点です。</p>
