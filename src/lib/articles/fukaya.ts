...
const articles: Article[] = [
  // ===== 保活の基本 (1) =====
  {
    ...
    citySlug: "fukaya",
    title: "深谷市の保活スケジュール　令和8年度4月入園の流れ",
    description:
      "深谷市の認可保育園の申込時期・選考の流れ・結果通知の時期をわかりやすく解説。令和8年度4月入園のスケジュールを中心にまとめました。",
    image:
      "https://images.unsplash.com/photo-1484820540004-14229fe36ca4?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>令和8年度（2026年度）4月入園のスケジュール</h2>
<p>深谷市の4月入園は<strong>一次利用調整</strong>と<strong>二次利用調整</strong>の2回に分かれています。申込先は深谷市子ども未来部保育課です。</p>
...
<p>深谷市の認可保育園は約25か所。エリアや園の特徴を調べましょう。</p>
</div>
</div>
<div class="step">
...
<p>深谷市が発行する「保育園・認定こども園・小規模保育室 入園手引き」を入手しましょう。</p>
</div>
</div>
<div class="step">
...
<p>各月の申込締切日は、入園希望月の<span class="highlight">前月10日頃</span>です。詳しくは深谷市の公式サイトをご確認ください。</p>`,
  ...
  // ===== 選考のしくみ =====
  {
    ...
    citySlug: "fukaya",
    title: "深谷市の入園点数のしくみ　基本指数と調整指数をやさしく解説",
    description:
      "深谷市の保育園入園選考で使われる基本指数と調整指数の仕組みを、初めての方にもわかるように解説します。",
    image:
      "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>点数ってなに？</h2>
<p>深谷市の保育園入園は「先着順」ではなく「点数（指数）」の高い順に内定が決まります。</p>
...
<li>同居祖父母が保育可能：<span class="highlight">-3点</span></li>
  ...
  // ===== 点数アップ =====
  {
    slug: "score-up-tips",
    citySlug: "fukaya",
    title: "深谷市で点数を1点でも上げる方法　加点のチェックリスト",
    description:
      "深谷市の入園選考で調整指数の加点を最大限に活用する方法を、チェックリスト形式で解説します。",
    image:
      "https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>加点の取りこぼしをなくそう</h2>
<p>深谷市の入園選考では<span class="highlight">1点</span>の差が明暗を分けることも。使える加点は漏れなく活用しましょう。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>認可外保育施設に預けながら翌年の4月入園を申し込むと、+3点の加点がつきます。0歳児クラスで認可外に預け、1歳児クラスで認可園を狙うのは深谷市でも有効な戦略です。</p>
</div>

<div class="info-box">
<p><strong>注意すべき減点項目</strong></p>
<p>深谷市外からの申込は-10点、認可園からの転園は-5点、同居祖父母が保育可能な場合は-3点の減点があります。特に市外からの申込は大幅な減点となるため要注意です。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 60,
  },
  // ===== 同点対策 =====
  {
    ...
    citySlug: "fukaya",
    title: "深谷市で同点になったらどうなる？　優先順位のしくみ",
    description:
      "深谷市の保育園入園選考で同点になった場合の優先順位と、事前にできる対策を解説します。",
    image:
      "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>同点の場合の優先順位</h2>
<p>深谷市では選考指数が同点の場合、以下の順番で優先されます。</p>
...
<p>深谷市では過去の入園最低指数を公開していることがあります。保育課の窓口で確認してみましょう。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 48,
  },
  // ===== 就労時間 =====
  {
    ...
    citySlug: "fukaya",
    title: "深谷市　パートタイム・短時間勤務の点数を詳しく解説",
    description:
      "深谷市の保育園入園選考で、パートタイムや短時間勤務がどのくらいの点数になるか、具体例を交えて解説します。",
    image:
      "https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>深谷市のパート・短時間勤務の点数</h2>
<p>深谷市の基本指数は、月あたりの就労時間で細かく区分されています。</p>
...
<p>通勤時間は就労時間に含まれません。また、育休中や産休中の場合は「出産」の事由で評価されます。</p>
  ...
  // ===== ひとり親 =====
  {
    ...
    citySlug: "fukaya",
    title: "深谷市のひとり親世帯　入園選考で有利な理由と加点戦略",
    description:
      "深谷市のひとり親世帯が受ける基本指数の加点・優先措置と、入園選考を有利に進めるコツを解説します。",
    image:
      "https://images.unsplash.com/photo-1488754612908-cf78fc443644?w=800&h=400&fit=crop",
    category: "入園のコツ",
    categoryColor: "rose",
    content: `<h2>ひとり親世帯の強み</h2>
<p>深谷市ではひとり親世帯（母子家庭・父子家庭）で就労または就学している場合、調整指数で<span class="highlight">+5点</span>の加点が付きます。</p>

<h2>基本指数は通常通り</h2>
<p>加点は調整指数に含まれるため、基本指数（就労の点数）は両親家庭と同じ基準で評価されます。例えば、月160時間以上勤務なら基本指数20点、調整指数+5点で合計25点になります。</p>

<h2>同点時の優先順位</h2>
<p>深谷市の同点時の優先ルールでは、ひとり親世帯が第1優先とされています。つまり、<strong>フルタイムで働くひとり親と両親がどちらも20点+20点で40点の場合、ひとり親世帯が優先されます</strong>。</p>
...
<p>ひとり親であることを証明するため、戸籍謄本や児童扶養手当受給証等の提出が必要になります。申し込み時に保育課に確認しましょう。</p>
  ...
  // ===== 育休タイミング =====
  {
    ...
    citySlug: "fukaya",
    title: "深谷市の育休・産休タイミング　入園のベストなタイミングは？",
    description:
      "深谷市で育休明けの保育園入園を考える方へ。入園月の選び方と育休・産休からの復帰でもらえる加点について解説します。",
    image:
...
<p>育休からの復帰予定日は、申し込み書類に必ず記入してください。この日付で加点の対象判定が行われます。</p>
  ...
  // ===== 待機児童 =====
  {
    ...
    citySlug: "fukaya",
    title: "深谷市の待機児童の実態　入園難易度と対策",
    description:
      "深谷市の待機児童数・保育園の施設数・エリア別の入園難易度など、リアルな保活事情をまとめました。",
    image:
      "https://images.unsplash.com/photo-1511895426328-dc8714191300?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>深谷市の保育園事情</h2>
<p>深谷市は埼玉県北部の人口約14.2万人の市です。認可保育園は約25か所、認定こども園や小規模保育事業所を含めると、認可施設は50か所以上あります。</p>

<h2>待機児童数の推移</h2>
<p>深谷市は埼玉県の中でも待機児童が比較的少ない自治体として知られています。ただし、年によって変動があるため、最新の数字は深谷市役所に確認しましょう。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>深谷市は比較的入園しやすい自治体ですが、人気園には集中するため、複数の園を希望に入れることが大切です。</p>
</div>
...
<li>認可外保育施設を活用して翌年の加点を狙う</li>
  ...
  // ===== 申込チェックリスト =====
  {
    ...
    citySlug: "fukaya",
    title: "深谷市の保育園申込　必要書類と提出前チェックリスト",
    description:
      "深谷市の認可保育園申込に必要な書類一覧と、提出前の確認チェックリストで申請漏れを防ぎます。",
    image:
      "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800&h=400&fit=crop",
    category: "申込のコツ",
    categoryColor: "teal",
...
<p>書類に不安がある場合は、深谷市子ども未来部保育課（048-574-8648）に電話して確認できます。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 55,
  },
  // ===== 認可外 =====
  {
    ...
    citySlug: "fukaya",
    title: "深谷市の認可外保育施設ガイド　認可園との違いと活用法",
    description:
      "深谷市で認可園に入れなかった場合の選択肢として、認可外保育施設の特徴と加点活用法を解説します。",
    image:
      "https://images.unsplash.com/photo-1587654780291-39c9404d7dd0?w=800&h=400&fit=crop",
    category: "認可外保育",
    categoryColor: "teal",
    content: `<h2>認可外保育施設とは？</h2>
<p>認可外保育施設は、認可基準を満たしていないものの、自治体に届出をして運営している保育施設です。深谷市内にも複数の認可外保育施設があります。</p>

<h2>認可園との主な違い</h2>
<table>
<tr><th>項目</th><th>認可</th><th>認可外</th></tr>
<tr><td>保育料</td><td>所得に応じて決定</td><td>施設が設定</td></tr>
<tr><td>申込先</td><td>深谷市保育課</td><td>施設に直接</td></tr>
...
<p>深谷市の認可外保育施設一覧は、深谷市子ども未来部保育課の窓口で確認できます。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 42,
  },
