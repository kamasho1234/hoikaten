...
const articles: Article[] = [
  {
    ...
    citySlug: "kisarazu",
    title: "木更津市の保活スケジュール　申込から内定までの流れ",
    description:
      "木更津市の認可保育園の申込時期・選考の流れをまとめました。令和8年度4月入園の動き方を解説します。",
    image: "https://images.unsplash.com/photo-1484820540004-14229fe36ca4?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>木更津市の4月入園スケジュール</h2>
<p>木更津市の認可保育園は毎年秋に翌年度4月入園の一次申込を受付けます。基準点数・調整点数を理解して準備を進めましょう。</p>
...
<p>木更津市のホームページで保育園の一覧や前年度のボーダー（最低点数一覧）を確認します。</p>
</div>
</div>
<div class="step">
...
<p>木更津市内の保育園を見学して、通勤経路との相性を確認しましょう。</p>
</div>
</div>
<div class="step">
...
<p>詳しくは<a href="https://www.city.kisarazu.lg.jp/soshiki/kenkokodomo/kodomohoiku/1/4345.html" target="_blank" rel="noopener">木更津市公式サイト 保育施設入園の申し込み</a>をご確認ください。</p>
</div>`,
  ...
  },
  {
    ...
    citySlug: "kisarazu",
    title: "木更津市の入園点数のしくみ　基準点数と調整点数を解説",
    description:
      "木更津市の保育園入園選考で使われる基準点数と調整点数のしくみをわかりやすく解説します。",
    image: "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>木更津市の選考点数とは</h2>
<p>木更津市の認可保育園は「基準点数（父＋母）＋ 調整点数」の合計で選考されます。</p>
...
<p>総合点数が同じ場合は基準点数の高い者が優先されます。さらに基準点数も同じ場合は所得の低い者から承諾されます。</p>
  ...
  },
  {
    slug: "score-up-tips",
    citySlug: "kisarazu",
    title: "木更津市で入園点数を上げるコツ　調整点数チェックリスト",
    description:
      "木更津市の保育園入園選考で調整点数の加点を最大限に活用する方法を解説します。",
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>木更津市は入所決定者の最低点数一覧を公開しています。園ごとのボーダーを確認して、自分の点数で入園できそうな園を探しましょう。</p>
</div>
...
<p>就労証明書の月あたり就労時間は正確に記載してください。実態と異なる記載は入園取消しの対象です。</p>
  ...
  },
  {
    ...
    citySlug: "kisarazu",
    title: "木更津市で同点になったらどうなる？優先順位を解説",
    description:
      "木更津市の保育園入園選考で同点だった場合の優先順位の判定方法を解説します。",
    image: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=800&h=400&fit=crop",
    category: "選考のしくみ",
    categoryColor: "blue",
    content: `<h2>同点時の判定方法</h2>
<p>木更津市の入園選考で総合点数が同点になった場合、さらに優先順位で判定されます。</p>
...
<p>優先順位は年度によって変更される場合があります。最新の「入園のご案内」で必ず確認しましょう。</p>
  ...
  },
  {
    ...
    citySlug: "kisarazu",
    title: "木更津市で時短勤務だと点数はどう変わる？",
    description:
      "木更津市の保育園入園選考で時短勤務の場合の基準点数への影響を解説します。",
    image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>木更津市は月の就労時間で判定</h2>
<p>木更津市の基準点数は月の就労時間で決まります。時短勤務の影響を確認しましょう。</p>
...
<p>復職後のフルタイム勤務条件を就労証明書に記載してもらえるか、勤務先に確認しましょう。育休中でも復職後の勤務条件で点数が判定されます。</p>
  ...
  },
  {
    ...
    citySlug: "kisarazu",
    title: "木更津市でひとり親の場合　加点と支援制度を解説",
    description:
      "木更津市の保育園入園選考でひとり親世帯が受ける加点と、利用できる支援制度をまとめました。",
...
<p>木更津市ではひとり親世帯向けの様々な支援制度があります。保育園入園時の相談窓口で詳しく説明を受けられます。</p>
...
<div class="warn-box">
<p><strong>注意</strong></p>
<p>加点を受けるには、戸籍謄本や児童扶養手当受給証などの書類提出が必要な場合があります。事前に木更津市に確認しましょう。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 48,
  },
  {
    ...
    citySlug: "kisarazu",
    title: "木更津市の育休明けのタイミング　入園点数への影響",
    description:
      "木更津市の保育園入園選考で育休明けの復帰タイミングが点数に与える影響を解説します。",
    image: "https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>育休復帰予定で加点</h2>
<p>木更津市の入園選考では、育児休業を取得して入園月に復帰する場合、調整点数で<span class="highlight">+1点</span>の加点が得られます。</p>
...
<p>入園月の前月までに復帰してしまうと、加点の対象にならない場合があります。申込時に必ず確認しましょう。</p>
  ...
  },
  {
    ...
    citySlug: "kisarazu",
    title: "木更津市の待機児童の現状　入園の難易度を解説",
    description:
      "木更津市の認可保育園の待機児童数や競争率から、入園の難易度を分析します。",
    image: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&h=400&fit=crop",
    category: "保活の基本",
    categoryColor: "green",
    content: `<h2>木更津市の待機児童状況</h2>
<p>木更津市の認可保育園の需要と供給のバランスを把握することが、保活戦略の第一歩です。</p>

<h3>保育園の競争率</h3>
<p>木更津市内の保育園は地域によって競争率が異なります。駅前や商業施設近くの人気園は倍率が高い傾向にあります。</p>
...
<div class="warn-box">
<p><strong>注意</strong></p>
<p>待機児童数は毎年変動します。必ず最新の木更津市公式情報で確認しましょう。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 42,
  },
  {
    ...
    citySlug: "kisarazu",
    title: "木更津市の申込書類チェックリスト　書き漏れを防ぐ",
    description:
      "木更津市の保育園申込に必要な書類と、記入時の注意点をまとめたチェックリストです。",
...
<div class="warn-box">
<p><strong>注意</strong></p>
<p>書類に記載漏れがあると点数が認定されない場合があります。申込む前に木更津市役所に確認することをお勧めします。</p>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 50,
  },
  {
    ...
    citySlug: "kisarazu",
    title: "木更津市で認可外保育施設を利用する場合の加点",
    description:
      "木更津市の保育園入園選考で認可外保育施設の利用が与える影響と加点制度を解説します。",
    image: "https://images.unsplash.com/photo-1503454537688-e47a8b0b5a20?w=800&h=400&fit=crop",
    category: "点数アップ",
    categoryColor: "amber",
    content: `<h2>認可外保育施設の利用で加点</h2>
<p>木更津市の入園選考では、認可外保育施設に月ぎめで預けている場合、調整点数で<span class="highlight">+2点</span>の加点が得られます。</p>
...
<p>認可外施設の利用実績がないと加点が認定されません。領収書などの証拠書類を保管しておきましょう。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "kisarazu",
    title: "木更津市の保育料はいくら？　上限額と決まり方",
    description:
      "木更津市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>木更津市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>木更津市でいちばん高い階層はいくら？</h2>
<p>木更津市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額67,000円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
...
<p>上記の金額は木更津市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.kisarazu.lg.jp/material/files/group/26/20210812.pdf" target="_blank" rel="noopener">木更津市の保育料表</a>をご確認ください。</p>
</div>`,
