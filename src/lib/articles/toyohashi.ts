...
<p>最新のスケジュールは<a href="https://www.city.toyohashi.lg.jp/63210.htm" target="_blank" rel="noopener">豊橋市 令和8年度入園についてのページ</a>で確認できます。</p>
  ...
  // 2. 点数の仕組みと計算方法
  {
    slug: "scoring-system",
    citySlug: "toyohashi",
    title: "豊橋市の保育園点数の仕組みと計算方法｜基本指数・補正指数を解説",
    description:
      "豊橋市の保育園入園選考で使われる点数（基本指数・補正指数）の仕組みを解説。父母合算方式の計算方法と各項目の点数をわかりやすくまとめました。",
    category: "点数・選考",
    categoryColor: "blue",
    image:
      "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=800&h=400&fit=crop",
    content: `<h2>豊橋市の入園選考の仕組み</h2>
<p>豊橋市では、保育施設の利用申込者数が受入可能数を超えた場合、「保育所入所基準指数表」に基づいて点数（指数）で入園調整を行います。</p>

<h2>点数の構成</h2>
<p>世帯の合計指数は<strong>「基本指数（父母の状況）」＋「補正指数」</strong>で決まります。基本指数は父母それぞれに算出し、<strong>合算</strong>したものが世帯の基本指数になります。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>豊橋市はフルタイム共働きの場合、父20点＋母20点＝基本指数40点が基準ラインです。補正指数の加点で差がつきやすいので、該当する項目がないか確認しましょう。</p>
</div>`,
    publishedAt: "2026-04-05",
    popularity: 60,
  },
