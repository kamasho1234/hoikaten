...
<p>横手市の選考では父母各最大200点の合計400点満点で優先順位が決まります。単純な平均ではなく合算となるため、両親がバランスの取れた就労をしている世帯が有利になりやすいです。</p>
</div>
...
<p>横手市は父母各最大200点の<span class="highlight">合計400点満点のSum方式</span>で入園選考を行います。</p>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>選考指数 = 父の基礎指数 + 母の基礎指数（最大400点）</p>
<p>点数が高い順に優先的に入園できます。</p>
</div>

<h3>基礎指数の計算</h3>
<p>保護者1人あたりの基礎指数は最大200点です。就労日数・就労時間の組み合わせで細かく設定されています。</p>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>ひとり親世帯+100点は、基礎指数が最大200点であることと比較して、相応の加算です。つまり、基礎指数が100点のひとり親世帯と200点の両親世帯がほぼ同等の選考順位になります。</p>
</div>
