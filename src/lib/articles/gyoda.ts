...
<li>ひとり親世帯：+23点</li>
<li>生活保護受給：+3点</li>
<li>きょうだいが同じ園に在園中：+5点</li>
<li>きょうだいを同時申込：+3点</li>
<li>育児休業中からの入所申込み：+3点</li>
<li>育児休業から復職し認可外保育施設に在籍：+3点</li>
</ul>

<h3>減点される主な調整指数</h3>
<ul>
<li>市外在住：-30点</li>
<li>同居の祖父母が保育可能（証明書未提出）：-3点</li>
<li>保育料滞納：-5～-20点</li>
</ul>`,
    publishedAt: "2026-04-26",
    popularity: 65,
...
<h3>2. 育休明けタイミングの活用（+3点）</h3>
<p>育児休業中からの入所申込みで+3点の加点がつきます。スケジュール調整が可能であれば、入園月に合わせて育休からの復帰を計画しましょう。</p>

<h3>3. きょうだいの活用（+3点または+2点）</h3>
<p>上の子が既に同じ園に在園中であれば+3点、同時申込なら+2点がつきます。複数の子どもがいる場合は大きなアドバンテージです。</p>

<h3>4. ひとり親世帯の場合（+23点）</h3>
<p>母子家庭・父子家庭で就労中なら+23点です。この加点は調整指数の中でも最大級なので、選考で大きく有利に働きます。</p>
...
<p>行田市では、ひとり親世帯（母子家庭・父子家庭）で就労中または就労が内定している場合、+23点の加点がつきます。</p>

<h3>加点の内訳</h3>
<ul>
<li>基本指数：親1人分の就労時間に応じた点数（最大20点）</li>
<li>調整指数：ひとり親加算 +23点</li>
</ul>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>ひとり親加算の+23点は、調整指数の中で最も大きな加点です。他の加点と組み合わせると、かなり競争力が高まります。</p>
</div>
...
<p>ひとり親（+23点）＋育児休業中からの申込（+3点）＋認可外利用で復職（+3点）など、複数の加点を組み合わせると最大+29点の加点が見込めます。</p>
</div>
</div>`,
    publishedAt: "2026-04-26",
    popularity: 58,
...
<li>給食の内容（弁当持参か施設提供か）</li>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "gyoda",
    title: "行田市の保育料はいくら？　上限額と決まり方",
    description:
      "行田市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>行田市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>行田市でいちばん高い階層はいくら？</h2>
<p>行田市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額55,000円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
...
<p>上記の金額は行田市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.gyoda.lg.jp/material/files/group/22/futangaku2019.pdf" target="_blank" rel="noopener">行田市の保育料表</a>をご確認ください。</p>
</div>`,
