...
<li>きょうだいが在園中の園を希望する、または同時に申し込む（+6点＋同点時優先）</li>
<li>育休から復帰する場合は+16点の加点を活用する</li>
<li>ひとり親は+20点の加点対象</li>
...
<div class="point-box">
<p><strong>ポイント</strong></p>
<p>山口市ではきょうだい同時申込み・在園で+6点の加点が得られます。また、育休復帰は+16点と非常に大きな加点となるため、活用できる場合は積極的に申告しましょう。</p>
</div>
...
<p>山口市では、両親ともに<strong>月160時間以上</strong>の就労で、基準指数は<strong>父50点＋母50点＝100点</strong>になります。</p>

<h3>フルタイム＋調整指数の例</h3>
<table>
<tr><th>状況</th><th>合計点</th></tr>
<tr><td>フルタイム共働き（調整なし）</td><td>100点</td></tr>
<tr><td>＋ きょうだい在園中</td><td>106点</td></tr>
<tr><td>＋ 育休復帰</td><td>116点</td></tr>
<tr><td>＋ ひとり親</td><td>120点</td></tr>
<tr><td>＋ きょうだい在園＋育休復帰</td><td>122点</td></tr>
</table>

<h2>調整指数で差をつけるには</h2>
<ul>
<li><strong>ひとり親（+20点）</strong>：最も大きな加点項目</li>
<li><strong>育休復帰（+16点）</strong>：育休から復帰する場合の最大加点</li>
<li><strong>きょうだい在園中・同時申込み（+6点）</strong>：きょうだいが在園中なら忘れずに申告</li>
<li><strong>児童障害（+4点）</strong>：申込み児童が障がい児の場合</li>
<li><strong>単身赴任（+4点）</strong>：親が不在の場合</li>
</ul>

<div class="point-box">
<p><strong>ポイント</strong></p>
<p>山口市ではフルタイム共働き100点が多くの世帯のベースラインです。調整指数をどれだけ積み上げられるかが合否を分けます。</p>
</div>`,
    publishedAt: "2026-04-07",
    popularity: 85,
  },
...
<p>山口市の小規模保育事業所一覧は<a href="https://www.city.yamaguchi.lg.jp/soshiki/50/" target="_blank" rel="noopener">山口市こども未来部保育幼稚園課</a>をご確認ください。</p>
  ...
  // ===== 育休・復職 (2) =====
  {
    ...
    content: `<h2>育休復帰の加点（+16点）</h2>
<p>山口市では、育児休業から復帰再申込みの場合に+16点の調整指数が加算されます。</p>
...
<p>最新の必要書類は<a href="https://www.city.yamaguchi.lg.jp/soshiki/50/" target="_blank" rel="noopener">山口市こども未来部保育幼稚園課</a>をご確認ください。</p>
  ...
  },
  {
    slug: "nursery-fees",
    citySlug: "yamaguchi",
    title: "山口市の保育料はいくら？　上限額と決まり方",
    description:
      "山口市の認可保育施設の保育料について、0〜2歳児クラスの上限額と決まり方を、市が公表している保育料表をもとに紹介します。",
    category: "お金の話",
    categoryColor: "rose",
...
<p>山口市の認可保育施設の保育料は、<span class="highlight">世帯の住民税額</span>と<span class="highlight">保育を利用する時間（保育標準時間・保育短時間）</span>で決まる階層表になっています。所得が高いほど階層が上がり、保育料も上がります。</p>
<h2>山口市でいちばん高い階層はいくら？</h2>
<p>山口市が公表している保育料表では、0〜2歳児クラス・保育標準時間のいちばん高い階層で<span class="highlight">月額72,000円</span>です。ここが上限で、これを超えることはありません。</p>
<div class="point-box">
<p><strong>ポイント</strong></p>
...
<p>上記の金額は山口市が公表している保育料表によります。階層ごとの正確な金額は<a href="https://www.city.yamaguchi.lg.jp/uploaded/attachment/119243.pdf" target="_blank" rel="noopener">山口市の保育料表</a>をご確認ください。</p>
</div>`,
